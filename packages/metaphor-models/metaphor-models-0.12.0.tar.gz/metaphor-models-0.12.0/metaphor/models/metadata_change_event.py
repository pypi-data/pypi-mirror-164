...
class AssetGovernedTags:
    ...
    def from_dict(obj: Any) -> 'AssetGovernedTags':
        ...
        last_modified = from_union([AuditStamp.from_dict, from_none], obj.get("lastModified"))
        return AssetGovernedTags(created_at, id, aspect_type, asset_governed_tags_created_at, entity_id, governed_tag_ids, asset_governed_tags_id, last_modified)
...
class DashboardInfo:
    ...
    def from_dict(obj: Any) -> 'DashboardInfo':
        ...
        return DashboardInfo(created_at, id, aspect_type, charts, dashboard_info_created_at, description, entity_id, dashboard_info_id, power_bi, title, view_count)
...
class DatasetFieldAssociations:
    ...
    def from_dict(obj: Any) -> 'DatasetFieldAssociations':
        ...
        last_modified = from_union([AuditStamp.from_dict, from_none], obj.get("lastModified"))
        return DatasetFieldAssociations(created_at, id, aspect_type, dataset_field_associations_created_at, entity_id, governed_tag_fields, dataset_field_associations_id, last_modified)
...
class PowerBIDataset:
    ...
    def from_dict(obj: Any) -> 'PowerBIDataset':
        ...
        url = from_union([from_str, from_none], obj.get("url"))
        workspace = from_union([PowerBIWorkspace.from_dict, from_none], obj.get("workspace"))
        return PowerBIDataset(created_at, id, aspect_type, power_bi_dataset_created_at, description, entity_id, power_bi_dataset_id, name, source_datasets, tables, url, workspace)
