...
def collapse_hide_unused_toggle(
        ...
        execution_context: typing.Union[str, int] = None,
        undo: bool = None):
    ''' Toggle collapsed nodes and hide unused sockets :file: startup/bl_operators/node.py\:237 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/node.py$237> _
...
def tree_path_parent(override_context: typing.
                     ...
                     execution_context: typing.Union[str, int] = None,
                     undo: bool = None):
    ''' Go to parent node tree :file: startup/bl_operators/node.py\:267 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/node.py$267> _
