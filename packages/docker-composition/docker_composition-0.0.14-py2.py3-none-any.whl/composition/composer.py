...
from composition import api, template_cmd
...
@click.option("--application_id", "-i", default=[], multiple=True)
@click.option("--force", "force", default=False, flag_value=True)
def delete(application_id, force=False):
    # Alias for uninstall
    uninstall_application(application_id, force)


@click.command("uninstall")
@click.option("--application_id", "-i", default=[], multiple=True)
@click.option("--force", "force", default=False, flag_value=True)
def uninstall(application_id, force=False):
    """
