...
from hestia_earth.models.cycle.dressedCarcassWeightPerHead import MODEL, TERM_ID, _should_run, run
    ...
    cycle['products'] = [
        {
            ...
            'properties': [
                ...
                {'term': {'@id': 'processingConversionLiveweightToDressedCarcassWeight'}}
            ]
        }
    ]
    should_run, *args = _should_run(cycle)
