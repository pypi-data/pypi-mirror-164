...
from hestia_earth.models.faostat2018.carcassWeightPerHead import MODEL, TERM_ID, _should_run, run
...
FAO_TERM = {
    ...
    'defaultProperties': [{
        'term': {'@id': 'processingConversionCarcassWeightToReadyToCookWeight', 'units': '%'},
