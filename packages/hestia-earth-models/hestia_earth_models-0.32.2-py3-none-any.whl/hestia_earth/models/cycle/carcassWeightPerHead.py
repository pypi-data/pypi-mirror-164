...
REQUIREMENTS = {
    "Cycle": {
        "products": [{
            ...
            "term.units": "kg carcass weight",
            "properties": [
                {"@type": "Property", "value": "", "term.@id": "liveweightPerHead"},
                {"@type": "Property", "value": "", "term.@id": "processingConversionLiveweightToCarcassWeight"}
            ]
        }]
    }
}
...
def _run(product: dict):
    ...
    processingConversion = get_node_property_value(product, 'processingConversionLiveweightToCarcassWeight')
...
def _should_run_product(cycle):
    def exec(product: dict):
        ...
        should_run = all([
            ...
            node_has_property('processingConversionLiveweightToCarcassWeight')(product)
        ])
