...
REQUIREMENTS = {
    "Cycle": {
        "products": [{
            ...
            "term.units": "kg dressed carcass weight",
            "properties": [
                {"@type": "Property", "value": "", "term.@id": "liveweightPerHead"},
                {"@type": "Property", "value": "", "term.@id": "processingConversionLiveweightToDressedCarcassWeight"}
            ]
        }]
    }
}
...
def _run(product: dict):
    ...
    processingConversion = get_node_property_value(product, 'processingConversionLiveweightToDressedCarcassWeight')
...
def _should_run_product(cycle):
    def exec(product: dict):
        ...
        should_run = all([
            ...
            node_has_property('processingConversionLiveweightToDressedCarcassWeight')(product)
        ])
