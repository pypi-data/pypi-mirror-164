...
class UpdateConferenceRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            play_beep (str): Controls when a beep is played. Valid values: `always`, `never`, `entryOnly`, `exitOnly`.. [optional] if omitted the server will use the default value of "always"  # noqa: E501
            status (str): New status of the conference. Valid values: `empty` or `terminated`. For more information, see **Status Parameter** below.**. [optional]  # noqa: E501
        """
