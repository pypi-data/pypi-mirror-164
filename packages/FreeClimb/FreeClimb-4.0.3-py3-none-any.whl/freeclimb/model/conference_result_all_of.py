...
class ConferenceResultAllOf(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'play_beep': (str, none_type,),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            play_beep (str, none_type): Setting that controls when a beep is played. One of: always, never, entryOnly, exitOnly. Defaults to always.. [optional]  # noqa: E501
            record (bool, none_type): Flag indicating whether recording is enabled for this Conference.. [optional]  # noqa: E501
            status (str, none_type): The status of the Conference. One of: creating, empty, populated, inProgress, or terminated.. [optional]  # noqa: E501
