...
@click.group(
    name='ec2-manager',
    help=(
        f'EC2 Manager version {getattr(ec2_manager, "__version__", None)}. '
        f'A CLI tool for quick and cost effective EC2 management.'
    )
)
def cli():
    pass
      ...
      f'Do you want to update your encoded env file?'
        ...
        while True:
            ...
            with open(env_file_path, 'r') as env_file:
                secrets[key_name] = ec2_manager.EC2Manager.encode_string(env_file.read())
