...
class Run:
    ...
    def init(self, user_name, project_name=None, api_key=None):
        ...
        self._agent_id, self._run_id, self.user_name, self._project_name, self._step, self._workload_id,
        self._submission_id, self._workload_type)
        res_monitor = multiprocessing.Process(target=self._monitor_resources, args=(
        self._agent_id, self._run_id, self.user_name, self._project_name, self._step, self._workload_id,
        self._submission_id, self._workload_type))
        res_monitor.start()
    ...
    def _monitor_resources(self, agent_id, run_id, user_name, project_name, step, workload_id, submission_id,
                           workload_type):
