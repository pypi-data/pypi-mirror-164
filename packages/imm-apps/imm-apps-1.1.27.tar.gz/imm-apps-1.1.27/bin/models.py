...
def get_models(
    ...
    models = {
        ...
        "exp": {
            "path": "model.experience.experience_e",
            "class_list": ["ExperienceModelE"],
        ...
        "exp-rs": {
            "path": "model.experience.resume_e",
            "class_list": ["ResumeModelE"],
        ...
        # Recruitment
        "recruit-ja": {
            "path": "model.recruit.jobad_e",
            "class_list": ["JobadModelE"],
        ...
        "recruit-jo": {
            "path": "model.recruit.joboffer_e",
            "class_list": ["JobofferModelE"],
        ...
        "recruit-rs": {
            "path": "model.recruit.recruitmentsummary_e",
            "class_list": ["RecruitmnetSummaryModelE"],
        ...
        # LMIA
        "lmia-st1": {
            "path": "model.lmia.stage1e",
            "class_list": ["LmiaAssessE"],
            "remark": "LMIA module for stage 1 model (assessment)",
        },
        "lmia-st2": {
            "path": "model.lmia.stage2e",
            "class_list": ["LmiaRecruitmentE"],
            "remark": "LMIA module for stage 2 model (recruitment)",
        },
        "lmia-st3": {
            "path": "model.lmia.stage3e",
            "class_list": ["LmiaApplicationE"],
            "remark": "LMIA module for for stage 3 model (application)",
        },
        "lmia-rcic": {
            "path": "model.lmia.rcice",
            "class_list": ["LmiaRcicE"],
            "remark": "LMIA module for RCIC model (Plannning)",
        },
        "lmia-5593": {
            "path": "model.lmia.m5593e",
            "class_list": ["M5593ModelE"],
            "docx_template": {
        ...
        "lmia-5626": {
            "path": "model.lmia.m5626e",
            "class_list": ["M5626ModelE"],
            "docx_template": {
                "rs": DATADIR / "word" / "lmia-rs.docx",
        ...
        "lmia-5627": {
            "path": "model.lmia.m5627e",
            "class_list": ["M5627ModelE"],
            "docx_template": {
                "rs": DATADIR / "word" / "lmia-rs.docx",
        ...
        "lmia-cap": {
            "path": "model.lmia.cape",
            "class_list": ["CapModelE"],
        ...
        # BCPNP
        "bcpnp-ert": {
            "path": "model.bcpnp.employertraining_e",
            "class_list": ["EmployerTrainingModelE"],
        ...
        "bcpnp-eet": {
            "path": "model.bcpnp.employeetraining_e",
            "class_list": ["EmployeeTrainingModelE"],
        ...
        "bcpnp-jd": {
            "path": "model.bcpnp.jobdescription_e",
            "class_list": ["JobDescriptionModelE"],
        ...
        "bcpnp-edf": {
            "path": "model.bcpnp.employerdeclaraton_e",
            "class_list": ["EmployerDeclaratonFormModelE"],
        ...
        "bcpnp-rl": {
            "path": "model.bcpnp.recommendationletter_e",
            "class_list": ["RecommendationLetterModelE"],
        ...
        "bcpnp-rpf": {
            "path": "model.bcpnp.mrep_e",
            "class_list": ["MRepModelE"],
        ...
        "bcpnp-pro": {
            "path": "webform.bcpnp.bcpnpmodel_pro_e",
            "class_list": ["BcpnpModelProE"],
            "remark": "BCPNP module for BCPNP Profile model",
            "web_function": "✅",
        },
        "bcpnp-reg": {
            "path": "webform.bcpnp.bcpnpmodel_reg_e",
            "class_list": ["BcpnpModelRegE"],
            "remark": "BCPNP module for BCPNP Registration model",
            "web_function": "✅",
        },
        "bcpnp-reg-ee": {
            "path": "webform.bcpnp.bcpnpmodel_reg_e",
            "class_list": ["BcpnpEEModelRegE"],
            "remark": "BCPNP module for BCPNP Registration model(EE)",
            "web_function": "✅",
        },
        "bcpnp-app": {
            "path": "webform.bcpnp.bcpnpmodel_app_e",
            "class_list": ["BcpnpModelAppE"],
            "remark": "BCPNP module for BCPNP Application model",
            "web_function": "✅ ",
        },
        "bcpnp-app-ee": {
            "path": "webform.bcpnp.bcpnpmodel_app_e",
            "class_list": ["BcpnpEEModelAppE"],
            "remark": "BCPNP module for BCPNP application (EE) model",
            "web_function": "✅ ",
        },
        # PR
        "0008": {
            "path": "model.pr.m0008e",
            "class_list": ["M0008ModelE"],
            "remark": "PR module for form 0008 model",
        },
        "5406": {
            "path": "model.pr.m5406e",
            "class_list": ["M5406ModelE"],
            "remark": "PR module for form 5406 model",
        },
        "5562": {
            "path": "model.pr.m5562e",
            "class_list": ["M5562ModelE"],
            "remark": "PR module for form 5562 model",
        },
        "5669": {
            "path": "model.pr.m5669e",
            "class_list": ["M5669ModelE"],
            "remark": "PR module for form 5669 model",
        },
        "pr": {
            "path": "webform.prportal.prmodel_e",
            "class_list": ["PrModelE"],
        ...
        # TR
        "1295": {
            "path": "model.tr.m1295e",
            "class_list": ["M1295ModelE"],
            "pdf_function": "✅",
            "docx_template": {
        ...
        "5257": {
            "path": "model.tr.m5257e",
            "class_list": ["M5257ModelE"],
            "pdf_function": "✅",
            "remark": "TR module for form 5257 model",
        },
        "5708": {
            "path": "model.tr.m5708e",
            "class_list": ["M5708ModelE"],
            "pdf_function": "✅",
            "docx_template": {
        ...
        "5709": {
            "path": "model.tr.m5709e",
            "class_list": ["M5709ModelE"],
            "pdf_function": "✅",
            "remark": "TR module for form 5709 model",
        },
        "5710": {
            "path": "model.tr.m5710e",
            "class_list": ["M5710ModelE"],
            "pdf_function": "✅",
            "remark": "TR module for form 5710 model",
        },
        "5476": {
            "path": "model.common.m5476e",
            "class_list": ["M5476ModelE"],
            "pdf_function": "✅ ",
            "remark": "Rep form",
            "help": {
