...
class TestStaticSolver():
    def test_case(self):
        ...
        model.add_isotropic_material('steel',7.85e10,2e11,0.3,1e-7)
        model.add_beam_section_general('section','steel',A=0.0188,As2=0,As3=0,I22=4.023e-5,I33=4.771e-4,J=4.133e-6,W22=0,W33=0)
        model.add_beam("A","1","2",'section')
    ...
    def test_cantilever_beam(self):
        ...
        model.add_node("2",6,0,0)
        model.add_isotropic_material('steel',7.85e10,2e11,0.3,1e-7)
        model.add_beam_section_I('H400x200x20x30','steel',0.400,0.200,0.020,0.030)
    ...
    def test_simply_supported_beam(self):
        ...
        model.add_beam_section_I('H400x200x20x30','steel',0.400,0.200,0.020,0.030)
        model.add_beam("A","1","2",'H400x200x20x30')
        model.add_beam("B","2","3",'H400x200x20x30')
...
class TestStaticSolverSimpleBeam():
    def test_case(self):
        path="./test"
        if sys.platform=="win32":
            path="c:\\test"
