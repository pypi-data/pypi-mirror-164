...
class PlatformApi(object):
    ...
    def get_all_workspaces(self, **kwargs):  # noqa: E501
        ...
        Fetches all workspaces  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def invite_colleague_to_join_workspace(self, invite_colleague_form_from_web, **kwargs):  # noqa: E501
        """Invite Colleague  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.invite_colleague_to_join_workspace(invite_colleague_form_from_web, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.invite_colleague_to_join_workspace_with_http_info(invite_colleague_form_from_web, **kwargs)  # noqa: E501

    def invite_colleague_to_join_workspace_with_http_info(self, invite_colleague_form_from_web, **kwargs):  # noqa: E501
        """Invite Colleague  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.invite_colleague_to_join_workspace_with_http_info(invite_colleague_form_from_web, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('invite_colleague_form_from_web' not in local_var_params or  # noqa: E501
                                                        local_var_params['invite_colleague_form_from_web'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `invite_colleague_form_from_web` when calling `invite_colleague_to_join_workspace`")  # noqa: E501
    ...
    def unified_upgrade(self, unified_upgrade_request_event, **kwargs):  # noqa: E501
        """Request Unified Upgrade  # noqa: E501

        Registers when a user requests an upgrade using the unified upgrade flow  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.unified_upgrade(unified_upgrade_request_event, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param UnifiedUpgradeRequestEvent unified_upgrade_request_event: (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.unified_upgrade_with_http_info(unified_upgrade_request_event, **kwargs)  # noqa: E501

    def unified_upgrade_with_http_info(self, unified_upgrade_request_event, **kwargs):  # noqa: E501
        """Request Unified Upgrade  # noqa: E501

        Registers when a user requests an upgrade using the unified upgrade flow  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.unified_upgrade_with_http_info(unified_upgrade_request_event, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method unified_upgrade" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'unified_upgrade_request_event' is set
        if self.api_client.client_side_validation and ('unified_upgrade_request_event' not in local_var_params or  # noqa: E501
                                                        local_var_params['unified_upgrade_request_event'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `unified_upgrade_request_event` when calling `unified_upgrade`")  # noqa: E501
        ...
        body_params = None
        if 'unified_upgrade_request_event' in local_var_params:
            body_params = local_var_params['unified_upgrade_request_event']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
