...
extensions = [
    Extension("kola.lexer", ["kola/lexer" + FILE_SUFFIX], include_dirs=[_home, os.path.join(_home, "kola")]),
    Extension("kola.parser", ["kola/parser" + FILE_SUFFIX], include_dirs=[_home, os.path.join(_home, "kola")])
]
if USE_CYTHON:
