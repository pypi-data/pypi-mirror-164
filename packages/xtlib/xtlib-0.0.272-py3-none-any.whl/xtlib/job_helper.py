...
job_info_props = {"_id": 1, "compute": 1, "compute_target": 1,"concurrent": 1, "exper_name": 1, "hold": 1, "job_id": 1, "job_num": 1,
    ...
    "pool_info": 1, "service_job_info": 1, "sku": 1, "sla": 1, "ws_name": 1, "sleep_on_exit": 1, "vm_size": 1}
...
user_to_actual = {"compute": "compute", "cluster": "cluster", "compute_target": "compute_target", 
    "docker": "environment", "experiment": "exper_name",
    "hold": "hold", "job": "job_id","job_num": "job_num", "low_pri": "low_pri", "num_dgd_seeds": "num_dgd_seeds",
    "node_count": "node_count", "primary_metric": "primary_metric", "queue": "queue", 
    "repeat": "repeat", "search": "search_type", "service_name": "service_name", "service_type": "service_type", 
    "sku": "sku", "runs": "run_count", "search_style": "search_style", "sla": "sla", 
    "started": "started", "username": "username", 
...
std_cols_desc = {
    ...
    "compute": "the AML compute name specified in the target for this job",
