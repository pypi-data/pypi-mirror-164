...
class KinesisStreamsToKinesisFirehoseToS3(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(KinesisStreamsToKinesisFirehoseToS3.__init__)
    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(kinesis_stream_props, dict):
            kinesis_stream_props = StreamProps(**kinesis_stream_props)
        ...
        if __debug__:
            type_hints = typing.get_type_hints(KinesisStreamsToKinesisFirehoseToS3Props.__init__)
