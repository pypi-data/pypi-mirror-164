...
class CodeCommitMirror(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CodeCommitMirror.__init__)
...
class CodeCommitMirrorProps:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(CodeCommitMirrorProps.__init__)
...
class CodeCommitMirrorSourceRepository(
    ...
    def git_hub(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CodeCommitMirrorSourceRepository.git_hub)
    ...
    def private(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CodeCommitMirrorSourceRepository.private)
            check_type(argname="argument name", value=name, expected_type=type_hints["name"])
...
class EcsServiceRoller(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EcsServiceRoller.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
...
class EcsServiceRollerProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EcsServiceRollerProps.__init__)
            check_type(argname="argument cluster", value=cluster, expected_type=type_hints["cluster"])
...
class EmailReceiver(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EmailReceiver.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
...
class EmailReceiverProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EmailReceiverProps.__init__)
...
class RollTrigger(
    ...
    def from_rule(cls, rule: aws_cdk.aws_events.Rule) -> "RollTrigger":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(RollTrigger.from_rule)
    ...
    def from_schedule(cls, schedule: aws_cdk.aws_events.Schedule) -> "RollTrigger":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(RollTrigger.from_schedule)
            check_type(argname="argument schedule", value=schedule, expected_type=type_hints["schedule"])
...
class SamlFederatedPrincipal(
    ...
    def __init__(self, identity_provider: "SamlIdentityProvider") -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SamlFederatedPrincipal.__init__)
...
class SamlIdentityProvider(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SamlIdentityProvider.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
...
class SamlIdentityProviderProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SamlIdentityProviderProps.__init__)
...
class SlackApp(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SlackApp.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        props = SlackAppProps(
...
class SlackAppManifest(
    ...
    def __init__(
        ...
        *,
        ...
        app_home: typing.Optional[typing.Union["SlackAppManifestAppHome", typing.Dict[str, typing.Any]]] = None,
        background_color: typing.Optional[builtins.str] = None,
        bot_user: typing.Optional[typing.Union["SlackkAppManifestBotUser", typing.Dict[str, typing.Any]]] = None,
        description: typing.Optional[builtins.str] = None,
        event_subscriptions: typing.Optional[typing.Union["SlackAppManifestEventSubscriptions", typing.Dict[str, typing.Any]]] = None,
        interactivity: typing.Optional[typing.Union["SlackAppManifestInteractivity", typing.Dict[str, typing.Any]]] = None,
        ...
        oauth_config: typing.Optional[typing.Union["SlackAppManifestOauthConfig", typing.Dict[str, typing.Any]]] = None,
        org_deploy: typing.Optional[builtins.bool] = None,
        shortcuts: typing.Optional[typing.Sequence[typing.Union["SlackAppManifestShortcut", typing.Dict[str, typing.Any]]]] = None,
        slash_commands: typing.Optional[typing.Sequence[typing.Union["SlackAppManifestSlashCommand", typing.Dict[str, typing.Any]]]] = None,
        socket_mode: typing.Optional[builtins.bool] = None,
        unfurl_domains: typing.Optional[typing.Sequence[builtins.str]] = None,
        workflow_steps: typing.Optional[typing.Sequence[typing.Union["SlackAppManifestWorkflowStep", typing.Dict[str, typing.Any]]]] = None,
    ) -> None:
        '''
    ...
    def render(self, construct: constructs.IConstruct) -> builtins.str:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SlackAppManifest.render)
...
class SlackAppManifestAppHome:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SlackAppManifestAppHome.__init__)
...
class SlackAppManifestDefinition(
    ...
    def from_file(cls, file: builtins.str) -> "SlackAppManifestDefinition":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SlackAppManifestDefinition.from_file)
    ...
    def from_string(cls, manifest: builtins.str) -> "SlackAppManifestDefinition":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SlackAppManifestDefinition.from_string)
...
class _SlackAppManifestDefinitionProxy(SlackAppManifestDefinition):
    ...
    def render(self, construct: constructs.IConstruct) -> builtins.str:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SlackAppManifestDefinition.render)
            check_type(argname="argument construct", value=construct, expected_type=type_hints["construct"])
        return typing.cast(builtins.str, jsii.invoke(self, "render", [construct]))
...
class SlackAppManifestEventSubscriptions:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SlackAppManifestEventSubscriptions.__init__)
...
class SlackAppManifestInteractivity:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SlackAppManifestInteractivity.__init__)
...
class SlackAppManifestOauthConfig:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SlackAppManifestOauthConfig.__init__)
...
class SlackAppManifestProps:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(SlackAppManifestProps.__init__)
            check_type(argname="argument name", value=name, expected_type=type_hints["name"])
    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(interactivity, dict):
            interactivity = SlackAppManifestInteractivity(**interactivity)
        if __debug__:
            type_hints = typing.get_type_hints(SlackAppManifestSettings.__init__)
            check_type(argname="argument allowed_ip_address_ranges", value=allowed_ip_address_ranges, expected_type=type_hints["allowed_ip_address_ranges"])
            check_type(argname="argument event_subscriptions", value=event_subscriptions, expected_type=type_hints["event_subscriptions"])
            check_type(argname="argument interactivity", value=interactivity, expected_type=type_hints["interactivity"])
            check_type(argname="argument org_deploy", value=org_deploy, expected_type=type_hints["org_deploy"])
...
class SlackAppManifestShortcut:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SlackAppManifestShortcut.__init__)
...
class SlackAppManifestSlashCommand:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SlackAppManifestSlashCommand.__init__)
...
class SlackAppManifestWorkflowStep:
    def __init__(self, *, callback_id: builtins.str, name: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SlackAppManifestWorkflowStep.__init__)
            check_type(argname="argument callback_id", value=callback_id, expected_type=type_hints["callback_id"])
            check_type(argname="argument name", value=name, expected_type=type_hints["name"])
        self._values: typing.Dict[str, typing.Any] = {
            "callback_id": callback_id,
...
class SlackAppProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SlackAppProps.__init__)
...
class SlackEvents(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SlackEvents.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
...
class SlackEventsProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SlackEventsProps.__init__)
...
class SlackTextract(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SlackTextract.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
...
class SlackTextractProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SlackTextractProps.__init__)
...
class SlackkAppManifestBotUser:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SlackkAppManifestBotUser.__init__)
...
class StateMachineCustomResourceProvider(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(StateMachineCustomResourceProvider.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
...
class StateMachineCustomResourceProviderProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(StateMachineCustomResourceProviderProps.__init__)
...
class StaticWebsite(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(StaticWebsite.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def default_security_headers_behavior(
        cls,
    ) -> aws_cdk.aws_cloudfront.ResponseSecurityHeadersBehavior:  # pyright: ignore [reportGeneralTypeIssues]
    ...
    def default_security_headers_behavior(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(StaticWebsite, "default_security_headers_behavior").fset)
...
class StaticWebsiteProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(StaticWebsiteProps.__init__)
...
class ToolkitCleaner(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ToolkitCleaner.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
...
class ToolkitCleanerProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ToolkitCleanerProps.__init__)
...
class UrlShortener(
    ...
    def __init__(
        ...
        *,
        hosted_zone: aws_cdk.aws_route53.IHostedZone,
        api_gateway_authorizer: typing.Optional[aws_cdk.aws_apigateway.IAuthorizer] = None,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(UrlShortener.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
...
class UrlShortenerProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(UrlShortenerProps.__init__)
            check_type(argname="argument hosted_zone", value=hosted_zone, expected_type=type_hints["hosted_zone"])
    ...
    def api_gateway_authorizer(
        self,
    ) -> typing.Optional[aws_cdk.aws_apigateway.IAuthorizer]:
