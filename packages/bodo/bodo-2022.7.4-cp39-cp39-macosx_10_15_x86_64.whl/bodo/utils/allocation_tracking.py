...
def get_allocation_stats():
    cuscz__dbih = get_allocation_stats_arr(), get_allocation_stats_dec(
        ), get_allocation_stats_pq(), get_allocation_stats_qa()
    fvozg__jyngs, zmc__jsse, yjbgb__slql, sfnh__yyzu = 0, 0, 0, 0
    for nou__fvq in cuscz__dbih:
        fvozg__jyngs += nou__fvq[0]
        zmc__jsse += nou__fvq[1]
        yjbgb__slql += nou__fvq[2]
        sfnh__yyzu += nou__fvq[3]
    return fvozg__jyngs, zmc__jsse, yjbgb__slql, sfnh__yyzu
