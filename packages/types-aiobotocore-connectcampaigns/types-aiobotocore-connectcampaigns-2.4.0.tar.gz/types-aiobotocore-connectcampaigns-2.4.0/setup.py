...
setup(
    ...
    description=(
        "Type annotations for aiobotocore.ConnectCampaignService 2.4.0 service generated with"
        " mypy-boto3-builder 7.11.8"
    ),
    classifiers=[
    ...
    package_data={"": ["LICENSE"], "types_aiobotocore_connectcampaigns": ["py.typed", "*.pyi"]},
    python_requires=">=3.7",
    project_urls={
        "Documentation": (
