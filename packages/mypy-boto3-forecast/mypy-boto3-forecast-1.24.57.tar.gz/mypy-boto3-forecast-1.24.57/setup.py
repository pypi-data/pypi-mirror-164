...
setup(
    ...
    description=(
        "Type annotations for boto3.ForecastService 1.24.57 service generated with"
        " mypy-boto3-builder 7.11.7"
    ),
    classifiers=[
    ...
    package_data={"": ["LICENSE"], "mypy_boto3_forecast": ["py.typed", "*.pyi"]},
    python_requires=">=3.7",
    project_urls={
