...
from suite_py.lib import changelog as cl
...
class Deploy:
    ...
    def run(self):
        ...
        if current_version != "":
            ...
            new_version = self._version.select_new_version(current_version)
        ...
        if cl.changelog_exists():
            latest_tag, latest_entry = cl.get_latest_entry_with_tag()
