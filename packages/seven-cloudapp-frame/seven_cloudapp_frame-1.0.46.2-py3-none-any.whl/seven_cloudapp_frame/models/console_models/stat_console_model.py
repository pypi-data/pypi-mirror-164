...
@LastEditTime: 2022-08-24 18:52:06
...
class StatUserDataWork(TimingWork):
    ...
    def clear_report(self):
        ...
        while True:
            stat_user_report_list = stat_user_report_model.get_dict_list(where="create_day<%s", order_by="id asc", limit="100", params=[SevenHelper.get_now_day_int(-24 * 30 * space_day)])
