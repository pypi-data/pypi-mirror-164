...
class DevelopCmd(develop):
    prefix_targets = [
        ("nbconvert/templates", 'greenwood_template'),
        ("voila/templates", 'greenwood_template')
    ]
    def run(self):
...
setup(
    name='greenwood-template',
    version="0.0.6",
    description="Greenwood template for voila",
    data_files=data_files,
    include_package_data=True,
    author='Greenwood Labs',
    install_requires=['voila>=0.2.1,<0.4.0'],
    url='https://github.com/greenwood-labs/voila-greenwood-material',
    keywords=[
        'ipython',
        'jupyter',
        'widgets',
