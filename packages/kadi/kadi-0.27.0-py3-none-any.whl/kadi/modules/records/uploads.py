...
def save_chunk(*, upload, file_object, index, size, checksum=None):
    ...
    try:
        ...
        # Always update the upload's timestamp since the timestamp is used for checking
        # the upload's expiration.
...
def complete_file_upload(upload):
    ...
    :return: The resulting new or updated file or ``None`` if a file to be
