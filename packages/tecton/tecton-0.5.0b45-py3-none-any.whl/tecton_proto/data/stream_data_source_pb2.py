...
_SPARKSTREAMDATASOURCEFUNCTION = _descriptor.Descriptor(
  name='SparkStreamDataSourceFunction',
  full_name='tecton_proto.data.SparkStreamDataSourceFunction',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='function', full_name='tecton_proto.data.SparkStreamDataSourceFunction.function', index=0,
...
_STREAMDATASOURCE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='spark_data_source_function', full_name='tecton_proto.data.StreamDataSource.spark_data_source_function', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='spark_schema', full_name='tecton_proto.data.StreamDataSource.spark_schema', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='raw_stream_translator', full_name='tecton_proto.data.StreamDataSource.raw_stream_translator', index=4,
    ...
    _descriptor.FieldDescriptor(
      name='deduplication_column_names', full_name='tecton_proto.data.StreamDataSource.deduplication_column_names', index=5,
    ...
    _descriptor.FieldDescriptor(
      name='time_column', full_name='tecton_proto.data.StreamDataSource.time_column', index=6,
    ...
    _descriptor.FieldDescriptor(
      name='stream_config', full_name='tecton_proto.data.StreamDataSource.stream_config', index=7,
    ...
    _descriptor.FieldDescriptor(
      name='options', full_name='tecton_proto.data.StreamDataSource.options', index=8,
...
_SPARKSTREAMDATASOURCEFUNCTION.fields_by_name['function'].message_type = tecton__proto_dot_args_dot_user__defined__function__pb2._USERDEFINEDFUNCTION
...
_STREAMDATASOURCE.fields_by_name['spark_data_source_function'].message_type = _SPARKSTREAMDATASOURCEFUNCTION
...
_STREAMDATASOURCE.oneofs_by_name['stream_source'].fields.append(
  _STREAMDATASOURCE.fields_by_name['spark_data_source_function'])
_STREAMDATASOURCE.fields_by_name['spark_data_source_function'].containing_oneof = _STREAMDATASOURCE.oneofs_by_name['stream_source']
...
DESCRIPTOR.message_types_by_name['SparkStreamDataSourceFunction'] = _SPARKSTREAMDATASOURCEFUNCTION
...
SparkStreamDataSourceFunction = _reflection.GeneratedProtocolMessageType('SparkStreamDataSourceFunction', (_message.Message,), {
  'DESCRIPTOR' : _SPARKSTREAMDATASOURCEFUNCTION,
  '__module__' : 'tecton_proto.data.stream_data_source_pb2'
  # @@protoc_insertion_point(class_scope:tecton_proto.data.SparkStreamDataSourceFunction)
  })
_sym_db.RegisterMessage(SparkStreamDataSourceFunction)
