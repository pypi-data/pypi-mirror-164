...
_VIRTUALDATASOURCEARGS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\222M\002\010\006', json_name='hiveDsConfig', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\222M\002\010\006', json_name='fileDsConfig', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\222M\002\010\006', json_name='redshiftDsConfig', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\222M\002\010\006', json_name='snowflakeDsConfig', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='spark_batch_config', full_name='tecton_proto.args.VirtualDataSourceArgs.spark_batch_config', index=7,
      number=11, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\222M\002\010\006', json_name='sparkBatchConfig', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='kinesis_ds_config', full_name='tecton_proto.args.VirtualDataSourceArgs.kinesis_ds_config', index=8,
    ...
    _descriptor.FieldDescriptor(
      name='kafka_ds_config', full_name='tecton_proto.args.VirtualDataSourceArgs.kafka_ds_config', index=9,
    ...
    _descriptor.FieldDescriptor(
      name='spark_stream_config', full_name='tecton_proto.args.VirtualDataSourceArgs.spark_stream_config', index=10,
      number=12, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='sparkStreamConfig', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='type', full_name='tecton_proto.args.VirtualDataSourceArgs.type', index=11,
    ...
    _descriptor.FieldDescriptor(
      name='test_only_schema', full_name='tecton_proto.args.VirtualDataSourceArgs.test_only_schema', index=12,
...
_VIRTUALDATASOURCEARGS.fields_by_name['spark_batch_config'].message_type = tecton__proto_dot_args_dot_data__source__pb2._SPARKBATCHCONFIGARGS
...
_VIRTUALDATASOURCEARGS.fields_by_name['spark_stream_config'].message_type = tecton__proto_dot_args_dot_data__source__pb2._SPARKSTREAMCONFIGARGS
...
_VIRTUALDATASOURCEARGS.oneofs_by_name['batch_ds_config'].fields.append(
  _VIRTUALDATASOURCEARGS.fields_by_name['spark_batch_config'])
_VIRTUALDATASOURCEARGS.fields_by_name['spark_batch_config'].containing_oneof = _VIRTUALDATASOURCEARGS.oneofs_by_name['batch_ds_config']
...
_VIRTUALDATASOURCEARGS.oneofs_by_name['stream_ds_config'].fields.append(
  _VIRTUALDATASOURCEARGS.fields_by_name['spark_stream_config'])
_VIRTUALDATASOURCEARGS.fields_by_name['spark_stream_config'].containing_oneof = _VIRTUALDATASOURCEARGS.oneofs_by_name['stream_ds_config']
