...
_JOINKEYCOMPONENT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='column_type', full_name='tecton_proto.data.JoinKeyComponent.column_type', index=2,
      number=3, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='columnType', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='data_type', full_name='tecton_proto.data.JoinKeyComponent.data_type', index=3,
...
_JOINKEYCOMPONENT.fields_by_name['column_type'].enum_type = tecton__proto_dot_common_dot_column__type__pb2._COLUMNTYPE
_JOINKEYCOMPONENT.fields_by_name['data_type'].message_type = tecton__proto_dot_common_dot_data__type__pb2._DATATYPE
