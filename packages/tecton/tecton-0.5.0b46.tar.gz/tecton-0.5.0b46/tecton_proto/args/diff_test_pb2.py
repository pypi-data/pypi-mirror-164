...
_DIFFTESTARGS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='recreate_suppressable_nested_field', full_name='tecton_proto.args.DiffTestArgs.recreate_suppressable_nested_field', index=6,
      number=8, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\222M\002\010\006', json_name='recreateSuppressableNestedField', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='unannotated_needing_recreate', full_name='tecton_proto.args.DiffTestArgs.unannotated_needing_recreate', index=7,
      number=7, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='unannotatedNeedingRecreate', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
  ],
  extensions=[
  ],
  nested_types=[],
...
_DIFFTESTNESTEDINNER = _descriptor.Descriptor(
  name='DiffTestNestedInner',
  full_name='tecton_proto.args.DiffTestNestedInner',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='inplace_field', full_name='tecton_proto.args.DiffTestNestedInner.inplace_field', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\222M\002\010\001', json_name='inplaceField', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
  ],
  extensions=[
  ],
  nested_types=[],
...
_DIFFTESTNESTEDOUTER = _descriptor.Descriptor(
  name='DiffTestNestedOuter',
  full_name='tecton_proto.args.DiffTestNestedOuter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='args', full_name='tecton_proto.args.DiffTestNestedOuter.args', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_DIFFTESTARGS.fields_by_name['recreate_suppressable_nested_field'].message_type = _DIFFTESTNESTEDINNER
_DIFFTESTNESTEDOUTER.fields_by_name['args'].message_type = _DIFFTESTARGS
DESCRIPTOR.message_types_by_name['DiffTestFoo'] = _DIFFTESTFOO
DESCRIPTOR.message_types_by_name['DiffTestArgs'] = _DIFFTESTARGS
DESCRIPTOR.message_types_by_name['DiffTestNestedInner'] = _DIFFTESTNESTEDINNER
DESCRIPTOR.message_types_by_name['DiffTestNestedOuter'] = _DIFFTESTNESTEDOUTER
...
DiffTestNestedInner = _reflection.GeneratedProtocolMessageType('DiffTestNestedInner', (_message.Message,), {
  'DESCRIPTOR' : _DIFFTESTNESTEDINNER,
  '__module__' : 'tecton_proto.args.diff_test_pb2'
  # @@protoc_insertion_point(class_scope:tecton_proto.args.DiffTestNestedInner)
  })
_sym_db.RegisterMessage(DiffTestNestedInner)

DiffTestNestedOuter = _reflection.GeneratedProtocolMessageType('DiffTestNestedOuter', (_message.Message,), {
  'DESCRIPTOR' : _DIFFTESTNESTEDOUTER,
  '__module__' : 'tecton_proto.args.diff_test_pb2'
  # @@protoc_insertion_point(class_scope:tecton_proto.args.DiffTestNestedOuter)
  })
_sym_db.RegisterMessage(DiffTestNestedOuter)
