...
class BelBankAPI:
    ...
    def get_atms(self, city='', ATM_currency=''):
        """
    ...
    def get_deposits(self, deposit_currency=''):
        """
    ...
    def get_credits(self, credit_type=''):
        """
    ...
    def get_filials(self, city='', service=''):
        """
