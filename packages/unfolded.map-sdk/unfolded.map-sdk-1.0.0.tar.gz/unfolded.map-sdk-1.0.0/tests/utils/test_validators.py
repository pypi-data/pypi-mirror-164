...
class TestValidateKwargs:
    def test_one_arg(self):
        ...
        # Default params are n_args=2, positional_only=None
        # pylint:disable=unused-argument
        @validate_kwargs(n_args=1)
    ...
    def test_two_args(self):
        # pylint:disable=unused-argument
        @validate_kwargs(n_args=2, positional_only=None)
    ...
    def test_positional_only_arg(self):
        # pylint:disable=unused-argument
        @validate_kwargs(n_args=1, positional_only=["foo"])
