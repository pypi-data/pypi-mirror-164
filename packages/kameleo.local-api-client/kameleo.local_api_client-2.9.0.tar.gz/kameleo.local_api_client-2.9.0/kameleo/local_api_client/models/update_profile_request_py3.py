...
class UpdateProfileRequest(Model):
    ...
    def __init__(self, *, canvas, webgl, audio, timezone, geolocation, proxy, web_rtc, fonts, plugins, screen, start_page: str, password_manager, extensions=None, notes: str=None, launcher: str=None, **kwargs) -> None:
