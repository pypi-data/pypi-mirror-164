...
class EnumField(Field):
    ...
    def __init__(self, source, enum_class: Enum, operator: str = "eq"):
        super().__init__(source, operator=operator)
...
class BooleanField(Field):
    ...
    def __init__(self, source, operator: str = "eq", truthy: List = [], falsy: List = []):
        super().__init__(source, operator=operator)
...
class ArrayField(Field):
    ...
    def __init__(self, source, operator: str = "contains"):
        super().__init__(source, operator=operator)
...
class DateField(Field):
    ...
    def __init__(self, source, operator: str = "eq", format: str = None):
        super().__init__(source, operator=operator)
