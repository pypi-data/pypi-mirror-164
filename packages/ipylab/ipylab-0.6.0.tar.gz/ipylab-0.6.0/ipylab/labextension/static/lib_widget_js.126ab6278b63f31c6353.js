...
/* harmony import */ var _jupyter_widgets_base__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @jupyter-widgets/base */ "webpack/sharing/consume/default/@jupyter-widgets/base?8add");
...
class ShellModel extends _jupyter_widgets_base__WEBPACK_IMPORTED_MODULE_1__.WidgetModel {
    ...
    async _add(payload) {
        ...
        luminoWidget.id = id !== null && id !== void 0 ? id : _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_0__.DOMUtils.createDomID();
        _lumino_messaging__WEBPACK_IMPORTED_MODULE_3__.MessageLoop.installMessageHook(luminoWidget, (handler, msg) => {
            switch (msg.type) {
                case 'close-request': {
