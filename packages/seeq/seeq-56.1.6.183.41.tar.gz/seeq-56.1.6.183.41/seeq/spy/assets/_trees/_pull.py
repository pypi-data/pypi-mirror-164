...
def pull_tree(session: Session, node_id, workbook_id, datasource, status, errors):
    """
    ...
    df = _properties.process_properties(session,
                                        ...
                                        datasource, status, errors, existing_tree_df)

    df = pull_all_children_of_all_nodes(session, df, workbook_id, datasource, status, errors,
                                        existing_tree_df)
...
def pull_all_children_of_all_nodes(session: Session, df, workbook_id, datasource, status, errors,
