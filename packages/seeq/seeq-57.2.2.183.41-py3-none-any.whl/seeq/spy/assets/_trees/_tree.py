...
class Tree:
    ...
    def __init__(self, data, *, friendly_name=None, description=None, workbook=_common.DEFAULT_WORKBOOK_PATH,
                 datasource=None, convert_displays_to_sdl=True, quiet=False, errors='raise', status=None,
        ...
        if isinstance(data, pd.DataFrame):
            ...
            df: KeyedDataFrame = _validate.validate_and_filter(self.session, data, status, errors, stage='input',
            ...
            df = _properties.process_properties(self.session, df, self._display_template_map, self._datasource, status,
                                                errors, existing_tree_df)
            ...
            df = _pull.pull_all_children_of_all_nodes(self.session, df, self._workbook_id,
                                                      ...
                                                      status, errors, existing_tree_df,
            ...
            if existing_node_id:
                ...
                df = _pull.pull_tree(self.session, existing_node_id, self._workbook_id, self._display_template_map,
                                     self._datasource, status, errors)
    ...
    def insert(self, children=None, parent=None, *, name=None, formula=None, formula_parameters=None,
        ...
        children = _properties.process_properties(self.session, children, display_template_map, self._datasource,
                                                  status, errors, keep_parent_column=True)
    ...
    def push(self, *, errors=None, quiet=None, status=None):
        ...
        _properties.push_and_replace_display_templates(self.session, self._dataframe, self._display_template_map,
                                                       self._datasource, self._workbook_id)
        ...
        if self._workbook and self._workbook_id == _common.EMPTY_GUID:
