...
- Now click you want sinhala subtitles of tv series
- Copy url and Paste it as bulk url
- Run the program and download all subtitles of you selected tv series

OPTIONAL
- If you want change download path, Add it as download_path
...
def download(bulk_url, download_path):
    try:
