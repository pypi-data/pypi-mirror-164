...
print('---------- Boards ----------')
print('Pimu:            %s'%p.board_info['board_variant'])
print('Wacc:            %s'%w.board_info['board_variant'])
print('Left wheel:      %s' %b.left_wheel.board_info['board_variant'])
print('Right wheel:     %s' %b.right_wheel.board_info['board_variant'])
print('Lift stepper:    %s' %l.motor.board_info['board_variant'])
print('Arm stepper:     %s' %a.motor.board_info['board_variant'])
print('---------- Firmware ----------')
