...
group.add_argument("--cliff", help="Scope base cliff sensors",action="store_true")
group.add_argument("--at_cliff", help="Scope base at_cliff signal",action="store_true")
group.add_argument("--voltage", help="Scope bus voltage (V)",action="store_true")
group.add_argument("--current", help="Scope bus current (A)",action="store_true")
group.add_argument("--temp", help="Scope base internal temperature (C)",action="store_true")
group.add_argument("--ax", help="Scope base accelerometer AX",action="store_true")
group.add_argument("--ay", help="Scope base accelerometer AY",action="store_true")
group.add_argument("--az", help="Scope base accelerometer AZ",action="store_true")
group.add_argument("--mx", help="Scope base magnetometer MX",action="store_true")
group.add_argument("--my", help="Scope base magnetometer MY",action="store_true")
group.add_argument("--mz", help="Scope base magnetometer MZ",action="store_true")
group.add_argument("--gx", help="Scope base gyro GX",action="store_true")
group.add_argument("--gy", help="Scope base gyro GY",action="store_true")
group.add_argument("--gz", help="Scope base gyro GZ",action="store_true")
group.add_argument("--roll", help="Scope base imu Roll",action="store_true")
group.add_argument("--pitch", help="Scope base imu Pitch",action="store_true")
group.add_argument("--heading", help="Scope base imu Heading",action="store_true")
group.add_argument("--bump", help="Scope base imu bump level",action="store_true")
