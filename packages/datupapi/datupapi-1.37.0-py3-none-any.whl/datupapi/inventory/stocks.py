...
class Stocks(Config):
        ...
        def clean_and_format(self,df_invopt):
            ...
            try:
                df=df_invopt.copy()
                indicators=['Item','ItemDescription','Location','LocationDescription','Inventory','Transit', 'Transfer',
                ...
                cols1 = ['InventoryUnit','Inventory', 'ReorderDays', 'Transit', 'Committed', 'Transfer',          
                    'DemandHistory','SuggestedForecast','NextSuggestedForecast','BackSuggestedForecast',
