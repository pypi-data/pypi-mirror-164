...
from telecms.db import migrations, models
import telecms.db.models.deletion
import telecms.utils.timezone
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_add', models.DateTimeField(default=telecms.utils.timezone.now, verbose_name='date added')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('params', models.TextField(blank=True, default='', verbose_name='params')),
                ('date_add', models.DateTimeField(default=telecms.utils.timezone.now, verbose_name='date added')),
                ('dashboard', models.ForeignKey(on_delete=telecms.db.models.deletion.CASCADE, related_name='widgets', to='telecms_django.Dashboard', verbose_name='dashboard')),
            ],
            options={
                'verbose_name': 'widget',
