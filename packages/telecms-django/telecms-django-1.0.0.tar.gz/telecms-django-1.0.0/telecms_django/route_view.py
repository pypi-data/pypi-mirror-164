import os
import sys
from telecms.http import HttpResponse, HttpResponseRedirect
from telecms.http.response import HttpResponseBase
from telecms.template import Template
from telecms.template.context import Context
from telecms.views import generic
from telecms.views.decorators.csrf import csrf_exempt

from telecms_bridge_base import settings as base_settings
from telecms_bridge_base.request import Request
from telecms_bridge_base.responses.base import Response
from telecms_bridge_base.responses.optional_json import OptionalJSONResponse
from telecms_bridge_base.responses.redirect import RedirectResponse
from telecms_bridge_base.responses.template import TemplateResponse

from telecms_bridge_base.status import HTTP_204_NO_CONTENT
