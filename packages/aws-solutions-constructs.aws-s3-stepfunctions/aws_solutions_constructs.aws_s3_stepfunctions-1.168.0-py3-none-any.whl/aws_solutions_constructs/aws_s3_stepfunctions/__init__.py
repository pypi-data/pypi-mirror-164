...
class S3ToStepfunctions(
    ...
    def __init__(
        ...
        *,
        ...
        event_rule_props: typing.Optional[typing.Union[aws_cdk.aws_events.RuleProps, typing.Dict[str, typing.Any]]] = None,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(S3ToStepfunctions.__init__)
    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(state_machine_props, dict):
            state_machine_props = StateMachineProps(**state_machine_props)
        if isinstance(bucket_props, dict):
            bucket_props = BucketProps(**bucket_props)
        if isinstance(event_rule_props, dict):
            event_rule_props = RuleProps(**event_rule_props)
        ...
        if __debug__:
            type_hints = typing.get_type_hints(S3ToStepfunctionsProps.__init__)
