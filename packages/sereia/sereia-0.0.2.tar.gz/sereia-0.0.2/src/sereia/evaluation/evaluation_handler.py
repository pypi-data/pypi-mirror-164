...
from sereia.utils import ConfigHandler,get_logger,next_path,last_path
...
class EvaluationHandler:
    ...
    def evaluate_query_matches(self,results,**kwargs):
        ...
        for item in results['results']:
            ...
            if 'query_matches' in item and 'query_matches' in self.golden_standards[item['keyword_query']]:
                ...
                print('golden qm: {}'.format(golden_qm))
    ...
    def evaluate_retrieved_documents(self, results):
        ...
        GROUND_TRUTH_FOLDER = './../ground_truth/{}/'.format(DefaultConfiguration.DATABASE)
        ...
        database_collections = databases_collection_ids[DefaultConfiguration.DATABASE]
