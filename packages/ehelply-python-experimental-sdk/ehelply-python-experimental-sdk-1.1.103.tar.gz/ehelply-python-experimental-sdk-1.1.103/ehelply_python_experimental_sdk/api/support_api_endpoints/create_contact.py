...
# body param
SchemaForRequestBodyApplicationJson = Contact
...
_path = '/sam/support/contact'
_method = 'POST'
SchemaFor200ResponseBodyApplicationJson = ContactResponse
...
class CreateContact(api_client.Api):
