...
# body param
SchemaForRequestBodyApplicationJson = ProjectsProjectCreate


request_body_projects_project_create = api_client.RequestBody(
    content={
...
_path = '/sam/projects/projects'
_method = 'POST'
SchemaFor200ResponseBodyApplicationJson = ProjectDB
...
class CreateProject(api_client.Api):
    ...
    def create_project(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_projects_project_create.serialize(body, content_type)
