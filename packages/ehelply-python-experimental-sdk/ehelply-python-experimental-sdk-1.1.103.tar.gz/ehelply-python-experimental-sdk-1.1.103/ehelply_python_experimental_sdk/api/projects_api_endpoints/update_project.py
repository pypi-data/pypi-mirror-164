...
# body param
SchemaForRequestBodyApplicationJson = ProjectsProjectUpdate


request_body_projects_project_update = api_client.RequestBody(
    content={
...
_path = '/sam/projects/projects/{project_uuid}'
_method = 'PUT'
...
class UpdateProject(api_client.Api):
    ...
    def update_project(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_projects_project_update.serialize(body, content_type)
