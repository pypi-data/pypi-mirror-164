...
RequestOptionalQueryParams = typing.TypedDict(
    ...
    {
        'with_invoice': WithInvoiceSchema,
        'year': YearSchema,
        'month': MonthSchema,
    },
    total=False
...
request_query_with_invoice = api_client.QueryParameter(
    name="with_invoice",
    style=api_client.ParameterStyle.FORM,
    schema=WithInvoiceSchema,
    explode=True,
)
...
_path = '/sam/projects/projects/{project_uuid}/invoices'
_method = 'GET'
SchemaFor200ResponseBodyApplicationJson = GetProjectInvoiceResponse
...
class GetProjectInvoice(api_client.Api):
