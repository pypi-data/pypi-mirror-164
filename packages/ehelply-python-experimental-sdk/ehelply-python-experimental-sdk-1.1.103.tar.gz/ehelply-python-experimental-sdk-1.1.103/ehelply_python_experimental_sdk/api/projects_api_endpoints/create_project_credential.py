...
# body param
SchemaForRequestBodyApplicationJson = CreateProjectCredential


request_body_create_project_credential = api_client.RequestBody(
    content={
...
_path = '/sam/projects/projects/{project_uuid}/credentials'
_method = 'POST'
...
class CreateProjectCredential(api_client.Api):
    ...
    def create_project_credential(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_create_project_credential.serialize(body, content_type)
