...
_path = '/sam/projects/projects/{project_uuid}/members'
_method = 'GET'
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    @classmethod
    @property
    def _items(cls) -> typing.Type['ProjectsProjectMemberDB']:
...
class GetProjectMembers(api_client.Api):
