...
# body param
SchemaForRequestBodyApplicationJson = ParticipantCreate


request_body_participant_create = api_client.RequestBody(
    content={
...
_path = '/sam/users/participants'
_method = 'POST'
SchemaFor200ResponseBodyApplicationJson = ParticipantUserReturn
...
class CreateParticipant(api_client.Api):
    ...
    def create_participant(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_participant_create.serialize(body, content_type)
