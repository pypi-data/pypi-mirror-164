...
# body param
SchemaForRequestBodyApplicationJson = ParticipantUpdate


request_body_participant_update = api_client.RequestBody(
    content={
...
class UpdateParticipant(api_client.Api):
    ...
    def update_participant(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_participant_update.serialize(body, content_type)
