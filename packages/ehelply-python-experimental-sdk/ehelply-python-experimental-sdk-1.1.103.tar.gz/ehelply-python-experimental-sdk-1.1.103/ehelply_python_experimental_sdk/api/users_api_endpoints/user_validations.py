...
# body param
SchemaForRequestBodyApplicationJson = UserValidations


request_body_user_validations = api_client.RequestBody(
    content={
...
_path = '/sam/users/validations/{field}'
_method = 'POST'
...
class UserValidations(api_client.Api):
    ...
    def user_validations(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_user_validations.serialize(body, content_type)
