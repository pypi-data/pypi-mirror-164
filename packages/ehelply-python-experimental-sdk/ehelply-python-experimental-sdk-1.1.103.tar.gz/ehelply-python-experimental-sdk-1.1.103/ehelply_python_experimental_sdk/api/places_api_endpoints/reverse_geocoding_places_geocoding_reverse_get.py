...
# query params
LongSchema = NumberSchema
LatSchema = NumberSchema
...
request_query_long = api_client.QueryParameter(
    name="long",
...
_path = '/places/geocoding/reverse'
_method = 'GET'
...
class ReverseGeocodingPlacesGeocodingReverseGet(api_client.Api):
