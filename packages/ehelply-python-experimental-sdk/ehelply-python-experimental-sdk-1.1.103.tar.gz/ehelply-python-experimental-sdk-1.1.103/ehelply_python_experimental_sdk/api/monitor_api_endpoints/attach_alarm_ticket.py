...
# body param
SchemaForRequestBodyApplicationJson = AlarmTicket


request_body_alarm_ticket = api_client.RequestBody(
    content={
...
_path = '/sam/monitor/services/{service}/stages/{stage}/alarms/{alarm_uuid}/ticket'
_method = 'POST'
...
class AttachAlarmTicket(api_client.Api):
    ...
    def attach_alarm_ticket(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_alarm_ticket.serialize(body, content_type)
