...
# body param
SchemaForRequestBodyApplicationJson = AlarmNote


request_body_alarm_note = api_client.RequestBody(
    content={
...
_path = '/sam/monitor/services/{service}/stages/{stage}/alarms/{alarm_uuid}/note'
_method = 'POST'
...
class AttachAlarmNote(api_client.Api):
    ...
    def attach_alarm_note(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_alarm_note.serialize(body, content_type)
