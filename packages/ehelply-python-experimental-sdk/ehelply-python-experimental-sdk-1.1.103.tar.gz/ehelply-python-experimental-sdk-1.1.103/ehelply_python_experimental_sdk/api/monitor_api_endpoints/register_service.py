...
# body param
SchemaForRequestBodyApplicationJson = ServiceCreate


request_body_service_create = api_client.RequestBody(
    content={
...
class RegisterService(api_client.Api):
    ...
    def register_service(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_service_create.serialize(body, content_type)
