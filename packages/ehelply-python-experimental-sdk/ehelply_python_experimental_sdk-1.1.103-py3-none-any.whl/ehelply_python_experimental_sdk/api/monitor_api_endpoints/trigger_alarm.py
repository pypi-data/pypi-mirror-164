...
# body param
SchemaForRequestBodyApplicationJson = AlarmCreate


request_body_alarm_create = api_client.RequestBody(
    content={
...
class TriggerAlarm(api_client.Api):
    ...
    def trigger_alarm(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_alarm_create.serialize(body, content_type)
