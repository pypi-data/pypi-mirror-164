...
# body param
SchemaForRequestBodyApplicationJson = AlarmTerminate


request_body_alarm_terminate = api_client.RequestBody(
    content={
...
_path = '/sam/monitor/services/{service}/stages/{stage}/alarms/{alarm_uuid}/terminate'
_method = 'POST'
...
class TerminateAlarm(api_client.Api):
    ...
    def terminate_alarm(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_alarm_terminate.serialize(body, content_type)
