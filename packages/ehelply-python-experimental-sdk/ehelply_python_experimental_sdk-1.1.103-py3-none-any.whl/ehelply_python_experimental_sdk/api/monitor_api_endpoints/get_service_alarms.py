...
IncludeTerminatedSchema = BoolSchema
IncludeClearedSchema = BoolSchema
...
RequestOptionalQueryParams = typing.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'include_terminated': IncludeTerminatedSchema,
        'include_cleared': IncludeClearedSchema,
    },
    total=False
)
...
request_query_include_terminated = api_client.QueryParameter(
    name="include_terminated",
    style=api_client.ParameterStyle.FORM,
    schema=IncludeTerminatedSchema,
    explode=True,
)
request_query_include_cleared = api_client.QueryParameter(
    name="include_cleared",
    style=api_client.ParameterStyle.FORM,
    schema=IncludeClearedSchema,
    explode=True,
)
# path params
...
_path = '/sam/monitor/services/{service}/stages/{stage}/alarms'
_method = 'GET'
...
class GetServiceAlarms(api_client.Api):
    ...
    def get_service_alarms(
        ...
        for parameter in (
            ...
            request_query_include_terminated,
            request_query_include_cleared,
        ):
