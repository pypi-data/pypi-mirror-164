...
# body param
SchemaForRequestBodyApplicationJson = AlarmIgnore


request_body_alarm_ignore = api_client.RequestBody(
    content={
...
_path = '/sam/monitor/services/{service}/stages/{stage}/alarms/{alarm_uuid}/ignore'
_method = 'POST'
...
class IgnoreAlarm(api_client.Api):
    ...
    def ignore_alarm(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_alarm_ignore.serialize(body, content_type)
