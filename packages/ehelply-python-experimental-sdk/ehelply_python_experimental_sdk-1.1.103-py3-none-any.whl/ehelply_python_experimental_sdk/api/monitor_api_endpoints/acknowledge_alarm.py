...
# body param
SchemaForRequestBodyApplicationJson = AlarmAcknowledge


request_body_alarm_acknowledge = api_client.RequestBody(
    content={
...
_path = '/sam/monitor/services/{service}/stages/{stage}/alarms/{alarm_uuid}/acknowledge'
_method = 'POST'
...
class AcknowledgeAlarm(api_client.Api):
    ...
    def acknowledge_alarm(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_alarm_acknowledge.serialize(body, content_type)
