...
# body param
SchemaForRequestBodyApplicationJson = CompanyBase


request_body_company_base = api_client.RequestBody(
    content={
...
class CreateCompanyPlacesCompaniesPost(api_client.Api):
    ...
    def create_company_places_companies_post(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_company_base.serialize(body, content_type)
