...
MemberUuidSchema = StrSchema
TicketIdSchema = StrSchema
...
request_path_member_uuid = api_client.PathParameter(
    name="member_uuid",
    style=api_client.ParameterStyle.SIMPLE,
    schema=MemberUuidSchema,
    required=True,
)
...
# body param
SchemaForRequestBodyApplicationJson = CreateTicket


request_body_create_ticket = api_client.RequestBody(
    content={
...
_path = '/sam/support/projects/{project_uuid}/members/{member_uuid}/tickets/{ticket_id}'
_method = 'PUT'
SchemaFor200ResponseBodyApplicationJson = TicketResponse
...
class UpdateTicket(api_client.Api):
    ...
    def update_ticket(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_create_ticket.serialize(body, content_type)
