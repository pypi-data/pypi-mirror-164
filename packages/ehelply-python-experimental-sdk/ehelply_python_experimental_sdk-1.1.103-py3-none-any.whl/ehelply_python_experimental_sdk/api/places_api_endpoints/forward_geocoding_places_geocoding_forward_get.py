...
# query params
SearchingPlaceSchema = StrSchema
...
request_query_searching_place = api_client.QueryParameter(
    name="searching_place",
    style=api_client.ParameterStyle.FORM,
    schema=SearchingPlaceSchema,
    required=True,
    explode=True,
)
# header params
...
_path = '/places/geocoding/forward'
_method = 'GET'
...
class ForwardGeocodingPlacesGeocodingForwardGet(api_client.Api):
