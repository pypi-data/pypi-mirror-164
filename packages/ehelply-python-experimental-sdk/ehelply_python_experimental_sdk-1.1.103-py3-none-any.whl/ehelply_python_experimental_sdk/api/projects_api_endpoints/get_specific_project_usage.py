...
_path = '/sam/projects/projects/{project_uuid}/usage/{usage_type_key}'
_method = 'GET'
SchemaFor200ResponseBodyApplicationJson = ProjectsProjectUsageDB
...
class GetSpecificProjectUsage(api_client.Api):
