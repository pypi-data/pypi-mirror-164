...
request_path_service_name = api_client.PathParameter(
    name="service_name",
    style=api_client.ParameterStyle.SIMPLE,
...
# body param
SchemaForRequestBodyApplicationJson = UpdateProjectCredentialRequest


request_body_update_project_credential_request = api_client.RequestBody(
    content={
...
_path = '/sam/projects/projects/{project_uuid}/credentials/{service_name}'
_method = 'PUT'
...
class UpdateProjectCredential(api_client.Api):
    ...
    def update_project_credential(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_update_project_credential_request.serialize(body, content_type)
