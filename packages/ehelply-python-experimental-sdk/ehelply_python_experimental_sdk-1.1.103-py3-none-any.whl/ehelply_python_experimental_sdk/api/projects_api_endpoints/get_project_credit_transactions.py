...
_path = '/sam/projects/projects/{project_uuid}/credits/{credit_uuid}/transactions'
_method = 'GET'
...
class GetProjectCreditTransactions(api_client.Api):

    def get_project_credit_transactions(
        self: api_client.Api,
