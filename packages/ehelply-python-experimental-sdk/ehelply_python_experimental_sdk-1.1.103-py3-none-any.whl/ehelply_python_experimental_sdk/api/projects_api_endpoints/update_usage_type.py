...
request_path_usage_type_key = api_client.PathParameter(
    name="usage_type_key",
    style=api_client.ParameterStyle.SIMPLE,
    schema=UsageTypeKeySchema,
    required=True,
)
# body param
SchemaForRequestBodyApplicationJson = ProjectsUsageTypeUpdate


request_body_projects_usage_type_update = api_client.RequestBody(
    content={
...
_path = '/sam/projects/usage/types/{usage_type_key}'
_method = 'PUT'
...
class UpdateUsageType(api_client.Api):
    ...
    def update_usage_type(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_projects_usage_type_update.serialize(body, content_type)
