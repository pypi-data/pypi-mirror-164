...
# body param
SchemaForRequestBodyApplicationJson = CreateProjectInvoice


request_body_create_project_invoice = api_client.RequestBody(
    content={
...
class CreateProjectInvoice(api_client.Api):
    ...
    def create_project_invoice(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_create_project_invoice.serialize(body, content_type)
