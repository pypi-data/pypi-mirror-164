...
_path = '/sam/projects/projects/{project_uuid}/invoices/history'
_method = 'GET'
SchemaFor200ResponseBodyApplicationJson = GetProjectInvoiceHistory
...
class GetProjectInvoiceHistory(api_client.Api):

    def get_project_invoice_history(
        self: api_client.Api,
