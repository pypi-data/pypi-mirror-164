...
# query params
DateStartSchema = StrSchema
DateEndSchema = StrSchema
DescSchema = BoolSchema
...
request_path_subject = api_client.PathParameter(
    name="subject",
    style=api_client.ParameterStyle.SIMPLE,
...
class GetSubjectLogs(api_client.Api):
