...
def Create_Labware_Needed(
    Labware_Format: Labware_Layout, N_Wells_Needed: int, N_Wells_Available: Union[int, Literal["All"]] = "All", Return_Original_Layout: bool = True
):
...
def well_range(Wells: str, Labware_Format: Union[Labware_Layout, Tuple[int, int]] = None, Direction: Union[Literal["Horizontal", "Vertical"]] = "Horizontal", Box: bool = False):
