...
import alphaui
from alphaui import encryptor, queueing

STATIC_TEMPLATE_LIB = pkg_resources.resource_filename("alphaui", "templates/")
STATIC_PATH_LIB = pkg_resources.resource_filename("alphaui", "templates/frontend/static")
BUILD_PATH_LIB = pkg_resources.resource_filename("alphaui", "templates/frontend/assets")
VERSION_FILE = pkg_resources.resource_filename("alphaui", "version.txt")
...
class App(FastAPI):
    ...
    def __init__(self, **kwargs):
        self.tokens = None
        self.auth = None
        self.blocks: Optional[alphaui.Blocks] = None
        super().__init__(**kwargs)

    def configure_app(self, blocks: alphaui.Blocks) -> None:
        auth = blocks.auth
        if auth is not None:
    ...
    @staticmethod
    def create_app(blocks: alphaui.Blocks) -> FastAPI:
