...
if TYPE_CHECKING:  # Only import for type checking (to avoid circular imports).
    from alphaui.components import IOComponent


@document()
class Parallel(alphaui.Interface):
    """
    ...
    def __init__(self, *interfaces: alphaui.Interface, **options):
        """
        Parameters:
...
@document()
class Series(alphaui.Interface):
    """
