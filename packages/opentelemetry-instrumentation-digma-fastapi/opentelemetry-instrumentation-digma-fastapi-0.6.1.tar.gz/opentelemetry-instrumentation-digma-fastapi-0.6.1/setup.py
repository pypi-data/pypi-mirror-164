...
PACKAGE_INFO = {}
version_file = (Path("src/opentelemetry/instrumentation/digma/fastapi") / "version.py").read_text()
exec(version_file, PACKAGE_INFO)

requires = [str(ir) for ir in parse_requirements(Path('requirements.txt').read_text())]

setup(
    name='opentelemetry-instrumentation-digma-fastapi',
    version=PACKAGE_INFO['__version__'],
    author='Roni Dover',
    author_email='rdover@digma.ai',
    description='Digma instrumentation for FastAPI',
