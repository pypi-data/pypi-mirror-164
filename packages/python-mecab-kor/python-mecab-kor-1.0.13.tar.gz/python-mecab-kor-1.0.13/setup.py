...
import setuptools
from setuptools import Extension as DefaultExtension
...
def install_requirements():
    ...
    if not requirements_installed:
        os.system(f"sh {os.path.join(scripts_directory, 'install_requirements.sh')}")
...
class Extension(DefaultExtension):
    def __init__(self, *args, **kwargs):
