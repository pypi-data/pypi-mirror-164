...
class MoldModelMasterDomain:
    ...
    def __init__(
        ...
        mold_model_master_cache: MoldModelMasterDomainCache,
        namespace_name: str,
        mold_name: str,
    ):
        ...
        self._mold_model_master_cache = mold_model_master_cache
        self._namespace_name = namespace_name
        self._mold_name = mold_name

    def load(
        self,
        request: request_.GetMoldModelMasterRequest,
    ) -> result_.GetMoldModelMasterResult:
        request.with_namespace_name(self._namespace_name)
        request.with_mold_name(self._mold_name)
        r = self._client.get_mold_model_master(
            request,
        )
        self._mold_model_master_cache.update(r.item)
        return r

    def update(
        self,
        request: request_.UpdateMoldModelMasterRequest,
    ) -> result_.UpdateMoldModelMasterResult:
        request.with_namespace_name(self._namespace_name)
        request.with_mold_name(self._mold_name)
        r = self._client.update_mold_model_master(
            request,
        )
        self._mold_model_master_cache.update(r.item)
        return r
    ...
    def delete(
        self,
        request: request_.DeleteMoldModelMasterRequest,
    ) -> result_.DeleteMoldModelMasterResult:
        request.with_namespace_name(self._namespace_name)
        request.with_mold_name(self._mold_name)
        r = self._client.delete_mold_model_master(
            request,
        )
        self._mold_model_master_cache.delete(r.item)
        return r
