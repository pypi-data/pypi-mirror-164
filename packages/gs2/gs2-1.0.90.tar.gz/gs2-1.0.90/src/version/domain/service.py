...
from version.domain.namespace import NamespaceDomain
...
class Gs2Version:
    ...
    def calculate_signature(
        self,
        request: request_.CalculateSignatureRequest,
    ) -> result_.CalculateSignatureResult:
        r = self._client.calculate_signature(
            request,
        )
        return r
