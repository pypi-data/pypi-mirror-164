...
class CategoryModelDomain:
    ...
    def __init__(
        ...
        category_model_cache: CategoryModelDomainCache,
        namespace_name: str,
        category_name: str,
    ):
        ...
        self._category_model_cache = category_model_cache
        self._namespace_name = namespace_name
        self._category_name = category_name

    def load(
        self,
        request: request_.GetCategoryModelRequest,
    ) -> result_.GetCategoryModelResult:
        request.with_namespace_name(self._namespace_name)
        request.with_category_name(self._category_name)
        r = self._client.get_category_model(
            request,
        )
        self._category_model_cache.update(r.item)
        return r
