...
from quest.domain.quest_model import QuestModelDomain
...
class QuestGroupModelDomain:
    ...
    def __init__(
        ...
        quest_group_model_cache: QuestGroupModelDomainCache,
        namespace_name: str,
        ...
        self._quest_group_model_cache = quest_group_model_cache
        self._namespace_name = namespace_name
        self._quest_group_name = quest_group_name
        self._quest_model_cache = QuestModelDomainCache()

    def load(
        self,
        request: request_.GetQuestGroupModelRequest,
    ) -> result_.GetQuestGroupModelResult:
        request.with_namespace_name(self._namespace_name)
        request.with_quest_group_name(self._quest_group_name)
        r = self._client.get_quest_group_model(
            request,
        )
        self._quest_group_model_cache.update(r.item)
        return r

    def quest_models(
        self,
    ) -> DescribeQuestModelsIterator:
        return DescribeQuestModelsIterator(
            self._quest_model_cache,
            self._client,
