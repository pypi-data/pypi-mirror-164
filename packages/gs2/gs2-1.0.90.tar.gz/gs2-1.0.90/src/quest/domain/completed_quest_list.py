...
class CompletedQuestListDomain:
    ...
    def __init__(
        ...
        completed_quest_list_cache: CompletedQuestListDomainCache,
        namespace_name: str,
        user_id: str,
        ...
        self._completed_quest_list_cache = completed_quest_list_cache
    ...
    def load(
        self,
        request: request_.GetCompletedQuestListByUserIdRequest,
    ) -> result_.GetCompletedQuestListByUserIdResult:
        request.with_namespace_name(self._namespace_name)
        request.with_user_id(self._user_id)
        request.with_quest_group_name(self._quest_group_name)
        r = self._client.get_completed_quest_list_by_user_id(
            request,
        )
        self._completed_quest_list_cache.update(r.item)
        return r

    def delete(
        self,
        request: request_.DeleteCompletedQuestListByUserIdRequest,
    ) -> result_.DeleteCompletedQuestListByUserIdResult:
        request.with_namespace_name(self._namespace_name)
        request.with_user_id(self._user_id)
        request.with_quest_group_name(self._quest_group_name)
        r = self._client.delete_completed_quest_list_by_user_id(
            request,
        )
        self._completed_quest_list_cache.delete(r.item)
        return r
