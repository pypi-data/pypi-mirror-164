...
from job_queue.domain.namespace import NamespaceDomain
...
class Gs2JobQueue:
    ...
    def push_by_stamp_sheet(
        self,
        request: request_.PushByStampSheetRequest,
    ) -> result_.PushByStampSheetResult:
        r = self._client.push_by_stamp_sheet(
            request,
        )
        return r
