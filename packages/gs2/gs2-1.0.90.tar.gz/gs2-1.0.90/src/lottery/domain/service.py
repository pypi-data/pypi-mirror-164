...
from lottery.domain.namespace import NamespaceDomain
...
class Gs2Lottery:
    ...
    def draw_by_stamp_sheet(
        self,
        request: request_.DrawByStampSheetRequest,
    ) -> result_.DrawByStampSheetResult:
        r = self._client.draw_by_stamp_sheet(
            request,
        )
        return r
