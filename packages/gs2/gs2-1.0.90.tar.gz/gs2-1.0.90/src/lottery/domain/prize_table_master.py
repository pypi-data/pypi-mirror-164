...
class PrizeTableMasterDomain:
    ...
    def load(
        self,
        request: request_.GetPrizeTableMasterRequest,
    ) -> result_.GetPrizeTableMasterResult:
        request.with_namespace_name(self._namespace_name)
        request.with_prize_table_name(self._prize_table_name)
        r = self._client.get_prize_table_master(
            request,
        )
        self._prize_table_master_cache.update(r.item)
        return r

    def update(
        self,
        request: request_.UpdatePrizeTableMasterRequest,
    ) -> result_.UpdatePrizeTableMasterResult:
        request.with_namespace_name(self._namespace_name)
        request.with_prize_table_name(self._prize_table_name)
        r = self._client.update_prize_table_master(
            request,
        )
        self._prize_table_master_cache.update(r.item)
        return r
    ...
    def delete(
        self,
        request: request_.DeletePrizeTableMasterRequest,
    ) -> result_.DeletePrizeTableMasterResult:
        request.with_namespace_name(self._namespace_name)
        request.with_prize_table_name(self._prize_table_name)
        r = self._client.delete_prize_table_master(
            request,
        )
        self._prize_table_master_cache.delete(r.item)
        return r
