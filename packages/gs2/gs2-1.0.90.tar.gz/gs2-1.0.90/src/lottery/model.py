...
class Box(core.Gs2Model):
    ...
    def with_box_id(self, box_id: str) -> Box:
        self.box_id = box_id
        return self
    ...
    def with_drawn_indexes(self, drawn_indexes: List[int]) -> Box:
        self.drawn_indexes = drawn_indexes
        return self

    def with_created_at(self, created_at: int) -> Box:
        self.created_at = created_at
        return self

    def with_updated_at(self, updated_at: int) -> Box:
        self.updated_at = updated_at
        return self
    ...
    def from_dict(
        ...
        return Box()\
            ...
            .with_drawn_indexes([
                ...
                for i in range(len(data.get('drawnIndexes')) if data.get('drawnIndexes') else 0)
            ])\
            .with_created_at(data.get('createdAt'))\
            .with_updated_at(data.get('updatedAt'))
    ...
    def to_dict(self) -> Dict[str, Any]:
        return {
            ...
            "drawnIndexes": [
                ...
                for i in range(len(self.drawn_indexes) if self.drawn_indexes else 0)
            ],
            "createdAt": self.created_at,
            "updatedAt": self.updated_at,
        }
