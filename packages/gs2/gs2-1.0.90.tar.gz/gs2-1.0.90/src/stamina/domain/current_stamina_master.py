...
class CurrentStaminaMasterDomain:
    ...
    def load(
        self,
        request: request_.GetCurrentStaminaMasterRequest,
    ) -> result_.GetCurrentStaminaMasterResult:
        request.with_namespace_name(self._namespace_name)
        r = self._client.get_current_stamina_master(
            request,
        )
        return r
    ...
    def update(
        self,
        request: request_.UpdateCurrentStaminaMasterRequest,
    ) -> result_.UpdateCurrentStaminaMasterResult:
        request.with_namespace_name(self._namespace_name)
        r = self._client.update_current_stamina_master(
            request,
        )
        return r
    ...
    def update_from_git_hub(
        self,
        request: request_.UpdateCurrentStaminaMasterFromGitHubRequest,
    ) -> result_.UpdateCurrentStaminaMasterFromGitHubResult:
        request.with_namespace_name(self._namespace_name)
        r = self._client.update_current_stamina_master_from_git_hub(
            request,
        )
        return r
