...
class MaxStaminaTableMasterDomain:
    ...
    _namespace_name: str
    _max_stamina_table_name: str

    def __init__(
        self,
        session: Gs2RestSession,
        max_stamina_table_master_cache: MaxStaminaTableMasterDomainCache,
        namespace_name: str,
        ...
        self._max_stamina_table_master_cache = max_stamina_table_master_cache
        self._namespace_name = namespace_name
        self._max_stamina_table_name = max_stamina_table_name

    def load(
        self,
        request: request_.GetMaxStaminaTableMasterRequest,
    ) -> result_.GetMaxStaminaTableMasterResult:
        request.with_namespace_name(self._namespace_name)
        request.with_max_stamina_table_name(self._max_stamina_table_name)
        r = self._client.get_max_stamina_table_master(
            request,
        )
        self._max_stamina_table_master_cache.update(r.item)
        return r

    def update(
        self,
        request: request_.UpdateMaxStaminaTableMasterRequest,
    ) -> result_.UpdateMaxStaminaTableMasterResult:
        request.with_namespace_name(self._namespace_name)
        request.with_max_stamina_table_name(self._max_stamina_table_name)
        r = self._client.update_max_stamina_table_master(
            request,
        )
        self._max_stamina_table_master_cache.update(r.item)
        return r
    ...
    def delete(
        self,
        request: request_.DeleteMaxStaminaTableMasterRequest,
    ) -> result_.DeleteMaxStaminaTableMasterResult:
        request.with_namespace_name(self._namespace_name)
        request.with_max_stamina_table_name(self._max_stamina_table_name)
        r = self._client.delete_max_stamina_table_master(
            request,
        )
        self._max_stamina_table_master_cache.delete(r.item)
        return r
