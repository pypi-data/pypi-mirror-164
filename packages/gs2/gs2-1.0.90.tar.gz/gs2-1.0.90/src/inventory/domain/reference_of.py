...
class ReferenceOfDomain:
    ...
    def load(
        self,
        request: request_.GetReferenceOfByUserIdRequest,
    ) -> result_.GetReferenceOfByUserIdResult:
        ...
        r = self._client.get_reference_of_by_user_id(
            request,
        )
        return r
    ...
    def verify(
        self,
        request: request_.VerifyReferenceOfByUserIdRequest,
    ) -> result_.VerifyReferenceOfByUserIdResult:
        request.with_namespace_name(self._namespace_name)
        request.with_user_id(self._user_id)
        request.with_inventory_name(self._inventory_name)
        request.with_item_name(self._item_name)
        request.with_item_set_name(self._item_set_name)
        r = self._client.verify_reference_of_by_user_id(
            request,
        )
        return r
    ...
    def add(
        self,
        request: request_.AddReferenceOfByUserIdRequest,
    ) -> result_.AddReferenceOfByUserIdResult:
        request.with_namespace_name(self._namespace_name)
        request.with_user_id(self._user_id)
        request.with_inventory_name(self._inventory_name)
        request.with_item_name(self._item_name)
        request.with_item_set_name(self._item_set_name)
        r = self._client.add_reference_of_by_user_id(
            request,
        )
        return r
    ...
    def delete(
        self,
        request: request_.DeleteReferenceOfByUserIdRequest,
    ) -> result_.DeleteReferenceOfByUserIdResult:
        request.with_namespace_name(self._namespace_name)
        request.with_user_id(self._user_id)
        request.with_inventory_name(self._inventory_name)
        request.with_item_name(self._item_name)
        request.with_item_set_name(self._item_set_name)
        r = self._client.delete_reference_of_by_user_id(
            request,
        )
        return r
    ...
    def list(
        ...
        return DescribeReferenceOfByUserIdIterator(
            self._client,
