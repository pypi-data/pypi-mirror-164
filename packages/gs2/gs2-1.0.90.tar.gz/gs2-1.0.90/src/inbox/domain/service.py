...
from inbox.domain.namespace import NamespaceDomain
...
class Gs2Inbox:
    ...
    def send_by_stamp_sheet(
        self,
        request: request_.SendByStampSheetRequest,
    ) -> result_.SendByStampSheetResult:
        r = self._client.send_by_stamp_sheet(
            request,
        )
        return r
    ...
    def open_by_stamp_task(
        self,
        request: request_.OpenByStampTaskRequest,
    ) -> result_.OpenByStampTaskResult:
        r = self._client.open_by_stamp_task(
            request,
        )
        return r
