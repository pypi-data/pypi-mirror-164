...
class InboxDomain:
    ...
    def get_receive_request(
        self,
        request: request_.GetReceiveRequestByUserIdRequest,
    ) -> result_.GetReceiveRequestByUserIdResult:
        request.with_namespace_name(self._namespace_name)
        request.with_user_id(self._user_id)
        r = self._client.get_receive_request_by_user_id(
            request,
        )
        return r
    ...
    def accept_request(
        self,
        request: request_.AcceptRequestByUserIdRequest,
    ) -> result_.AcceptRequestByUserIdResult:
        request.with_namespace_name(self._namespace_name)
        request.with_user_id(self._user_id)
        r = self._client.accept_request_by_user_id(
            request,
        )
        return r
    ...
    def reject_request(
        self,
        request: request_.RejectRequestByUserIdRequest,
    ) -> result_.RejectRequestByUserIdResult:
        request.with_namespace_name(self._namespace_name)
        request.with_user_id(self._user_id)
        r = self._client.reject_request_by_user_id(
            request,
        )
        return r
    ...
    def list(
        ...
        return DescribeReceiveRequestsByUserIdIterator(
