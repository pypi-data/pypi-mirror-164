...
class BlackListDomain:
    ...
    def register(
        self,
        request: request_.RegisterBlackListByUserIdRequest,
    ) -> result_.RegisterBlackListByUserIdResult:
        request.with_namespace_name(self._namespace_name)
        request.with_user_id(self._user_id)
        r = self._client.register_black_list_by_user_id(
            request,
        )
        return r
    ...
    def unregister(
        self,
        request: request_.UnregisterBlackListByUserIdRequest,
    ) -> result_.UnregisterBlackListByUserIdResult:
        request.with_namespace_name(self._namespace_name)
        request.with_user_id(self._user_id)
        r = self._client.unregister_black_list_by_user_id(
            request,
        )
        return r
    ...
    def list(
        ...
        return DescribeBlackListByUserIdIterator(
            self._client,
