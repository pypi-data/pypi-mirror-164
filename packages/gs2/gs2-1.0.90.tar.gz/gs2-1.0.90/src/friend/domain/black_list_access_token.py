...
class BlackListAccessTokenDomain:
    ...
    def register(
        self,
        request: request_.RegisterBlackListRequest,
    ) -> result_.RegisterBlackListResult:
        request.with_namespace_name(self._namespace_name)
        request.with_access_token(self._access_token.token if self._access_token else None)
        r = self._client.register_black_list(
            request,
        )
        return r
    ...
    def unregister(
        self,
        request: request_.UnregisterBlackListRequest,
    ) -> result_.UnregisterBlackListResult:
        request.with_namespace_name(self._namespace_name)
        request.with_access_token(self._access_token.token if self._access_token else None)
        r = self._client.unregister_black_list(
            request,
        )
        return r
    ...
    def list(
        ...
        return DescribeBlackListIterator(
            self._client,
