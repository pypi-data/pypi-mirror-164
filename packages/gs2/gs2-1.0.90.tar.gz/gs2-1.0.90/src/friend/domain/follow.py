...
class FollowDomain:
    ...
    def load(
        self,
        request: request_.GetFollowByUserIdRequest,
    ) -> result_.GetFollowByUserIdResult:
        request.with_namespace_name(self._namespace_name)
        request.with_user_id(self._user_id)
        r = self._client.get_follow_by_user_id(
            request,
        )
        return r
    ...
    def follow(
        self,
        request: request_.FollowByUserIdRequest,
    ) -> result_.FollowByUserIdResult:
        request.with_namespace_name(self._namespace_name)
        request.with_user_id(self._user_id)
        r = self._client.follow_by_user_id(
            request,
        )
        return r
    ...
    def unfollow(
        self,
        request: request_.UnfollowByUserIdRequest,
    ) -> result_.UnfollowByUserIdResult:
        request.with_namespace_name(self._namespace_name)
        request.with_user_id(self._user_id)
        r = self._client.unfollow_by_user_id(
            request,
        )
        return r
    ...
    def list(
        ...
        return DescribeFollowsByUserIdIterator(
