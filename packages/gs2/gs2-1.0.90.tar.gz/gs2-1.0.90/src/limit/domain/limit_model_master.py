...
class LimitModelMasterDomain:
    ...
    def __init__(
        ...
        limit_model_master_cache: LimitModelMasterDomainCache,
        namespace_name: str,
        limit_name: str,
    ):
        ...
        self._limit_model_master_cache = limit_model_master_cache
        self._namespace_name = namespace_name
        self._limit_name = limit_name

    def load(
        self,
        request: request_.GetLimitModelMasterRequest,
    ) -> result_.GetLimitModelMasterResult:
        request.with_namespace_name(self._namespace_name)
        request.with_limit_name(self._limit_name)
        r = self._client.get_limit_model_master(
            request,
        )
        self._limit_model_master_cache.update(r.item)
        return r

    def update(
        self,
        request: request_.UpdateLimitModelMasterRequest,
    ) -> result_.UpdateLimitModelMasterResult:
        request.with_namespace_name(self._namespace_name)
        request.with_limit_name(self._limit_name)
        r = self._client.update_limit_model_master(
            request,
        )
        self._limit_model_master_cache.update(r.item)
        return r
    ...
    def delete(
        self,
        request: request_.DeleteLimitModelMasterRequest,
    ) -> result_.DeleteLimitModelMasterResult:
        request.with_namespace_name(self._namespace_name)
        request.with_limit_name(self._limit_name)
        r = self._client.delete_limit_model_master(
            request,
        )
        self._limit_model_master_cache.delete(r.item)
        return r
