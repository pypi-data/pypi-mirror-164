...
from mission.domain.namespace import NamespaceDomain
...
class Gs2Mission:
    ...
    def receive_by_stamp_task(
        self,
        request: request_.ReceiveByStampTaskRequest,
    ) -> result_.ReceiveByStampTaskResult:
        r = self._client.receive_by_stamp_task(
            request,
        )
        return r
    ...
    def increase_by_stamp_sheet(
        self,
        request: request_.IncreaseByStampSheetRequest,
    ) -> result_.IncreaseByStampSheetResult:
        r = self._client.increase_by_stamp_sheet(
            request,
        )
        return r
