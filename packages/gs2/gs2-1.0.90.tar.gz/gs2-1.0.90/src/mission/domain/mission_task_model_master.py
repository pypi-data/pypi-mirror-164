...
class MissionTaskModelMasterDomain:
    ...
    def __init__(
        ...
        mission_task_model_master_cache: MissionTaskModelMasterDomainCache,
        namespace_name: str,
        ...
        self._mission_task_model_master_cache = mission_task_model_master_cache
    ...
    def load(
        self,
        request: request_.GetMissionTaskModelMasterRequest,
    ) -> result_.GetMissionTaskModelMasterResult:
        request.with_namespace_name(self._namespace_name)
        request.with_mission_group_name(self._mission_group_name)
        request.with_mission_task_name(self._mission_task_name)
        r = self._client.get_mission_task_model_master(
            request,
        )
        self._mission_task_model_master_cache.update(r.item)
        return r

    def update(
        self,
        request: request_.UpdateMissionTaskModelMasterRequest,
    ) -> result_.UpdateMissionTaskModelMasterResult:
        request.with_namespace_name(self._namespace_name)
        request.with_mission_group_name(self._mission_group_name)
        request.with_mission_task_name(self._mission_task_name)
        r = self._client.update_mission_task_model_master(
            request,
        )
        self._mission_task_model_master_cache.update(r.item)
        return r
    ...
    def delete(
        self,
        request: request_.DeleteMissionTaskModelMasterRequest,
    ) -> result_.DeleteMissionTaskModelMasterResult:
        request.with_namespace_name(self._namespace_name)
        request.with_mission_group_name(self._mission_group_name)
        request.with_mission_task_name(self._mission_task_name)
        r = self._client.delete_mission_task_model_master(
            request,
        )
        self._mission_task_model_master_cache.delete(r.item)
        return r
