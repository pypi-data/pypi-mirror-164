...
from dictionary.domain.namespace import NamespaceDomain
...
class Gs2Dictionary:
    ...
    def add_entries_by_stamp_sheet(
        self,
        request: request_.AddEntriesByStampSheetRequest,
    ) -> result_.AddEntriesByStampSheetResult:
        r = self._client.add_entries_by_stamp_sheet(
            request,
        )
        return r
