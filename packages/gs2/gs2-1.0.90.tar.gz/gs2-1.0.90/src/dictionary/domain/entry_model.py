...
class EntryModelDomain:
    ...
    def __init__(
        ...
        entry_model_cache: EntryModelDomainCache,
        namespace_name: str,
        entry_name: str,
    ):
        ...
        self._entry_model_cache = entry_model_cache
        self._namespace_name = namespace_name
        self._entry_name = entry_name

    def load(
        self,
        request: request_.GetEntryModelRequest,
    ) -> result_.GetEntryModelResult:
        request.with_namespace_name(self._namespace_name)
        request.with_entry_name(self._entry_name)
        r = self._client.get_entry_model(
            request,
        )
        self._entry_model_cache.update(r.item)
        return r
