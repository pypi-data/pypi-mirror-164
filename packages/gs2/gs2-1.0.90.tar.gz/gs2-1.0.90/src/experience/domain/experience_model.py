...
class ExperienceModelDomain:
    ...
    def load(
        self,
        request: request_.GetExperienceModelRequest,
    ) -> result_.GetExperienceModelResult:
        request.with_namespace_name(self._namespace_name)
        request.with_experience_name(self._experience_name)
        r = self._client.get_experience_model(
            request,
        )
        self._experience_model_cache.update(r.item)
        return r
