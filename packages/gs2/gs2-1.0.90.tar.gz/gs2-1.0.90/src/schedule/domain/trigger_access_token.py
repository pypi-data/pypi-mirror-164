...
class TriggerAccessTokenDomain:
    ...
    def load(
        self,
        request: request_.GetTriggerRequest,
    ) -> result_.GetTriggerResult:
    ...
    def delete(
        self,
        request: request_.DeleteTriggerRequest,
    ) -> result_.DeleteTriggerResult:
        request.with_namespace_name(self._namespace_name)
        request.with_access_token(self._access_token.token if self._access_token else None)
        request.with_trigger_name(self._trigger_name)
        r = self._client.delete_trigger(
            request,
        )
