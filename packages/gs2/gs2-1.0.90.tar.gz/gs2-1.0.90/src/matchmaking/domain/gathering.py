...
class GatheringDomain:
    ...
    def update(
        self,
        request: request_.UpdateGatheringByUserIdRequest,
    ) -> result_.UpdateGatheringByUserIdResult:
        request.with_namespace_name(self._namespace_name)
        request.with_user_id(self._user_id)
        request.with_gathering_name(self._gathering_name)
        r = self._client.update_gathering_by_user_id(
            request,
        )
    ...
    def load(
        self,
        request: request_.GetGatheringRequest,
    ) -> result_.GetGatheringResult:
        request.with_namespace_name(self._namespace_name)
        request.with_gathering_name(self._gathering_name)
        r = self._client.get_gathering(
            request,
        )
        self._gathering_cache.update(r.item)
        return r
    ...
    def cancel_matchmaking(
        self,
        request: request_.CancelMatchmakingByUserIdRequest,
    ) -> result_.CancelMatchmakingByUserIdResult:
        request.with_namespace_name(self._namespace_name)
        request.with_user_id(self._user_id)
        request.with_gathering_name(self._gathering_name)
        r = self._client.cancel_matchmaking_by_user_id(
            request,
        )
        self._gathering_cache.update(r.item)
        return r
