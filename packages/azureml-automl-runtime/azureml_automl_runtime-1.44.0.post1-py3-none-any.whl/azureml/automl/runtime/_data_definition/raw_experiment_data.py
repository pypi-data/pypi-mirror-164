...
class RawExperimentData:
    ...
    def __init__(
        ...
        output_data_snapshot_str_with_quantiles: str = ""
    ):
        """
        ...
        :param output_data_snapshot_str_with_quantiles: The output data snapshot string with quantiles.
        """
        # data
    ...
    def create(cls,
               ...
               n_cross_validations: Optional[Union[str, int]]) -> "RawExperimentData":
        """
