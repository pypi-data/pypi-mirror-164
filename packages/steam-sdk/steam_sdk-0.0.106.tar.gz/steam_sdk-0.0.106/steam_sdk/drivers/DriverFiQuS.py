...
import sys
import subprocess
from steam_sdk.parsers.ParserYAML import data_class_from_yaml
...
class DriverFiQuS:
    ...
    def __init__(self, FiQuS_path='', FiQuS_GetDP_path=''):
        ...
        #     pass
        #     #import fiqus
        # self.FiQuS_GetDP_path = FiQuS_GetDP_path
    ...
    def run_FiQuS(self, input_file_path: str, outputDirectory: str = 'output', verbose=True):
        ...
        # """
        #
        # fdm = data_class_from_yaml(input_file_path, DataFiQuS)
        # fdm.magnet.solve = self.FiQuS_GetDP_path
        # fdm.drive.type = 'geometry_only'
        # fdm.drive.geometry = 1
        # fdm.drive.overwrite = True
        #
        # # act
        # #MainFiQuS(input_file_path=input_file_path, model_folder=outputDirectory, fdm=fdm)
        # print(fdm)
        # # Unpack arguments
