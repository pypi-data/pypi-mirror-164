...
#get_signals_from_csd('C:/cernbox/steam-models-dev/analyses/example_circuit_analysis/output/PSPICE/RCS.csd',['I(x_R_EE.v_virtual_in)','V(x_R_EE.304)','I(R_WARM_1)','I(x_Crowbar.R_crowbar)','I(x_EC.v_virtual_in)'])