...
* key properties/data:
    ...
    3. and a few other supplementary properties...
* further properties/objects containing necessary data:
    1.  model.const.Experiment = description of experiment
    2.  model.const.DataParameters = description of input data
    3.  model.const.PlotParameters = data for plotting the results
* functions/methods, the most important of which are
    - Model.run, which runs the whole calculation
    - Model.describe, which briefly describes the model (for outputs, reports)
    - Model.final_report, which creates final reports from ALL fitting results
'''
...
class Model:
    ...
    * table_of_results_evp : pandas.DataFrame
    ...
    def _initialize_tables_of_results(self):
        ...
        Returns
        -------
        None. The result is correct initialization of two tables:
    ...
    def describe(self, fh=sys.stdout):
        ...
        Returns
        -------
        None, just the text printed to stdout or text file.
        '''
    ...
    def run(self, datafile, t_start, t_hold, t_fstart=None, t_fend=None):
        '''
        Run the model = run the whole fitting procedure.
        ...
        Returns
        -------
        None, but this is the key method of {Model} object which...
        
        * reads creep data
        * fits model function to creep data
        * saves results to self.table_of_results and save.table_of_results_evp
        * we note that the printing data and saving them to file
          is performed after running the model by another method - 
          self.final_report
    ...
    def save_fitting_result(self, datafile, par, R2fit, R2all, t_start):
        ...
        * self.table_of_results_evp = recalculated results for EVP models
        ...
        Returns
        -------
        None (formally it returns self, but this is not necessary).
    ...
    def final_report(self, output_file=None):
        ...
        * Model.print_table_of_results_evp = print addidional results
        ...
        -------
        None.
        Output is the printed report + saved file with the results of fitting.
