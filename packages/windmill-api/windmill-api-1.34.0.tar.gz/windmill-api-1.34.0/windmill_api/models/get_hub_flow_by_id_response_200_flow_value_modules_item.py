...
from ..models.get_hub_flow_by_id_response_200_flow_value_modules_item_input_transform import (
...
class GetHubFlowByIdResponse200FlowValueModulesItem:
    ...
    input_transform: GetHubFlowByIdResponse200FlowValueModulesItemInputTransform
    value: Union[
        GetHubFlowByIdResponse200FlowValueModulesItemValueType0,
        GetHubFlowByIdResponse200FlowValueModulesItemValueType1,
        GetHubFlowByIdResponse200FlowValueModulesItemValueType2,
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        input_transform = GetHubFlowByIdResponse200FlowValueModulesItemInputTransform.from_dict(
