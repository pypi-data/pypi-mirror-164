...
from ..models.open_flow_w_path_value_modules_item_input_transform import OpenFlowWPathValueModulesItemInputTransform
...
class OpenFlowWPathValueModulesItem:
    ...
    input_transform: OpenFlowWPathValueModulesItemInputTransform
    value: Union[
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        input_transform = OpenFlowWPathValueModulesItemInputTransform.from_dict(d.pop("input_transform"))
