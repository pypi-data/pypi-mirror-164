...
transformer_list = ["AnomalyRemoval", "SinTrend", 'Discretize', "EWMAFilter", 'AlignLastValue', "Detrend", 'HolidayTransformer', 'QuantileTransformer', 'SeasonalDifference', 'BTCD']
transformer_max_depth = 3
models_mode = "default"  # "default", "regressor", "neuralnets"
model_list = "superfast"
# model_list = "fast"  # fast_parallel, all
# model_list = ["MAR", "LastValueNaive", "FBProphet", "UnivariateMotif", "WindowRegression", 'ARCH']
preclean = None
{
