...
sino = svmbir.project(phantom, angles, num_rows_cols , verbose=verbose)

# Determine resulting number of views, slices, and channels
(num_views, num_slices, num_channels) = sino.shape

# Perform MBIR reconstruction
#recon = svmbir.recon(sino, angles, T=T, p=p, sharpness=sharpness, max_resolutions = max_resolutions,verbose=0,new_reg_defaults=True)
recon = svmbir.recon(sino, angles, T=T, p=p, sharpness=sharpness, max_resolutions = max_resolutions,verbose=verbose)
