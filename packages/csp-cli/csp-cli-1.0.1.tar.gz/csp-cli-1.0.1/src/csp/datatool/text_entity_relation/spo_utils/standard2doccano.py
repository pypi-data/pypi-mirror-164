...
# @click.command()
# @click.option("--standard_path", prompt="your standard labels file path(json)", help='eg: data/standard',
#               type=str)
...
if __name__ == '__main__':  
    ...
    output = "./data/"
    standard2doccno(standard_path, output)
