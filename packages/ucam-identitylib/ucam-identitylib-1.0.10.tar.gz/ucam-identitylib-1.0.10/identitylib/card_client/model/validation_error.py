...
class ValidationError(ModelNormal):
    ...
    def openapi_types():
        ...
        """
        return {
            'non_field_errors': ([str],),  # noqa: E501
        }
    ...
    attribute_map = {
        'non_field_errors': 'non_field_errors',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            non_field_errors ([str]): List of validation errors not related to any field. [optional]  # noqa: E501
        """
