...
def lazy_import():
    ...
    globals()['CardLogo'] = CardLogo


class V1beta1CardLogosList200Response(ModelNormal):
    ...
    def _from_openapi_data(cls, results, *args, **kwargs):  # noqa: E501
        """V1beta1CardLogosList200Response - a model defined in OpenAPI
