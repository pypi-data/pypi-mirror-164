...
class V1beta1CardRfidDataConfigList200ResponseResultsInner(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, configuration, *args, **kwargs):  # noqa: E501
        """V1beta1CardRfidDataConfigList200ResponseResultsInner - a model defined in OpenAPI

        Args:
            id (str):
            configuration ([bool, date, datetime, dict, float, int, list, str, none_type]):
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, configuration, *args, **kwargs):  # noqa: E501
        """V1beta1CardRfidDataConfigList200ResponseResultsInner - a model defined in OpenAPI
