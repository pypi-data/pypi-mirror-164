...
class CardLogo(ModelNormal):
    ...
    attribute_map = {
        ...
        'content_link': 'contentLink',  # noqa: E501
    ...
    def _from_openapi_data(cls, name, *args, **kwargs):  # noqa: E501
        """CardLogo - a model defined in OpenAPI

        Args:
            name (str): The logo's name
        ...
        Keyword Args:
            ...
            content_link (str): [optional]  # noqa: E501
            image_height (int): The height of the logo in pixels - not populated for svg logos. [optional]  # noqa: E501
            image_width (int): The width of the logo in pixels - not populated for svg logos. [optional]  # noqa: E501
            created_at (datetime): When this logo was created. [optional]  # noqa: E501
        """
