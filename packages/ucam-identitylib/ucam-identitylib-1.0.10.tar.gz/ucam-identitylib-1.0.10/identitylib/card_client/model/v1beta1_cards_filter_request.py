...
class V1beta1CardsFilterRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'updated_at__lte': (datetime,),  # noqa: E501
            'updated_at__gte': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'updated_at__lte': 'updated_at__lte',  # noqa: E501
        'updated_at__gte': 'updated_at__gte',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, identifiers, *args, **kwargs):  # noqa: E501
        """V1beta1CardsFilterRequest - a model defined in OpenAPI

        Args:
            identifiers ([str]): Identifiers to filter by, in the format value@scheme, scheme may be omitted in which case the scheme is assumed to be crsid
        ...
        Keyword Args:
            ...
            status (str): Status to filter by, if omitted cards of all statuses are returned. [optional]  # noqa: E501
            updated_at__lte (datetime): Filter updatedAt by IsoDateTime less than. [optional]  # noqa: E501
            updated_at__gte (bool, date, datetime, dict, float, int, list, str, none_type): Filter updatedAt by IsoDateTime greater than. [optional]  # noqa: E501
        """
