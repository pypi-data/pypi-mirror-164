...
def lazy_import():
    ...
    globals()['AvailableBarcode'] = AvailableBarcode


class V1beta1AvailableBarcodesList200Response(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'results': ([AvailableBarcode],),  # noqa: E501
    ...
    def _from_openapi_data(cls, results, *args, **kwargs):  # noqa: E501
        """V1beta1AvailableBarcodesList200Response - a model defined in OpenAPI

        Args:
            results ([AvailableBarcode]):
