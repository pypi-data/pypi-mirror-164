...
class StatusEnum(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str):, must be one of ["APPROVED", "UNAPPROVED", "UNAPPROVED_REVIEW_POSTPONED", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["APPROVED", "UNAPPROVED", "UNAPPROVED_REVIEW_POSTPONED", ]  # noqa: E501
