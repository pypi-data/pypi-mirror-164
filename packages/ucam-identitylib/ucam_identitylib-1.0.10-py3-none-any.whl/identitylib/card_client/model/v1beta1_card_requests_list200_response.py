...
def lazy_import():
    ...
    globals()['CardRequestSummary'] = CardRequestSummary


class V1beta1CardRequestsList200Response(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'results': ([CardRequestSummary],),  # noqa: E501
    ...
    def _from_openapi_data(cls, results, *args, **kwargs):  # noqa: E501
        """V1beta1CardRequestsList200Response - a model defined in OpenAPI

        Args:
            results ([CardRequestSummary]):
