...
class CardNote(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, card_id, text, *args, **kwargs):  # noqa: E501
        """CardNote - a model defined in OpenAPI

        Args:
            card_id (str):
            text (str): The text of the note against a given card
        ...
        Keyword Args:
            ...
            created_by (str, none_type): The identifier of the user who created the note - not known for legacy data. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, card_id, text, *args, **kwargs):  # noqa: E501
        """CardNote - a model defined in OpenAPI
