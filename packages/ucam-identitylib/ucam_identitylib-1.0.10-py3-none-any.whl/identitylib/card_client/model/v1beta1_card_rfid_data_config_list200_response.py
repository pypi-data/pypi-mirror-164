...
def lazy_import():
    ...
    globals()['V1beta1CardRfidDataConfigList200ResponseResultsInner'] = V1beta1CardRfidDataConfigList200ResponseResultsInner


class V1beta1CardRfidDataConfigList200Response(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'results': ([V1beta1CardRfidDataConfigList200ResponseResultsInner],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, results, *args, **kwargs):  # noqa: E501
        """V1beta1CardRfidDataConfigList200Response - a model defined in OpenAPI

        Args:
            results ([V1beta1CardRfidDataConfigList200ResponseResultsInner]):
