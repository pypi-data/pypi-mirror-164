...
class PermissionsList200Response(ModelNormal):
    ...
    def _from_openapi_data(cls, permissions, *args, **kwargs):  # noqa: E501
        """PermissionsList200Response - a model defined in OpenAPI

        Args:
            permissions ([str]): A list of the permissions the current principal has
