...
def lazy_import():
    ...
    globals()['CardSummary'] = CardSummary


class V1beta1CardsList200Response(ModelNormal):
    ...
    def _from_openapi_data(cls, results, *args, **kwargs):  # noqa: E501
        """V1beta1CardsList200Response - a model defined in OpenAPI
