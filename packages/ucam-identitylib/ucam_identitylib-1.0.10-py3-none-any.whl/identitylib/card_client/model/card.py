...
class Card(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, identifiers, status, can_update, notes, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, identifiers, status, can_update, notes, *args, **kwargs):  # noqa: E501
        """Card - a model defined in OpenAPI
