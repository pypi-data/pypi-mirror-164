...
from identitylib.card_client.exceptions import ApiTypeError, ApiValueError, ApiException
from identitylib.card_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = PermissionsApi()
        api_instance.permissions_list  # this is an instance of the class Endpoint
        api_instance.permissions_list()  # this invokes api_instance.permissions_list.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.permissions_list.callable or self.callable in this class
