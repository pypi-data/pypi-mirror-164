...
import tfx_analysis import utils
...
class TFXReadonlyMetadataStore(utils.ReadonlyMetadataStore):
    ...
    def compare_tfma_analysis(self, model_id, other_model_id):
        ...
        tfma_artifact, other_tfma_artifact = (
            ...
            self.get_dest_artifact_of_type(other_model_id, TFXArtifactTypes.MODEL_EVAL),
        )
    ...
    def display_stats_for_examples(self, examples_id, split="Split-train"):
    ...
    def compare_stats_for_examples(
        self, examples_id, other_examples_id, name="", other_name=""
    ):
        ...
        stats_artifact, other_stats_artifact = (
            self.get_dest_artifact_of_type(examples_id, TFXArtifactTypes.EXAMPLE_STATS),
