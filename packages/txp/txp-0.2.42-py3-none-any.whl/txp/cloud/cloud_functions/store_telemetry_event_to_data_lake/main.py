...
data_lake_bucket_name = \
    f"{project_id}-{os.environ.get('DATA_LAKE_BUCKET_NAME', settings.functions.data_lake_bucket_name)}"
pending_signal_chunks_collection_name = os.environ.get('PENDING_SIGNAL_CHUNKS_COLLECTION',
                                                       settings.firestore.pending_signal_chunks_collection)
