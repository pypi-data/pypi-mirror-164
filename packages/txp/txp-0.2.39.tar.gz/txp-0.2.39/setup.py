...
extras_require = \
{':extra == "cloud"': ['scipy[cloud]>=1.4.0,<2.0.0'],
 ':extra == "dev"': ['pytest[dev]>=6.2.4,<7.0.0',
                     'pytest-xdist[dev]>=2.4.0,<3.0.0',
                     'black[dev]>=21.6b0,<22.0',
                     'jupyterlab[dev]>=3.4.5,<4.0.0',
                     'nbmake[dev]>=1.3.4,<2.0.0',
                     'google-cloud-pubsub[dev]>=2.12.1,<3.0.0',
                     'google-api-python-client[dev]>=2.23.0,<3.0.0',
                     'google-auth[dev]>=2.2.1,<3.0.0',
                     'google-cloud-iot[dev]>=2.3.0,<3.0.0',
                     'google[dev]>=3.0.0,<4.0.0',
                     'google-auth-oauthlib[dev]>=0.4.6,<0.5.0',
                     'google-cloud-firestore[dev]>=2.3,<3.0'],
 ':extra == "gateway"': ['cryptography[gateway]>=35.0.0,<36.0.0',
                         'transitions[gateway]>=0.8.8,<0.9.0',
                         'PyJWT[gateway]>=2.1.0,<3.0.0',
                         'paho-mqtt[gateway]>=1.5.1,<2.0.0',
                         'ifaddr[gateway]>=0.1.7,<0.2.0',
                         'schedule[gateway]>=1.1.0,<2.0.0',
                         'requests[gateway]>=2.26.0,<3.0.0',
                         'psutil[gateway]>=5.8.0,<6.0.0',
                         'queuelib[gateway]>=1.6.2,<2.0.0',
                         'freezegun[gateway]>=1.1.0,<2.0.0',
                         'pyudev[gateway]>=0.23.1,<0.24.0',
                         'six[gateway]>=1.13.0,<2.0.0',
                         'mcp9600[gateway]>=0.0.4,<0.0.5',
                         'deepdiff[gateway]>=5.7.0,<6.0.0'],
 ':extra == "ml"': ['ray[ml]>=1.12.0,<2.0.0',
                    'sklearn[ml]>=0.0,<0.1',
                    'fastapi[ml]>=0.78.0,<0.79.0'],
