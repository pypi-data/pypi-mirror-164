...
['Markdown>=3.3.6,<4.0.0',
 ...
 'cryptography[gateway]>=35.0.0,<36.0.0',
 ...
 'scipy[cloud]>=1.4.0,<2.0.0',
 'six[gateway]>=1.13.0,<2.0.0',
 'sklearn[ml]>=0.0,<0.1',
 'streamlit==1.4.0',
 'tabulate>=0.8.9,<0.9.0',
 'transitions[gateway]>=0.8.8,<0.9.0',
 'xgboost[ml]>=1.6.0,<2.0.0']

extras_require = \
{':extra == "dev"': ['jupyterlab[dev]>=3.4.5,<4.0.0',
                     'nbmake[dev]>=1.3.4,<2.0.0'],
 ':extra == "gateway"': ['mcp9600[gateway]>=0.0.4,<0.0.5'],
