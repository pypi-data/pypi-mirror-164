...
class _Memoizer:
    ...
    @classmethod
    def check_already_processed_decorator(cls: type[_Memoizer], is_method=False):
    ...
    @classmethod
    def check_already_processed(cls, obj: T) -> T:
    ...
    @classmethod
    def mark_as_processed(cls: type[_Memoizer], obj: T):
    ...
    def _return(
        cls,
        obj: T,
        obj_to_membership_sign: Callable[[T], int],
        default_func: Callable[[T], S],
        memoizing=True,
    ) -> Literal["AP"] | Any:
