...
class Animation:
    ...
    def __init__(
        self,
        mobject: OpenGLMobject | Mobject | None,
        ...
        **kwargs,
        ...
        if config["renderer"] == "opengl":
            self.starting_mobject: OpenGLMobject | Mobject = OpenGLMobject()
    ...
    def get_all_mobjects_to_update(self) -> list[Mobject | OpenGLMobject]:
...
class Wait(Animation):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.is_static_wait: bool | None = frozen_frame
