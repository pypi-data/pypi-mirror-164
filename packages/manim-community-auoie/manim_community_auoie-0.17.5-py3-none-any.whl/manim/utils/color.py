...
def rgba_to_color(rgba: list[float]) -> Color:
...
def invert_color(color: Color | str) -> Color:
...
def color_to_int_rgba(color: Color | str, opacity: float = 1.0) -> np.ndarray:
