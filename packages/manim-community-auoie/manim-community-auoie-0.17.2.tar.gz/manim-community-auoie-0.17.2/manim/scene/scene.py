...
from typing import TYPE_CHECKING, Callable, Iterable, Sequence, Tuple, TypedDict, cast
...
class Scene:
    ...
    def __init__(
        ...
        self.moving_mobjects: list[Mobject | Object3D | OpenGLMobject] = []
        self.static_mobjects: list[Mobject] = []
        self.time_progression = None
        self.duration: float | None = None
        self.last_t: float | None = None
        self.queue: Queue[tuple[str, Iterable, dict]] = Queue()
        ...
        self.key_to_function_map: dict[str, Callable] = {}
        self.mouse_press_callbacks: list[Callable] = []
        ...
        self.mobjects: list[Mobject | Object3D | OpenGLMobject] = []
    ...
    def should_update_mobjects(self) -> bool:
        ...
        """
        wait_animation = cast(Wait, self.animations[0])
    ...
    def add(self, *mobjects: Mobject | Object3D | OpenGLMobject):
        """
        ...
        *mobjects : Mobject
        ...
        """
        if config.renderer == "opengl":
            new_mobjects: list[Mobject | OpenGLMobject] = []
            ...
            list_mobjects: list[Mobject | Object3D | OpenGLMobject] = [
                *mobjects,
                *self.foreground_mobjects,
            ]
            self.restructure_mobjects(to_remove=list_mobjects)
            self.mobjects += list_mobjects
            if self.moving_mobjects:
                self.restructure_mobjects(
                    to_remove=list_mobjects,
                    mobject_list_name="moving_mobjects",
                )
                self.moving_mobjects += list_mobjects
        return self
    ...
    def remove(self, *mobjects: Mobject | OpenGLMobject | Object3D):
        """
    ...
    def is_current_animation_frozen_frame(self) -> bool | None:
