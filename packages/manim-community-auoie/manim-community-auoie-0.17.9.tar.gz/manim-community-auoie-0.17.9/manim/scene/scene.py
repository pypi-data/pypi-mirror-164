...
class Scene:
    ...
    def __init__(
        self,
        renderer: CairoRenderer | None = None,
        camera_class=Camera,
        ...
        self.moving_mobjects: list[Mobject | Object3D] = []
        ...
        if renderer is None:
            self.renderer: CairoRenderer = CairoRenderer(
        ...
        self.mobjects: list[Mobject | Object3D] = []
    ...
    def add(self, *mobjects: Mobject | Object3D):
        """
        ...
        *mobjects : Mobject
        ...
        """
        list_mobjects: list[Mobject | Object3D] = [
            *mobjects,
    ...
    def remove(self, *mobjects: Mobject | Object3D):
        """
