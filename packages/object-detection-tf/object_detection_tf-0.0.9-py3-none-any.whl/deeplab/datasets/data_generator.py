...
_CONCRETE_TAKEOFF = DatasetDescriptor(
    splits_to_sizes={
        'train': 2508,  # num of samples in images/training
        'val': 278,  # num of samples in images/validation
    },
    num_classes=7,
    ignore_label=0,  # either 0 or 255
)
_DATASETS_INFORMATION = {
    'cityscapes': _CITYSCAPES_INFORMATION,
    'pascal_voc_seg': _PASCAL_VOC_SEG_INFORMATION,
    'ade20k': _ADE20K_INFORMATION,
    'concrete': _CONCRETE_TAKEOFF
}
