        ...
        """
            ...
            Parameters:
                ...
                by: Defines the method to click the UI element.  
                    ...
                    control-invocation: click the target UI element by invoking its UI method. It may not be supported if it is a window desktop element.  
        ...
        """
            ...
            Parameters:
                ...
                by: Defines the method to perform releasing mouse button.  
                    ...
                    control-invocation: perform the action by invoking its UI method. It may not be supported if it is a window desktop element.  
                    default: automatically choose method per element type. For Web element, use `control-invocation`; for Window element, use `mouse-emulation`.  
        ...
        """
            ...
            Parameters:
                ...
                by: the method to perform the text input operation. 
                    set-text: call system method to set text to the target element. Some window application elements may not be supported.  
