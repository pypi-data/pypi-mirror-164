...
const scriptEditorDebuggerExtension = {
    ...
    activate: (app, debug, editorTracker, labShell) => {
            ...
            try {
                ...
                if (sessionModel) {
                    ...
                    if (((_a = sessionModel.kernel) === null || _a === void 0 ? void 0 : _a.name) !== kernelSelection) {
                        ...
                        yield shutdownSession(sessionConnection);
                        sessionConnection = yield startSession(kernelSelection, path);
                        sessionModel = yield sessions.findByPath(path);
                        if (sessionConnection && sessionModel) {
                            activeSessions[sessionModel.id] = sessionConnection;
                        }
        ...
        const shutdownSession = (sessionConnection) => __awaiter(void 0, void 0, void 0, function* () {
            var _b;
            try {
                const kernelName = (_b = sessionConnection.kernel) === null || _b === void 0 ? void 0 : _b.name;
                yield sessionConnection.shutdown();
...
//# sourceMappingURL=lib_index_js.c9d72155759e4bc797ff.js.map