...
from alvin_api_client.model.manual_lineage_entity_type_validation import ManualLineageEntityTypeValidation
...
from alvin_api_client.model.save_search_filter import SaveSearchFilter
from alvin_api_client.model.save_search_string_filter import SaveSearchStringFilter
...
class DefaultApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_saved_search_filter_api_v2_saved_search_delete_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'HTTPBearer'
                ],
                'endpoint_path': '/api/v2/saved_search',
                'operation_id': 'delete_saved_search_filter_api_v2_saved_search_delete',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.find_data_entity_dependencies_api_v1_entity_dependency_post_endpoint = _Endpoint(
            settings={
                'response_type': ([DataEntityDependencyGet],),
                'auth': [],
                'endpoint_path': '/api/v1/entity/dependency',
                'operation_id': 'find_data_entity_dependencies_api_v1_entity_dependency_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.get_airflow_platform_api_v1_platforms_airflow_platform_id_get_endpoint = _Endpoint(
            settings={
                'response_type': (DataPlatformAirflowCreate,),
                'auth': [],
        ...
        self.get_databricks_platform_api_v1_platforms_databricks_platform_id_get_endpoint = _Endpoint(
            settings={
                'response_type': (DataPlatformDatabricksCreate,),
                'auth': [],
        ...
        self.get_hightouch_platform_api_v1_platforms_hightouch_platform_id_get_endpoint = _Endpoint(
            settings={
                'response_type': (DataPlatformHightouchCreate,),
                'auth': [],
        ...
        self.get_hive_platform_api_v1_platforms_hive_platform_id_get_endpoint = _Endpoint(
            settings={
                'response_type': (DataPlatformHiveCreate,),
                'auth': [],
        ...
        self.get_hiveglue_platform_api_v1_platforms_hiveglue_platform_id_get_endpoint = _Endpoint(
            settings={
                'response_type': (DataPlatformHiveGlueCreate,),
                'auth': [],
        ...
        self.get_mssql_platform_api_v1_platforms_mssql_platform_id_get_endpoint = _Endpoint(
            settings={
                'response_type': (DataPlatformMSSQLCreate,),
                'auth': [],
        ...
        self.get_mysql_platform_api_v1_platforms_mysql_platform_id_get_endpoint = _Endpoint(
            settings={
                'response_type': (DataPlatformMySQLCreate,),
                'auth': [],
        ...
        self.get_postgres_platform_api_v1_platforms_postgres_platform_id_get_endpoint = _Endpoint(
            settings={
                'response_type': (DataPlatformPostgresCreate,),
                'auth': [],
        ...
        self.get_powerbi_platform_api_v1_platforms_powerbi_platform_id_get_endpoint = _Endpoint(
            settings={
                'response_type': (DataPlatformPowerBICreate,),
                'auth': [],
        ...
        self.get_treasuredata_platform_api_v1_platforms_treasuredata_platform_id_get_endpoint = _Endpoint(
            settings={
                'response_type': (DataPlatformTreasureDataCreate,),
                'auth': [],
        ...
        self.list_manual_lineage_valid_entity_types_api_v1_lineage_manual_valid_entity_types_get_endpoint = _Endpoint(
            ...
            params_map={
                'all': [
                    'manual_lineage_entity_type_validation',
                ],
                'required': [
                    'manual_lineage_entity_type_validation',
                ],
            ...
            root_map={
                ...
                'openapi_types': {
                    'manual_lineage_entity_type_validation':
                        (ManualLineageEntityTypeValidation,),
                },
                'attribute_map': {
                },
                'location_map': {
                    'manual_lineage_entity_type_validation': 'body',
                },
                'collection_format_map': {
                }
            },
        ...
        self.list_saved_search_nodes_filter_api_v2_saved_search_nodes_get_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'HTTPBearer'
                ],
                'endpoint_path': '/api/v2/saved_search/nodes',
                'operation_id': 'list_saved_search_nodes_filter_api_v2_saved_search_nodes_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_saved_search_string_filter_api_v2_saved_search_string_get_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'HTTPBearer'
                ],
                'endpoint_path': '/api/v2/saved_search/string',
                'operation_id': 'list_saved_search_string_filter_api_v2_saved_search_string_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.saved_search_nodes_filter_api_v2_saved_search_nodes_post_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'HTTPBearer'
                ...
                'endpoint_path': '/api/v2/saved_search/nodes',
                'operation_id': 'saved_search_nodes_filter_api_v2_saved_search_nodes_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.saved_search_string_filter_api_v2_saved_search_string_post_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'HTTPBearer'
                ...
                'endpoint_path': '/api/v2/saved_search/string',
                'operation_id': 'saved_search_string_filter_api_v2_saved_search_string_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
                'all': [
                    'save_search_string_filter',
                ],
                'required': [
                    'save_search_string_filter',
                ],
            ...
            root_map={
                ...
                'openapi_types': {
                    'save_search_string_filter':
                        (SaveSearchStringFilter,),
                },
                'attribute_map': {
                },
                'location_map': {
                    'save_search_string_filter': 'body',
                },
                'collection_format_map': {
                }
            },
        ...
        self.search_api_v2_search_all_post_endpoint = _Endpoint(
            settings={
                'response_type': (SearchV2Response,),
                'auth': [
                    'HTTPBearer'
                ],
                'endpoint_path': '/api/v2/search/all',
                'operation_id': 'search_api_v2_search_all_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.search_entities_api_v2_search_get_endpoint = _Endpoint(
            settings={
                'response_type': (SearchV2Response,),
                'auth': [
                    'HTTPBearer'
                ...
                'operation_id': 'search_entities_api_v2_search_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.search_with_nodes_api_v2_search_nodes_post_endpoint = _Endpoint(
            settings={
                'response_type': (SearchV2Response,),
                'auth': [
                    'HTTPBearer'
                ],
                'endpoint_path': '/api/v2/search_nodes',
                'operation_id': 'search_with_nodes_api_v2_search_nodes_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def delete_saved_search_filter_api_v2_saved_search_delete(
        self,
        search_name,
        **kwargs
    ):
        """Delete Saved Search Filter  # noqa: E501

        Delete saved search filters based on search_name, this will delete both the string and node based filters base  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_saved_search_filter_api_v2_saved_search_delete(search_name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['search_name'] = \
            search_name
        return self.delete_saved_search_filter_api_v2_saved_search_delete_endpoint.call_with_http_info(**kwargs)
    ...
    def expand_node_children_api_v1_lineage_node_expand_children_post(
        ...
        **kwargs
        ...
        >>> thread = api.expand_node_children_api_v1_lineage_node_expand_children_post(data_entity_id, async_req=True)
        >>> result = thread.get()
    ...
    def find_data_entity_dependencies_api_v1_entity_dependency_post(
        self,
        data_entity_id,
        **kwargs
    ):
        """Find Data Entity Dependencies  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.find_data_entity_dependencies_api_v1_entity_dependency_post(data_entity_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['data_entity_id'] = \
            data_entity_id
        return self.find_data_entity_dependencies_api_v1_entity_dependency_post_endpoint.call_with_http_info(**kwargs)
    ...
    def list_manual_lineage_valid_entity_types_api_v1_lineage_manual_valid_entity_types_get(
        ...
        **kwargs
        ...
        >>> thread = api.list_manual_lineage_valid_entity_types_api_v1_lineage_manual_valid_entity_types_get(manual_lineage_entity_type_validation, async_req=True)
        >>> result = thread.get()

        Args:
            manual_lineage_entity_type_validation (ManualLineageEntityTypeValidation):
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['manual_lineage_entity_type_validation'] = \
            manual_lineage_entity_type_validation
    ...
    def list_saved_search_nodes_filter_api_v2_saved_search_nodes_get(
        self,
        **kwargs
    ):
        """List Saved Search Nodes Filter  # noqa: E501

        List all the saved search node based filters  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_saved_search_nodes_filter_api_v2_saved_search_nodes_get(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.list_saved_search_nodes_filter_api_v2_saved_search_nodes_get_endpoint.call_with_http_info(**kwargs)

    def list_saved_search_string_filter_api_v2_saved_search_string_get(
        self,
        **kwargs
    ):
        """List Saved Search String Filter  # noqa: E501

        List all the saved search string based filters  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_saved_search_string_filter_api_v2_saved_search_string_get(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.list_saved_search_string_filter_api_v2_saved_search_string_get_endpoint.call_with_http_info(**kwargs)
    ...
    def saved_search_nodes_filter_api_v2_saved_search_nodes_post(
        self,
        save_search_filter,
        **kwargs
    ):
        """Saved Search Nodes Filter  # noqa: E501

        Save the search nodes based filter  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.saved_search_nodes_filter_api_v2_saved_search_nodes_post(save_search_filter, async_req=True)
        >>> result = thread.get()

        Args:
            save_search_filter (SaveSearchFilter):
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['save_search_filter'] = \
            save_search_filter
        return self.saved_search_nodes_filter_api_v2_saved_search_nodes_post_endpoint.call_with_http_info(**kwargs)

    def saved_search_string_filter_api_v2_saved_search_string_post(
        self,
        save_search_string_filter,
        **kwargs
    ):
        """Saved Search String Filter  # noqa: E501

        Save the string based search filter along with the search nodes if they exists  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.saved_search_string_filter_api_v2_saved_search_string_post(save_search_string_filter, async_req=True)
        >>> result = thread.get()

        Args:
            save_search_string_filter (SaveSearchStringFilter):
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['save_search_string_filter'] = \
            save_search_string_filter
        return self.saved_search_string_filter_api_v2_saved_search_string_post_endpoint.call_with_http_info(**kwargs)

    def search_api_v2_search_all_post(
        self,
        search_string,
        **kwargs
    ):
        ...
        >>> thread = api.search_api_v2_search_all_post(search_string, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['search_string'] = \
            search_string
        return self.search_api_v2_search_all_post_endpoint.call_with_http_info(**kwargs)

    def search_entities_api_v2_search_get(
        self,
        search_string,
        **kwargs
    ):
        ...
        >>> thread = api.search_entities_api_v2_search_get(search_string, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['search_string'] = \
            search_string
        return self.search_entities_api_v2_search_get_endpoint.call_with_http_info(**kwargs)
    ...
    def search_with_nodes_api_v2_search_nodes_post(
        self,
        **kwargs
    ):
        """Search With Nodes  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.search_with_nodes_api_v2_search_nodes_post(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.search_with_nodes_api_v2_search_nodes_post_endpoint.call_with_http_info(**kwargs)
