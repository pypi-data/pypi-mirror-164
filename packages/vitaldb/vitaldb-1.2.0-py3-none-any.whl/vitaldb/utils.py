...
class VitalFile:
    ...
    def to_wfdb(self, opath, track_names=None, interval=None):
        ...
        wfdb.wrsamp(opath, fs=float(1/interval), units=wav_units, sig_name=wav_track_names, p_signal=df.values[:,1:], fmt=['16'] * len(wav_track_names))
