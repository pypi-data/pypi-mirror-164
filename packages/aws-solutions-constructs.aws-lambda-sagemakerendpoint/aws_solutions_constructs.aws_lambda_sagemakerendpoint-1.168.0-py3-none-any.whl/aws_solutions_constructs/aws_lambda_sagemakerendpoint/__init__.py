...
class LambdaToSagemakerEndpoint(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(LambdaToSagemakerEndpoint.__init__)
    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(endpoint_config_props, dict):
            endpoint_config_props = CfnEndpointConfigProps(**endpoint_config_props)
        if isinstance(endpoint_props, dict):
            endpoint_props = CfnEndpointProps(**endpoint_props)
        if isinstance(lambda_function_props, dict):
            lambda_function_props = FunctionProps(**lambda_function_props)
        if isinstance(vpc_props, dict):
            vpc_props = VpcProps(**vpc_props)
        if __debug__:
            type_hints = typing.get_type_hints(LambdaToSagemakerEndpointProps.__init__)
