...
class TokenPairsUtility:
    ...
    def getcrossAssetsDict(self):
        crossAssetsDict = requests.get("https://raw.githubusercontent.com/Nevquit/configW/main/crossAssetsDict_{}.json".format(self.net)).json()
        return crossAssetsDict
