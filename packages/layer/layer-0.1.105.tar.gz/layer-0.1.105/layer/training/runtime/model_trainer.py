...
from ...logged_data.queuing_logged_data_destination import QueueingLoggedDataDestination
...
class ModelTrainer:
    ...
    def _train(
        ...
        ) as train, QueueingLoggedDataDestination(
            self.client.logged_data_service_client, self.logger
        ) as logged_data_dest:
