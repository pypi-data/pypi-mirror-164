...
def log(
    ...
    **Tables**
    ...
    if not logged_data_destination:
        raise RuntimeError("No active logging data destination. Could not log data.")
    ...
    with LayerClient(layer_config.client, logger).init():
        ...
        log_data_runner.log(data=data, epoch=step, category=category, break_url=break_url)
