...
try:
    ...
    THEMES_DIR=mkrst_themes.__path__._path[0]
...
class CommandExecutor:
    ...
    def make_pdf(self):
        ...
        args = ['rst2pdf', '--fit-background-mode=scale', '--use-floating-images', '--real-footnotes', '-e', 'preprocess'] + opts
...
def main():
    ...
    parser.add_argument('-t', '--theme', type=str, default=THEME,
    ...
    parser.add_argument('--ext', type=str, default='',
            help='Load docutils extensions (coma separated)')
