...
_METAOPTIMIZATIONTARGET_THRESHOLDCONFIG = _descriptor.Descriptor(
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='type', full_name='tensorflow.metadata.v0.MetaOptimizationTarget.ThresholdConfig.type',
      index=0, containing_type=None, fields=[]),
  ],
...
_METAOPTIMIZATIONTARGET_THRESHOLDCONFIG.oneofs_by_name['type'].fields.append(
  _METAOPTIMIZATIONTARGET_THRESHOLDCONFIG.fields_by_name['threshold'])
_METAOPTIMIZATIONTARGET_THRESHOLDCONFIG.fields_by_name['threshold'].containing_oneof = _METAOPTIMIZATIONTARGET_THRESHOLDCONFIG.oneofs_by_name['type']
