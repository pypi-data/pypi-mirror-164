...
class CloudFrontToMediaStore(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CloudFrontToMediaStore.__init__)
    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(media_store_container_props, dict):
            media_store_container_props = CfnContainerProps(**media_store_container_props)
        if __debug__:
            type_hints = typing.get_type_hints(CloudFrontToMediaStoreProps.__init__)
