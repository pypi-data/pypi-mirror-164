...
class MessageID(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["connection_id",b"connection_id","direction",b"direction","sequence",b"sequence","subsequence",b"subsequence"]) -> None: ...
...
class MessageMetadata(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["id",b"id","timestamp",b"timestamp"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["id",b"id","message_type",b"message_type","properties",b"properties","protocol",b"protocol","timestamp",b"timestamp"]) -> None: ...
...
class RawMessageMetadata(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["id",b"id","timestamp",b"timestamp"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["id",b"id","properties",b"properties","protocol",b"protocol","timestamp",b"timestamp"]) -> None: ...
...
class ComparisonSettings(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["fail_unexpected",b"fail_unexpected","ignore_fields",b"ignore_fields"]) -> None: ...
...
class RootComparisonSettings(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        decimal_precision: typing.Text = ...,
        check_simple_collections_order: typing.Optional[google.protobuf.wrappers_pb2.BoolValue] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["check_simple_collections_order",b"check_simple_collections_order","time_precision",b"time_precision"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["check_repeating_group_order",b"check_repeating_group_order","check_simple_collections_order",b"check_simple_collections_order","decimal_precision",b"decimal_precision","ignore_fields",b"ignore_fields","time_precision",b"time_precision"]) -> None: ...
...
class MessageFilter(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["comparison_settings",b"comparison_settings","direction",b"direction","fields",b"fields","messageType",b"messageType"]) -> None: ...
...
class Checkpoint(google.protobuf.message.Message):
    ...
    class DirectionCheckpoint(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["direction_to_checkpoint_data",b"direction_to_checkpoint_data","direction_to_sequence",b"direction_to_sequence"]) -> None: ...
    ...
    def ClearField(self, field_name: typing_extensions.Literal["id",b"id","session_alias_to_direction_checkpoint",b"session_alias_to_direction_checkpoint"]) -> None: ...
...
class Event(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["end_timestamp",b"end_timestamp","id",b"id","parent_id",b"parent_id","start_timestamp",b"start_timestamp"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["attached_message_ids",b"attached_message_ids","body",b"body","end_timestamp",b"end_timestamp","id",b"id","name",b"name","parent_id",b"parent_id","start_timestamp",b"start_timestamp","status",b"status","type",b"type"]) -> None: ...
...
class EventBatch(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["events",b"events","parent_event_id",b"parent_event_id"]) -> None: ...
