...
class ReviewStatusRule(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRING:
                    self.reportHash = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.STRUCT:
...
class ReportFilter(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i107 in range(_size103):
                        ...
                        self.checkerMsg.append(_elem108)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.LIST:
                    ...
                    for _i113 in range(_size109):
                        ...
                        self.checkerName.append(_elem114)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.LIST:
                    ...
                    for _i119 in range(_size115):
                        ...
                        self.reportHash.append(_elem120)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i131 in range(_size127):
                        ...
                        self.reviewStatus.append(_elem132)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 7:
                if ftype == TType.LIST:
                    ...
                    for _i137 in range(_size133):
                        ...
                        self.detectionStatus.append(_elem138)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 8:
                if ftype == TType.LIST:
                    ...
                    for _i143 in range(_size139):
                        ...
                        self.runHistoryTag.append(_elem144)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 9:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i161 in range(_size157):
                        ...
                        self.componentNames.append(_elem162)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 15:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i167 in range(_size163):
                        ...
                        self.analyzerNames.append(_elem168)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 18:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i173 in range(_size169):
                        ...
                        self.cleanupPlanNames.append(_elem174)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.checkerMsg is not None:
            ...
            for iter176 in self.checkerMsg:
        ...
        if self.checkerName is not None:
            ...
            for iter177 in self.checkerName:
        ...
        if self.reportHash is not None:
            ...
            for iter178 in self.reportHash:
        ...
        if self.reviewStatus is not None:
            ...
            for iter180 in self.reviewStatus:
        ...
        if self.detectionStatus is not None:
            ...
            for iter181 in self.detectionStatus:
        ...
        if self.runHistoryTag is not None:
            ...
            for iter182 in self.runHistoryTag:
        ...
        if self.componentNames is not None:
            ...
            for iter185 in self.componentNames:
        ...
        if self.analyzerNames is not None:
            ...
            for iter186 in self.analyzerNames:
        ...
        if self.cleanupPlanNames is not None:
            ...
            for iter187 in self.cleanupPlanNames:
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i198 in range(_size194):
                        _elem199 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.names.append(_elem199)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.SET:
                    self.lines = set()
                    (_etype219, _size216) = iprot.readSetBegin()
                    for _i220 in range(_size216):
                        _elem221 = iprot.readI64()
                        self.lines.add(_elem221)
                    iprot.readSetEnd()
                else:
                    iprot.skip(ftype)
            else:
...
class ExportData(object):
            ...
            if fid == 1:
                if ftype == TType.MAP:
                    ...
                    for _i227 in range(_size223):
                        ...
                        for _i234 in range(_size230):
                            _elem235 = CommentData()
                            _elem235.read(iprot)
                            _val229.append(_elem235)
                        iprot.readListEnd()
                        self.comments[_key228] = _val229
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.MAP:
                    ...
                    for _i240 in range(_size236):
                        ...
                        _val242 = ReviewData()
                        _val242.read(iprot)
                        self.reviewData[_key241] = _val242
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.comments is not None:
            ...
            for kiter243, viter244 in self.comments.items():
...
class BlameInfo(object):
    ...
    def write(self, oprot):
        ...
        if self.commits is not None:
            ...
            for kiter261, viter262 in self.commits.items():
...
class CleanupPlan(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i268 in range(_size264):
                        ...
                        self.reportHashes.append(_elem269)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.reportHashes is not None:
            ...
            oprot.writeListBegin(TType.STRING, len(self.reportHashes))
            for iter270 in self.reportHashes:
