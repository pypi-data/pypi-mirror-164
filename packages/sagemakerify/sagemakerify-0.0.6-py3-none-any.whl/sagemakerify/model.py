...
class Model():
    def __init__(self, Cls, **kwargs):
        ...
        self.code_s3_path = sagemaker_utils.upload(self.code_tar_file, f'{self.code_s3_prefix}/{self.model_name}', show_progress=False, session = self.session.boto_session)        
