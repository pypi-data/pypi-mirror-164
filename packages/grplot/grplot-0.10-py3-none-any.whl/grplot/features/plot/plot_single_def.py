...
def plot_single_def(plot,
    ...
    # categorical plot family
        ...
        if x is not None and y is not None:
            if ((is_object_dtype(data[x]) == True) or (is_object_dtype(type(data[x][first_valid_index(data[x])])) == True) or (is_categorical_dtype(data[x]) == True) or (is_categorical_dtype(type(data[x][first_valid_index(data[x])])) == True)) and ((is_numeric_dtype(data[y]) == True) or (is_numeric_dtype(type(data[y][first_valid_index(data[y])])) == True)):
            ...
            elif ((is_numeric_dtype(data[x]) == True) or (is_numeric_dtype(type(data[x][first_valid_index(data[x])])) == True)) and ((is_object_dtype(data[y]) == True) or (is_object_dtype(type(data[y][first_valid_index(data[y])])) == True) or (is_categorical_dtype(data[y]) == True) or (is_categorical_dtype(type(data[y][first_valid_index(data[y])])) == True)):
