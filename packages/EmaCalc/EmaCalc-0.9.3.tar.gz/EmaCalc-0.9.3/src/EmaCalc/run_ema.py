...
if __name__ == '__main__':
    ...
    # nap = ds.nap_table(sc='HA', nap_cat=['A', 'B'], grouping=('CoSS',), p=0.95)  # grouped results
    nap = ds.nap_table(sit='HA', nap_cat=['A', 'B'], p=0.95)  # aggregated across other situation dimensions
