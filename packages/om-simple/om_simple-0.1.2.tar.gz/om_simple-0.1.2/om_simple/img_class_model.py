...
class SimpleModel(LightningModule):
    def __init__(self, model_name: str = 'resnet18',
                 pretrained: bool = False, num_classes: Optional[int] = None, class_to_index=None, img_size=112,base_lr=0.01):
        super().__init__()
...
def run_train(dataset_path, model_name="resnet18", outdir="results", img_size=112, epochs=100, save_interval=10, batch_size=8, num_workers=12, gpu_ids=[0], seed=42, base_lr=0.01):
