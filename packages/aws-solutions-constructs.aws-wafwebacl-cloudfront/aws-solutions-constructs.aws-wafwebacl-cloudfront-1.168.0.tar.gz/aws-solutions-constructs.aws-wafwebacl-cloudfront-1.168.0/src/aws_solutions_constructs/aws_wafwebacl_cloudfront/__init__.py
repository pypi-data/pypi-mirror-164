...
class WafwebaclToCloudFront(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(WafwebaclToCloudFront.__init__)
    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(webacl_props, dict):
            webacl_props = CfnWebACLProps(**webacl_props)
        if __debug__:
            type_hints = typing.get_type_hints(WafwebaclToCloudFrontProps.__init__)
