...
if __name__ == '__main__':
    ...
    target_str = 'load_csv'
    target_str = 'ico_menu_futuremarket'
    target_str = '累计净流入'
    root_dir = None
    root_dir = 'C:/Users/glhyy/anaconda3/Lib/site-packages/pyecharts/'
    root_dir = 'C:/Users/glhyy/Desktop/pyecharts-master'
    root_dir = './'
    root_dir = 'D:/Genlovy_Hoo/HooProjects/utils_hoo/'
    # # root_dir = 'D:/Genlovy_Hoo/HooProjects/HooFin/src/'
    # root_dir = 'D:/Genlovy_Hoo/HooProjects/ProjectsHundSun/接手工作/Light'
    # file_types = None
    file_types = 'all'
    file_types = ['.py']
