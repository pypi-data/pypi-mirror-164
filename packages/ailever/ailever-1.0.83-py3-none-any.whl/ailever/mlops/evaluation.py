...
class ScalarRegression:
    ...
    def evaluation(cls, y_true, y_pred):
        ...
        metric['true_25%']           = [np.percentile(comparison['y_true'], 25, axis=0)]
        metric['true_50%']           = [np.percentile(comparison['y_true'], 50, axis=0)]
        metric['true_75%']           = [np.percentile(comparison['y_true'], 75, axis=0)]
        metric['true_max']           = [comparison['y_true'].max()]
        metric['pred_min']           = [comparison['y_pred'].min()]
        metric['pred_25%']           = [np.percentile(comparison['y_pred'], 25, axis=0)]
        metric['pred_50%']           = [np.percentile(comparison['y_pred'], 50, axis=0)]
        metric['pred_75%']           = [np.percentile(comparison['y_pred'], 75, axis=0)]
        metric['pred_max']           = [comparison['y_pred'].max()]
        metric['min_diff']           = [(comparison['y_true'].min() - comparison['y_pred'].min())]
        metric['25%_diff']           = [np.percentile(comparison['y_true'] - comparison['y_pred'], 25, axis=0)]
        metric['50%_diff']           = [np.percentile(comparison['y_true'] - comparison['y_pred'], 50, axis=0)]
        metric['75%_diff']           = [np.percentile(comparison['y_true'] - comparison['y_pred'], 75, axis=0)]
        metric['max_diff']           = [(comparison['y_true'].max() - comparison['y_pred'].max())]
        metric['min_rate']           = [(comparison['y_pred'].min() / comparison['y_true'].min())]
        metric['25%_rate']           = [np.percentile(comparison['y_pred'] / comparison['y_true'], 25, axis=0)]
        metric['50%_rate']           = [np.percentile(comparison['y_pred'] / comparison['y_true'], 50, axis=0)]
        metric['75%_rate']           = [np.percentile(comparison['y_pred'] / comparison['y_true'], 75, axis=0)]
        metric['max_rate']           = [(comparison['y_pred'].max() / comparison['y_true'].max())]
