...
class ScalarRegression:
    ...
    def evaluation(cls, y_true, y_pred):
        ...
        if (comparison['y_true'].min() == 0) and (comparison['y_pred'].min() == 0) :
            metric['min_rate']           = [numpy.nan]
            metric['25%_rate']           = [numpy.nan]
            metric['50%_rate']           = [numpy.nan]
            metric['75%_rate']           = [numpy.nan]
            metric['max_rate']           = [numpy.nan]
        else:
