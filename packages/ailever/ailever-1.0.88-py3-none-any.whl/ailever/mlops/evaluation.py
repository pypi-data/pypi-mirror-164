...
class ScalarRegression:
    ...
    def evaluation(cls, y_true, y_pred):
        ...
        metric['min_rate']           = [(comparison['y_pred'].min() / comparison['y_true'].min())] if (comparison['y_true'].min() != 0) or (comparison['y_pred'].min() != 0) else [numpy.nan]
        ...
        metric['max_rate']           = [(comparison['y_pred'].max() / comparison['y_true'].max())] if (comparison['y_true'].max() != 0) or (comparison['y_pred'].max() != 0) else [numpy.nan]
        metric['mean_rate']           = [(comparison['y_pred'].mean() / comparison['y_true'].mean())] if (comparison['y_true'].mean() != 0) or (comparison['y_pred'].mean() != 0) else [numpy.nan]
        metric['std_rate']           = [(comparison['y_pred'].std() / comparison['y_true'].std())] if (comparison['y_true'].std() != 0) or (comparison['y_pred'].std() != 0) else [numpy.nan]
