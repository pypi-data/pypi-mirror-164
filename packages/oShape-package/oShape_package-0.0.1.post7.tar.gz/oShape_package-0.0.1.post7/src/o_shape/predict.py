...
if __name__ == "__main__":
    ...
    args.image_path = r'C:\Users\jovan\Pictures\head Image\front_ferdy.jpeg'
    args.model_path = str(SRC_DIR / 'checkpoints/best.pth')
    ...
    predict_hair_part(Image.open(r"C:\Users\jovan\Pictures\head Image\front_ferdy.jpeg"))
