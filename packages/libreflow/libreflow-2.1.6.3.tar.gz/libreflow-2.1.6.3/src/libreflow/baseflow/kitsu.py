...
class KitsuAPIWrapper(flow.Object):
    ...
    def get_shot_task_status_name(self, sequence_name, shot_name, task_type_name):
    ...
    def upload_shot_preview(self, sequence_name, shot_name, task_type_name, task_status_name, file_path, comment="", user_name=None):
        shot = self.get_shot_data(shot_name, sequence_name)
        result = False
