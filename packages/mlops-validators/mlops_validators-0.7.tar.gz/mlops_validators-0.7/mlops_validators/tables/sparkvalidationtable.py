...
class SparkValidationTable:
    ...
    def __init__(self, **kwargs):
        ...
        feature_A = kwargs.get("feature_A", None)
        feature_B = kwargs.get("feature_B", None)
        feature_A_remove_missing = kwargs.get("feature_A_remove_missing", False)
        feature_B_remove_missing = kwargs.get("feature_B_remove_missing", False)
        bins = kwargs.get("bins", False)
        sort_buckets = kwargs.get("sort_buckets" , True)
        frequency_label = kwargs.get("frequency_label", "value_")
        percentage_label = kwargs.get("percentage_label", "_percent")
        proportion_label = kwargs.get("proportion_label", "_proportion")
        frequency_totals_label = kwargs.get("frequency_totals_label", "totals")
        buckets_label = kwargs.get("buckets_label", "buckets")
        buckets_min_label = kwargs.get("buckets_min_label", "_min")
        buckets_max_label = kwargs.get("buckets_max_label", "_max")
        comparator = kwargs.get("comparator", "right_closed_comparison")
        ...
        self.frequency_totals_label = frequency_totals_label
