...
class SparkValidationTable:
    ...
    def __compile_cross_table(self, df_buckets, feature_A, feature_B):
        ...
        self.map_cross_columns = {col : self.cross_columns_label+col.replace(".", "_") for col in self.cross_tbl.columns if col != self._cross_feature_name}
    ...
    def __calculate_proportions(self):        
        self.map_cross_columns_p = {col : self.cross_columns_label+col.replace(".", "_")+self.cross_columns_label_p for col in self.map_cross_columns}
        for col in self.map_cross_columns:                        
    ...
    def __calculate_ratings(self):
        ...
        self.map_cross_columns_r = {col : self.cross_columns_label+col.replace(".", "_")+self.cross_columns_label_r for col in self.map_cross_columns}
        for col in self.map_cross_columns:
