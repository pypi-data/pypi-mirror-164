...
from robotframework_zebrunner.api.models import (
...
from robotframework_zebrunner.errors import AgentApiError
from robotframework_zebrunner.utils import Singleton
...
class ZebrunnerAPI(metaclass=Singleton):
    ...
    def finish_test_run(self, test_run_id: int) -> None:
        ...
        """
        print("finish test run: ", test_run_id, datetime.utcnow())
