...
def get_gravity_center(image, mask=None):
...
def plt_image_show(*image, window_name='', array_res=False, full_screen=True, cmap=None, position=[30, 30], share_xy=False, axis_off=False, col_num=None, norm_float=True):
    '''
    更加鲁棒地显示图像包括二维图像,第三维度为1的图像
    '''
