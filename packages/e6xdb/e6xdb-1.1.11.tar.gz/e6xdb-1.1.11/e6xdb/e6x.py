...
class Connection(object):
    ...
    def get_schema_names(self, database, table):
...
if __name__ == '__main__':
    connection = connect(host="44.200.35.172",
                         port=9000,
                         scheme="e6xdb",
                         username="admin",
                         database="tydy",
    ...
    cursor.execute("SELECT offer_created_date from candidate_offer_letter limit 100;")
    bdata = []
    for i in range(10):
