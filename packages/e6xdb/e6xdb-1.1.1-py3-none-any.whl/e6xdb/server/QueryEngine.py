...
class Iface(object):
    ...
    def createSchema(self, sPathName, nIntervalmillis):
        """
        Parameters:
         - sPathName
         - nIntervalmillis
...
class Client(Iface):
    ...
    def createSchema(self, sPathName, nIntervalmillis):
        ...
        """
        self.send_createSchema(sPathName, nIntervalmillis)
        return self.recv_createSchema()

    def send_createSchema(self, sPathName, nIntervalmillis):
        self._oprot.writeMessageBegin('createSchema', TMessageType.CALL, self._seqid)
        args = createSchema_args()
        args.sPathName = sPathName
        args.nIntervalmillis = nIntervalmillis
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()
...
class Processor(Iface, TProcessor):
    ...
    def process_createSchema(self, seqid, iprot, oprot):
        ...
        result = createSchema_result()
        try:
            result.success = self._handler.createSchema(args.sPathName, args.nIntervalmillis)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except SchemaProcessingException as error:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("createSchema", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
...
class createSchema_args(object):
    """
    Attributes:
     - sPathName
     - nIntervalmillis
    ...
    def __init__(self, sPathName=None, nIntervalmillis=None,):
        self.sPathName = sPathName
        self.nIntervalmillis = nIntervalmillis
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRING:
                    self.sPathName = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.I64:
                    self.nIntervalmillis = iprot.readI64()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.sPathName is not None:
            oprot.writeFieldBegin('sPathName', TType.STRING, 1)
            oprot.writeString(self.sPathName.encode('utf-8') if sys.version_info[0] == 2 else self.sPathName)
            oprot.writeFieldEnd()
        if self.nIntervalmillis is not None:
            oprot.writeFieldBegin('nIntervalmillis', TType.I64, 2)
            oprot.writeI64(self.nIntervalmillis)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(createSchema_args)
createSchema_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'sPathName', 'UTF8', None, ),  # 1
    (2, TType.I64, 'nIntervalmillis', None, None, ),  # 2
)


class createSchema_result(object):
    """
    Attributes:
     - success
     - error
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(createSchema_result)
createSchema_result.thrift_spec = (
