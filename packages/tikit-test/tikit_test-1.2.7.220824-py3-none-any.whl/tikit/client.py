...
from tikit import models as tikit_models
...
class Client(object):
    ...
    def create_model_by_task(self,
        ...
        :param model_format: 模型格式(PYTORCH/TORCH_SCRIPT/DETECTRON2/SAVED_MODEL/FROZEN_GRAPH/PMML)
    ...
    def create_model_service_version(self,
        ...
        return self.create_model_service_do("", worker_resource, framework, service_group_id,
                                            ...
                                            scale_strategy, hybrid_billing_prepaid_replicas, True)
    ...
    def create_model_service(self,
        ...
        return self.create_model_service_do(service_group_name, worker_resource, framework, service_group_id,
                                            service_description, resource_group_id, model_config_info, model_cos_path,
                                            env, scale_mode, replicas, horizontal_pod_autoscaler, log_enable,
                                            log_logset_id, log_topic_id, authorization_enable, tags, cron_scale_jobs,
                                            scale_strategy, hybrid_billing_prepaid_replicas, False)

    def create_model_service_do(self,
                                service_group_name,
                                worker_resource,
                                framework,
                                service_group_id=None,
        ...
        try:
            ...
            if worker_resource.ChargeType == "PREPAID" or worker_resource.ChargeType == "HYBRID_PAID":
                worker_info.Cpu = worker_resource.Cpu
                worker_info.Memory = worker_resource.Memory
                worker_info.Gpu = worker_resource.Gpu
                worker_info.GpuType = worker_resource.GpuType
    ...
    def stop_model_service(self, service_id):
        """关闭服务
