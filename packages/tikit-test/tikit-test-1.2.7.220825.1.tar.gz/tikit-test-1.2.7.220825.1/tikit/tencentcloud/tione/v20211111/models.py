...
注意：此字段可能返回 null，表示取不到有效值。
        ...
        :type ResourceConfigInfo: :class:`tikit.tencentcloud.tione.v20211111.models.ResourceConfigInfo`
        :param Tags: 标签
注意：此字段可能返回 null，表示取不到有效值。
        :type Tags: list of Tag
        :param ModelInfo: 服务对应的模型信息
注意：此字段可能返回 null，表示取不到有效值。
        :type ModelInfo: :class:`tikit.tencentcloud.tione.v20211111.models.ModelInfo`
        :param ImageInfo: 自定义镜像信息
注意：此字段可能返回 null，表示取不到有效值。
        :type ImageInfo: :class:`tikit.tencentcloud.tione.v20211111.models.ImageInfo`
        :param CodePackagePath: 代码包
注意：此字段可能返回 null，表示取不到有效值。
        :type CodePackagePath: :class:`tikit.tencentcloud.tione.v20211111.models.CosPathInfo`
        :param StartCmd: 启动命令
注意：此字段可能返回 null，表示取不到有效值。
        :type StartCmd: str
...
class CreateBatchTaskRequest(AbstractModel):
    ...
    def __init__(self):
        ...
        :type CronInfo: :class:`tikit.tencentcloud.tione.v20211111.models.CronInfo`
        :param ResourceGroupId: 预付费专用资源组
        :type ResourceGroupId: str
        :param Tags: 标签配置
        :type Tags: list of Tag
        ...
        :type CodePackage: :class:`tikit.tencentcloud.tione.v20211111.models.CosPathInfo`
        :param StartCmd: 启动命令
        :type StartCmd: str
...
TYPE_DATASET_OTHER，其他
        ...
        :type StorageDataPath: :class:`tikit.tencentcloud.tione.v20211111.models.CosPathInfo`
        :param StorageLabelPath: 数据集标签cos存储路径
        :type StorageLabelPath: :class:`tikit.tencentcloud.tione.v20211111.models.CosPathInfo`
...
class CreateModelServiceRequest(AbstractModel):
    ...
    def __init__(self):
        ...
        :type Resources: :class:`tikit.tencentcloud.tione.v20211111.models.ResourceInfo`
...
后付费实例自动调节模式下对应 时间策略的默认策略的实例数量
        ...
        :type HorizontalPodAutoscaler: :class:`tikit.tencentcloud.tione.v20211111.models.HorizontalPodAutoscaler`
...
注意：此字段可能返回 null，表示取不到有效值。
        :type Service: :class:`tikit.tencentcloud.tione.v20211111.models.Service`
        :param RequestId: 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
        :type RequestId: str
        """
        self.Service = None
...
class CreateTrainingModelRequest(AbstractModel):
    ...
    def __init__(self):
        ...
        :type TrainingModelCosPath: :class:`tikit.tencentcloud.tione.v20211111.models.CosPathInfo`
        ...
        :type ReasoningImageInfo: :class:`tikit.tencentcloud.tione.v20211111.models.ImageInfo`
        ...
        :type ModelOutputPath: :class:`tikit.tencentcloud.tione.v20211111.models.CosPathInfo`
...
class CreateTrainingTaskRequest(AbstractModel):
    ...
    def __init__(self):
        ...
        :type Output: :class:`tikit.tencentcloud.tione.v20211111.models.CosPathInfo`
        :param LogEnable: 是否上报日志
        :type LogEnable: bool
        ...
        :type StartCmdInfo: :class:`tikit.tencentcloud.tione.v20211111.models.StartCmdInfo`
...
注意：此字段可能返回 null，表示取不到有效值。
        :type DataSetSource: :class:`tikit.tencentcloud.tione.v20211111.models.DataSetConfig`
        :param COSSource: 来自cos的数据
注意：此字段可能返回 null，表示取不到有效值。
        :type COSSource: :class:`tikit.tencentcloud.tione.v20211111.models.CosPathInfo`
        :param CFSSource: 来自CFS的数据
注意：此字段可能返回 null，表示取不到有效值。
        :type CFSSource: :class:`tikit.tencentcloud.tione.v20211111.models.CFSConfig`
        :param HDFSSource: 来自HDFS的数据
注意：此字段可能返回 null，表示取不到有效值。
        :type HDFSSource: :class:`tikit.tencentcloud.tione.v20211111.models.HDFSConfig`
        :param WeDataHDFSSource: 来自WEDATA_HDFS的数据
注意：此字段可能返回 null，表示取不到有效值。
        :type WeDataHDFSSource: :class:`tikit.tencentcloud.tione.v20211111.models.WeDataHDFSConfig`
        """
...
注意：此字段可能返回 null，表示取不到有效值。
        :type BatchTaskDetail: :class:`tikit.tencentcloud.tione.v20211111.models.BatchTaskDetail`
        :param RequestId: 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
        :type RequestId: str
        """
...
注意：此字段可能返回 null，表示取不到有效值。
        :type ServiceGroup: :class:`tikit.tencentcloud.tione.v20211111.models.ServiceGroup`
        :param RequestId: 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
        :type RequestId: str
        """
...
class DescribeTrainingModelVersionResponse(AbstractModel):
    ...
    def __init__(self):
        r"""
        :param TrainingModelVersion: 模型版本
        :type TrainingModelVersion: :class:`tikit.tencentcloud.tione.v20211111.models.TrainingModelVersionDTO`
        :param RequestId: 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
        :type RequestId: str
        """
        self.TrainingModelVersion = None
...
class DescribeTrainingTaskResponse(AbstractModel):
    ...
    def __init__(self):
        ...
        :type TrainingTaskDetail: :class:`tikit.tencentcloud.tione.v20211111.models.TrainingTaskDetail`
        :param RequestId: 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
        :type RequestId: str
        """
...
注意：此字段可能返回 null，表示取不到有效值。
        :type UsedResource: :class:`tikit.tencentcloud.tione.v20211111.models.ResourceInfo`
        :param TotalResource: 节点总资源
注意：此字段可能返回 null，表示取不到有效值。
        :type TotalResource: :class:`tikit.tencentcloud.tione.v20211111.models.ResourceInfo`
...
注意：此字段可能返回 null，表示取不到有效值。
        :type ModelSource: :class:`tikit.tencentcloud.tione.v20211111.models.ModelSource`
        :param CosPathInfo: 模型cos路径
注意：此字段可能返回 null，表示取不到有效值。
        :type CosPathInfo: :class:`tikit.tencentcloud.tione.v20211111.models.CosPathInfo`
        :param CreateTime: 创建时间
注意：此字段可能返回 null，表示取不到有效值。
        :type CreateTime: str
...
注意：此字段可能返回 null，表示取不到有效值。
        :type ModelCosPath: :class:`tikit.tencentcloud.tione.v20211111.models.CosPathInfo`
        """
        self.ModelId = None
...
注意：此字段可能返回 null，表示取不到有效值。
        :type AlgorithmFramework: str
        :param ModelType: 默认为 NORMAL, 已加速模型: ACCELERATE
注意：此字段可能返回 null，表示取不到有效值。
        :type ModelType: str
...
注意：此字段可能返回 null，表示取不到有效值。
        :type UsedResource: :class:`tikit.tencentcloud.tione.v20211111.models.GroupResource`
        :param TotalResource: 资源组总资源
注意：此字段可能返回 null，表示取不到有效值。
        :type TotalResource: :class:`tikit.tencentcloud.tione.v20211111.models.GroupResource`
...
注意：此字段可能返回 null，表示取不到有效值。
        :type ServiceInfo: :class:`tikit.tencentcloud.tione.v20211111.models.ServiceInfo`
...
注意：此字段可能返回 null，表示取不到有效值。
        :type Status: :class:`tikit.tencentcloud.tione.v20211111.models.WorkloadStatus`
        :param Weight: 权重
注意：此字段可能返回 null，表示取不到有效值。
        :type Weight: int
        :param PodList: 实例列表
...
注意：此字段可能返回 null，表示取不到有效值。
        :type ResourceTotal: :class:`tikit.tencentcloud.tione.v20211111.models.ResourceInfo`
