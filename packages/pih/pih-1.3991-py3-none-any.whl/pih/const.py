...
class LogCommand(enum.Enum):
    DEBUG: str = "debug"
    LOG_IN: str = "facade:log_in"
    #
...
LOG_COMMAND_LIST = {
    LogCommand.DEBUG: LogCommand("It is a debug command", LogChannel.NOTIFICATION, LogLevel.DEBUG),
    #
    LogCommand.LOG_IN: LogCommand(
    ...
    #
    LogCommand.POLIBASE_DB_BACKUP_START: LogCommand(
        "Start Polibase DataBase Dump backup",  LogChannel.BACKUP, LogLevel.NORMAL),
    LogCommand.POLIBASE_DB_BACKUP_COMPLETE: LogCommand(
