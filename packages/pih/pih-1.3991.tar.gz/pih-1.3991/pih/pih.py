...
from pih.const import CONST, EXECUTOR, FIELD_NAME_COLLECTION, FIELD_COLLECTION, PASSWORD, PATHS, USER_PROPERTY, LogChannel, LogCommandName, LogLevel
...
class PIH:
    ...
    @staticmethod
    def log(message: str, channel: LogChannel = LogChannel.DEFAULT, level: Any = LogLevel.DEFAULT) -> Any:
    ...
    def command(command: LogCommandName) -> Any:
        return RPC_COMMANDS.LOG.command(command.name)

    class LOG:

        @staticmethod
        def debug(message: str, level: Any = LogLevel.DEFAULT) -> Any:
            return PIH.log(message, LogChannel.DEBUG, level)

        @staticmethod
        def backup(message: str, level: Any = LogLevel.DEFAULT) -> Any:
            return PIH.log(message, LogChannel.BACKUP, level)

        @staticmethod
        def notification(message: str, level: Any = LogLevel.DEFAULT) -> Any:
            return PIH.log(message, LogChannel.NOTIFICATION, level)

        @staticmethod
        def printer(message: str, level: Any = LogLevel.DEFAULT) -> Any:
            return PIH.log(message, LogChannel.PRINTER, level)
