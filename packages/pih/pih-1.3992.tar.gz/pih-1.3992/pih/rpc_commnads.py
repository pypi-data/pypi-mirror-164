...
class RPC_COMMANDS:
    ...
    class LOG:
        ...
        @staticmethod
        def command(message: LogCommandName, parameters: Tuple = None) -> str:
            all_parameters: Tuple = (message) + parameters
            return RPC.call(RPC_COMMANDS.LOG.create_rpc_command("command"), all_parameters)
