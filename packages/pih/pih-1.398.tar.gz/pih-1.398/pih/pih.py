...
from pih.const import CONST, EXECUTOR, FIELD_NAME_COLLECTION, FIELD_COLLECTION, PASSWORD, PATHS, USER_PROPERTY, LogChannel
...
class PIH:
    ...
    class LOG:
        ...
        @staticmethod
        def log(message: str, channel: LogChannel, level: int) -> Any:
            return RPC_COMMANDS.LOG.log(message, channel. level)
