...
LOG_COMMAND_LIST = {
    ...
    #
    LogCommandName.PRINTER_REPORT: LogCommand("Printer {printer_name} ({location}) information:", LogChannel.NOTIFICATION, LogLevel.NORMAL.value, (ParamItem("printer_name", "Name of printer"), ParamItem("location", "Location"), ParamItem("printe_report", "Printer report"))),
    #
