...
from pih.const import CONST, EXECUTOR, FIELD_NAME_COLLECTION, FIELD_COLLECTION, PASSWORD, PATHS, USER_PROPERTY, LogChannel, LogLevel
...
class PIH:
    ...
    class LOG:
        ...
        @staticmethod
        def log(message: str, channel: LogChannel = LogChannel.DEFAULT, level: List = LogLevel.DEFAULT) -> Any:
