...
LOG_COMMAND_LIST = {
    ...
    LogCommandName.LOG_IN: LogCommand(
        "User {name} ({computer_name}) log in", LogChannel.SYSTEM, LogLevel.NORMAL.value, (ParamItem("name", "Name of user"), ParamItem("computer_name", "Name of computer"))),
    #
    LogCommandName.PRINTER_REPORT: LogCommand("Printer {printer_name} ({location}) information: {printer_report}", LogChannel.NOTIFICATION, LogLevel.NORMAL.value, (ParamItem("printer_name", "Name of printer"), ParamItem("location", "Location"), ParamItem("printer_report", "Printer report"))),
    #
