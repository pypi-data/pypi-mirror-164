...
class DataStore(APIObject):
    ...
    def test(self, username, password):
        ...
        return self._client.post(f"{self._path}{self.id}/test/", data=payload).json()
    ...
    def schemas(self, username, password):
        ...
        """
        payload = {"user": username, "password": password}
        return self._client.post(f"{self._path}{self.id}/schemas/", data=payload).json()
    ...
    def tables(self, username, password, schema=None):
        ...
        return self._client.post(f"{self._path}{self.id}/tables/", data=payload).json()
