...
New Features
************
- Default autopilot mode in :meth:`project.start_autopilot <datarobot.models.Project.start_autopilot>` is changed to `AUTOPILOT_MODE.QUICK`.
...
- Added a new method to :class:`RetrainingPolicy <datarobot._experimental.models.retraining.RetrainingPolicy>`
  ...
  -  Added a new method to :meth:`RetrainingPolicy.delete <datarobot._experimental.models.retraining.RetrainingPolicy.delete>` that deletes a retraining policy associated with a deployment.
...
- Added support for passing in a `max_wait` value to :meth:`AutomatedDocument.generate <datarobot.models.automated_documentation.AutomatedDocument.generate>`
...
- Added two new properties to :class:`datarobot.models.Project`: ``catalog_id`` & ``catalog_version_id``.
