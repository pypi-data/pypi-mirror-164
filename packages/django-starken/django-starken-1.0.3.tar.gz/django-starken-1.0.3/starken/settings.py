"""
Settings for Linets with starken courier are all namespaced in the LINETS setting.
...
DEFAULTS = {
    ...
    'SENDER': {
        ...
        'GENERATE_LABEL_DOCUMENT_1': '<STARKEN_GENERATE_LABEL_DOCUMENT_1>',
        'TYPE_ORDER_1': '<STARKEN_TYPE_ORDER_1>',
        'ORIGIN_CITY': '<STARKEN_ORIGIN_CITY>',
    }
}
...
class APISettings:
    ...
    def user_settings(self):
        if not hasattr(self, '_user_settings'):
            self._user_settings = getattr(settings, 'DJANGO_STARKEN', {})
