...
class FinanceTokenBertSuite(unittest.TestCase):
    ...
    pretrainedModelSavePath = "/home/ckl/old_home/ckl/Documents/freelance/jsl/jsl_internal_latest69696/tmp/trained_models/by_anno/medbert_tok/bert_token_classifier_ade_tweet_binary_en_4.0.0_3.0_1659092904667"
    ...
    def test_pretrained_model(self):
        anno_cls_to_test = sparknlp_jsl.finance.FinanceBertForTokenClassification

        model = anno_cls_to_test.load(self.pretrainedModelSavePath).setInputCols("document", "tokens",).setOutputCol(
            "test_result")
