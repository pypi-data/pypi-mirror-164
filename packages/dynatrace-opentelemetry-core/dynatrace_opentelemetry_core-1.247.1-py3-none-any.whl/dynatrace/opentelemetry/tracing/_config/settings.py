...
class ConfigAttributes(enum.Enum):
    ...
    CONNECTION_AUTH_TOKEN = ConfigAttrSpec(
        "Connection/Auth-Token", str, MANDATORY_VALUE
    )
...
class ExtraSettings:
    ...
    DEFAULT_SHUTDOWN_OR_FLUSH_TIMEOUT_MILLIS = 6000
    DEFAULT_REGULAR_EXPORT_TIMEOUTS_MILLIS = (10000, 60000)
    DEFAULT_FLUSH_EXPORT_TIMEOUTS_MILLIS = (1000, 5000)
    ...
    def __init__(self, config: Dict[ConfigAttributes, Any], **kwargs):
        ...
        Args:
            ...
            shutdown_or_flush_timeout_millis: The time in milliseconds which a call
                to the SpanProcessor's shutdown or force_flush method will wait
                before giving up.
            ...
            flush_export_timeouts_millis: A tuple in the form of
                (connection_timeout, read_timeout) used by the exporter for flush
                export operations. Values are expected in milliseconds.
        ...
        self.shutdown_or_flush_timeout_millis = kwargs.get(
            "shutdown_or_flush_timeout_millis",
            self.DEFAULT_SHUTDOWN_OR_FLUSH_TIMEOUT_MILLIS,
        )
        ...
        self.flush_send_timeouts_millis = kwargs.get(
            "flush_export_timeouts_millis",
            self.DEFAULT_FLUSH_EXPORT_TIMEOUTS_MILLIS,
        )
