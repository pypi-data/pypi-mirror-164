...
class Scheduler(object):
    ...
    def cron(self, cron_string, func, args=None, kwargs=None, repeat=None,
             queue_name=None, id=None, timeout=None, description=None, meta=None, use_timezone=False,
             depends_on=None, on_success=None, on_failure=None):
        """
        Schedule a cronjob
        """
        scheduled_time = get_next_scheduled_time(cron_string, use_timezone=use_timezone)
        ...
        job.meta['use_timezone'] = use_timezone
    ...
    def enqueue_job(self, job):
        ...
        use_timezone = job.meta.get('use_timezone', None)
        ...
        if interval:
            ...
            if repeat is not None:
                if job.meta['repeat'] == 0:
                    return
            next_scheduled_time = get_next_scheduled_time(cron_string, use_timezone=use_timezone)
            self.connection.zadd(self.scheduled_jobs_key,
