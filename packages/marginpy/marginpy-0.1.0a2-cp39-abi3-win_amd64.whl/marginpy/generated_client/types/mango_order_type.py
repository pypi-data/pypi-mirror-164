...
MangoOrderTypeKind = typing.Union[
    Limit, ImmediateOrCancel, PostOnly, Market, PostOnlySlide
]
MangoOrderTypeJSON = typing.Union[
    LimitJSON, ImmediateOrCancelJSON, PostOnlyJSON, MarketJSON, PostOnlySlideJSON
]


def from_decoded(obj: dict) -> MangoOrderTypeKind:
...
def from_json(obj: MangoOrderTypeJSON) -> MangoOrderTypeKind:
    if obj["kind"] == "Limit":
        return Limit()
