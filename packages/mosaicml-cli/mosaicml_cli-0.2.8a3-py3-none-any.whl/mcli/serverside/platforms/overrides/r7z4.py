...
R7Z4_INSTANCES = LocalPlatformInstances(available_instances={GPUType.NONE: [0]}, gpu_configurations=[a100_config])


class R7Z4Platform(GenericK8sPlatform):
    """ R7Z4 Platform Overrides """

    allowed_instances: PlatformInstances = R7Z4_INSTANCES
