...
R7Z1_INSTANCES = LocalPlatformInstances(available_instances={GPUType.NONE: [0]}, gpu_configurations=[a100_config])


class R7Z1Platform(GenericK8sPlatform):
    """ R7Z1 Platform Overrides """

    allowed_instances: PlatformInstances = R7Z1_INSTANCES
