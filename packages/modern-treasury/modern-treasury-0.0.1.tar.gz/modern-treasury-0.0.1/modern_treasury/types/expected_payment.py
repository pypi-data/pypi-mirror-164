...
class ExpectedPayment(BaseModel):
    ...
    date_lower_bound: Optional[Optional[str]]
    """The earliest date the payment may come in. Format: yyyy-mm-dd"""

    date_upper_bound: Optional[Optional[str]]
    ...
    reconciliation_method: Optional[Optional[Literal["automatic", "manual"]]]
    """
    ...
    status: Optional[Literal["archived", "reconciled", "unreconciled"]]
