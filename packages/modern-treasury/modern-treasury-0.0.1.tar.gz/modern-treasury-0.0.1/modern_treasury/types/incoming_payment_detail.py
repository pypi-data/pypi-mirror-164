...
class VirtualAccountRoutingDetails(BaseModel):
    bank_address: Optional[Optional[VirtualAccountRoutingDetailsBankAddress]]
...
class VirtualAccount(BaseModel):
    account_details: Optional[List[VirtualAccountAccountDetails]]
    ...
    credit_ledger_account_id: Optional[Optional[str]]
    ...
    debit_ledger_account_id: Optional[Optional[str]]
    ...
    routing_details: Optional[List[VirtualAccountRoutingDetails]]
...
class IncomingPaymentDetail(BaseModel):
    ...
    status: Optional[Literal["completed", "pending", "returned"]]
    """The current status of the incoming payment order.

    One of `pending`, `completed`, or `returned`.
    """

    transaction_id: Optional[Optional[str]]
    """The ID of the reconciled Transaction or `null`."""

    transaction_line_item_id: Optional[Optional[str]]
    """The ID of the reconciled Transaction Line Item or `null`."""

    type: Optional[Literal["ach", "book", "check", "rtp", "sepa", "signet", "wire"]]
    """One of: `ach`, `wire`, `check`, `rtp`, `sepa`, `signet`."""

    updated_at: Optional[str]

    vendor_id: Optional[Optional[str]]
    """The identifier of the vendor bank."""

    virtual_account: Optional[Optional[VirtualAccount]]
    """
    If the incoming payment detail is in a virtual account, the serialized virtual
    account object.
    """

    virtual_account_id: Optional[Optional[str]]
    """
