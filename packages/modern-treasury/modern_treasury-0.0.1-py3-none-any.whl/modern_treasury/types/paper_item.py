...
class PaperItem(BaseModel):
    account_number: Optional[Optional[str]]
    """The account number on the paper item."""

    amount: Optional[int]
    """The amount of the paper item."""

    check_number: Optional[Optional[str]]
    ...
    lockbox_number: Optional[str]
    """The identifier for the lockbox assigned by the bank."""

    memo_field: Optional[Optional[str]]
    """The memo field on the paper item."""

    object: Optional[str]

    remitter_name: Optional[Optional[str]]
    """The name of the remitter on the paper item."""

    routing_number: Optional[Optional[str]]
