...
__all__ = ["ReferenceNumbers", "PaymentOrder"]
...
class ReferenceNumbers(BaseModel):
    ...
    reference_number_type: Optional[
        Literal[
...
class PaymentOrder(BaseModel):
    ...
    charge_bearer: Optional[Optional[Literal["shared", "sender", "receiver"]]]
    ...
    counterparty_id: Optional[Optional[str]]
    """
    ...
    current_return: Optional[Optional[return_object.ReturnObject]]
    """
    If the payment order's status is `returned`, this will include the return
    object's data.
    """

    decision_id: Optional[Optional[str]]
    """
    ...
    foreign_exchange_contract: Optional[Optional[str]]
    """
    If present, indicates a specific foreign exchange contract number that has been
    generated by your financial institution.
    """

    foreign_exchange_indicator: Optional[Optional[Literal["fixed_to_variable", "variable_to_fixed"]]]
    """
    ...
    ledger_transaction_id: Optional[Optional[str]]
    ...
    originating_party_name: Optional[Optional[str]]
    """
    ...
    priority: Optional[Literal["high", "normal"]]
    ...
    receiving_account_type: Optional[Literal["internal_account", "external_account"]]

    reference_numbers: Optional[List[ReferenceNumbers]]

    remittance_information: Optional[Optional[str]]
    ...
    send_remittance_advice: Optional[Optional[bool]]
    ...
    statement_descriptor: Optional[Optional[str]]
    ...
    subtype: Optional[Optional[Literal["CCD", "CIE", "CTX", "IAT", "PPD", "TEL", "WEB"]]]
    """
    ...
    transaction_monitoring_enabled: Optional[bool]
    """
    ...
    ultimate_originating_party_identifier: Optional[Optional[str]]
    """Identifier of the ultimate originator of the payment order."""

    ultimate_originating_party_name: Optional[Optional[str]]
    """Name of the ultimate originator of the payment order."""

    ultimate_receiving_party_identifier: Optional[Optional[str]]

    ultimate_receiving_party_name: Optional[Optional[str]]

    updated_at: Optional[str]

    vendor_failure_reason: Optional[Optional[str]]
