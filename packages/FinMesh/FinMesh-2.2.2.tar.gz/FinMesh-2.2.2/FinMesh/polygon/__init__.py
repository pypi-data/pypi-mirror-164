...
class polygonStocks:
    def __init__(ticker, external=False):
        self.ticker = ticker
    ...
    def get_aggregates(multiplier, timespan, from_date, to_date, output=None, **query_params):
        result = aggregates(self.ticker, multiplier, timespan, from_date, to_date, external=self.external, query_params=query_params)

    get_aggregates.__doc__ = aggregates.__doc__
