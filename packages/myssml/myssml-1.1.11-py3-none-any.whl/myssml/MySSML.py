...
class MySSML:
    ...
    VALID_VOICE_NAMES = ['zh-CN-XiaoxuanNeural', 'zh-CN-XiaochenNeural', 'zh-CN-XiaoxiaoNeural', 'zh-CN-XiaohanNeural', 'zh-CN-XiaozhenNeural', 'zh-CN-YunjianNeural', 'zh-CN-XiaoyanNeural', 'zh-CN-XiaoyiNeural', 'zh-CN-YunhaoNeural', 'zh-CN-XiaoshuangNeural', 'zh-CN-XiaomengNeural', 'zh-CN-YunfengNeural', 'zh-CN-YunzeNeural', 'zh-CN-XiaoqiuNeural', 'zh-CN-YunyeNeural', 'zh-CN-XiaoruiNeural', 'zh-CN-YunxiNeural', 'zh-CN-XiaoyouNeural', 'zh-CN-YunxiaNeural', 'zh-CN-YunyangNeural', 'zh-CN-XiaomoNeural']

    VALID_VOICE_NAMES_CN = {'晓萱': 'zh-CN-XiaoxuanNeural', '晓辰': 'zh-CN-XiaochenNeural', '晓晓': 'zh-CN-XiaoxiaoNeural', '晓涵': 'zh-CN-XiaohanNeural', '晓甄': 'zh-CN-XiaozhenNeural', '云健': 'zh-CN-YunjianNeural', '晓颜': 'zh-CN-XiaoyanNeural', '晓伊': 'zh-CN-XiaoyiNeural', '云皓': 'zh-CN-YunhaoNeural', '晓双': 'zh-CN-XiaoshuangNeural', '晓梦': 'zh-CN-XiaomengNeural', '云枫': 'zh-CN-YunfengNeural', '云泽': 'zh-CN-YunzeNeural', '晓秋': 'zh-CN-XiaoqiuNeural', '云野': 'zh-CN-YunyeNeural', '晓睿': 'zh-CN-XiaoruiNeural', '云希': 'zh-CN-YunxiNeural', '晓悠': 'zh-CN-XiaoyouNeural', '云夏': 'zh-CN-YunxiaNeural', '云扬': 'zh-CN-YunyangNeural', '晓墨': 'zh-CN-XiaomoNeural'}

    VALID_VOICE_NAMES_MAP = {'zh-CN-XiaoxuanNeural': ['general', 'calm', 'fearful', 'cheerful', 'disgruntled', 'serious', 'angry', 'gentle', 'depressed', 'Default'], 'zh-CN-XiaochenNeural': ['general', ''], 'zh-CN-XiaoxiaoNeural': ['general', 'assistant', 'chat', 'customerservice', 'newscast', 'affectionate', 'angry', 'calm', 'cheerful', 'disgruntled', 'fearful', 'gentle', 'lyrical', 'sad', 'serious', 'poetry-reading', 'Default'], 'zh-CN-XiaohanNeural': ['general', 'calm', 'fearful', 'cheerful', 'disgruntled', 'serious', 'angry', 'sad', 'gentle', 'affectionate', 'embarrassed', 'Default'], 'zh-CN-XiaozhenNeural': ['general', 'angry', 'disgruntled', 'cheerful', 'fearful', 'sad', 'serious', 'Default'], 'zh-CN-YunjianNeural': ['general', 'Narration-relaxed', 'Sports_commentary', 'Sports_commentary_excited', 'Default'], 'zh-CN-XiaoyanNeural': ['general', ''], 'zh-CN-XiaoyiNeural': ['general', 'angry', 'disgruntled', 'affectionate', 'cheerful', 'fearful', 'sad', 'embarrassed', 'serious', 'gentle', 'Default'], 'zh-CN-YunhaoNeural': ['general', 'Advertisement_upbeat', 'Default'], 'zh-CN-XiaoshuangNeural': ['general', 'chat', 'Default'], 'zh-CN-XiaomengNeural': ['general', 'chat', 'Default'], 'zh-CN-YunfengNeural': ['general', 'angry', 'disgruntled', 'cheerful', 'fearful', 'sad', 'serious', 'depressed', 'Default'], 'zh-CN-YunzeNeural': ['general', 'calm', 'fearful', 'cheerful', 'disgruntled', 'serious', 'angry', 'sad', 'depressed', 'documentary-narration', 'Default'], 'zh-CN-XiaoqiuNeural': ['general', ''], 'zh-CN-YunyeNeural': ['general', 'embarrassed', 'calm', 'fearful', 'cheerful', 'disgruntled', 'serious', 'angry', 'sad', 'Default'], 'zh-CN-XiaoruiNeural': ['general', 'calm', 'fearful', 'angry', 'sad', 'Default'], 'zh-CN-YunxiNeural': ['general', 'narration-relaxed', 'embarrassed', 'fearful', 'cheerful', 'disgruntled', 'serious', 'angry', 'sad', 'depressed', 'chat', 'assistant', 'newscast', 'Default'], 'zh-CN-XiaoyouNeural': ['general', ''], 'zh-CN-YunxiaNeural': ['general', 'calm', 'fearful', 'cheerful', 'angry', 'sad', 'Default'], 'zh-CN-YunyangNeural': ['general', 'customerservice', 'narration-professional', 'newscast-casual', 'Default'], 'zh-CN-XiaomoNeural': ['general', 'embarrassed', 'calm', 'fearful', 'cheerful', 'disgruntled', 'serious', 'angry', 'sad', 'depressed', 'affectionate', 'gentle', 'envious', 'Default']}
