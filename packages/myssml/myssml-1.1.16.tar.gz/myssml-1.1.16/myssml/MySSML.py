...
class MySSML:
    ...
    VALID_VOICE_NAMES_MAP = {'zh-CN-XiaoxuanNeural': {'LocalName': '晓萱', 'VoiceStyleNames': ['general', 'calm', 'fearful', 'cheerful', 'disgruntled', 'serious', 'angry', 'gentle', 'depressed', 'Default']}, 'zh-CN-XiaochenNeural': {'LocalName': '晓辰', 'VoiceStyleNames': ['general', '']}, 'zh-CN-XiaoxiaoNeural': {'LocalName': '晓晓', 'VoiceStyleNames': ['general', 'assistant', 'chat', 'customerservice', 'newscast', 'affectionate', 'angry', 'calm', 'cheerful', 'disgruntled', 'fearful', 'gentle', 'lyrical', 'sad', 'serious', 'poetry-reading', 'Default']}, 'zh-CN-XiaohanNeural': {'LocalName': '晓涵', 'VoiceStyleNames': ['general', 'calm', 'fearful', 'cheerful', 'disgruntled', 'serious', 'angry', 'sad', 'gentle', 'affectionate', 'embarrassed', 'Default']}, 'zh-CN-XiaoyanNeural': {'LocalName': '晓颜', 'VoiceStyleNames': ['general', '']}, 'zh-CN-XiaoshuangNeural': {'LocalName': '晓双', 'VoiceStyleNames': ['general', 'chat', 'Default']}, 'zh-CN-XiaoqiuNeural': {'LocalName': '晓秋', 'VoiceStyleNames': ['general', '']}, 'zh-CN-YunyeNeural': {'LocalName': '云野', 'VoiceStyleNames': ['general', 'embarrassed', 'calm', 'fearful', 'cheerful', 'disgruntled', 'serious', 'angry', 'sad', 'Default']}, 'zh-CN-XiaoruiNeural': {'LocalName': '晓睿', 'VoiceStyleNames': ['general', 'calm', 'fearful', 'angry', 'sad', 'Default']}, 'zh-CN-YunxiNeural': {'LocalName': '云希', 'VoiceStyleNames': ['general', 'narration-relaxed', 'embarrassed', 'fearful', 'cheerful', 'disgruntled', 'serious', 'angry', 'sad', 'depressed', 'chat', 'assistant', 'newscast', 'Default']}, 'zh-CN-XiaoyouNeural': {'LocalName': '晓悠', 'VoiceStyleNames': ['general', '']}, 'zh-CN-YunyangNeural': {'LocalName': '云扬', 'VoiceStyleNames': ['general', 'customerservice', 'narration-professional', 'newscast-casual', 'Default']}, 'zh-CN-XiaomoNeural': {'LocalName': '晓墨', 'VoiceStyleNames': ['general', 'embarrassed', 'calm', 'fearful', 'cheerful', 'disgruntled', 'serious', 'angry', 'sad', 'depressed', 'affectionate', 'gentle', 'envious', 'Default']}}
    ...
    def get_objIdPid(self,objType):
        ...
        elif objType == "EXPRESS_AS":
            objPType = ["P","S","VOICE"]

        elif objType == "S":
            objPType = ["P","PROSODY","VOICE", "EXPRESS_AS"]

        elif objType == "P":
            objPType = ["VOICE","PROSODY", "EXPRESS_AS"]
