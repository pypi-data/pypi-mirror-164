...
class LambdaToSsmstringparameter(
    ...
    def __init__(
        ...
        *,
        ...
        string_parameter_props: typing.Optional[typing.Union[aws_cdk.aws_ssm.StringParameterProps, typing.Dict[str, typing.Any]]] = None,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(LambdaToSsmstringparameter.__init__)
    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(string_parameter_props, dict):
            string_parameter_props = StringParameterProps(**string_parameter_props)
        if isinstance(vpc_props, dict):
            vpc_props = VpcProps(**vpc_props)
        if __debug__:
            type_hints = typing.get_type_hints(LambdaToSsmstringparameterProps.__init__)
