...
class Client:
    ...
    def request_new_permissions(self, name: str, permissions: abc.Iterable[T.Union[int, Permission]]) -> str:
    ...
    def delete_files(
        ...
        file_service_name: T.Optional[str] = None,
    ...
    def add_tags(
        ...
        hashes: T.Optional[abc.Iterable[str]] = None,
        file_ids: T.Optional[abc.Iterable[int]] = None,
        service_names_to_tags: T.Optional[T.Mapping[str, abc.Iterable[str]]] = None,
        service_keys_to_tags: T.Optional[T.Mapping[str, abc.Iterable[str]]] = None,
        service_names_to_actions_to_tags: T.Optional[
            T.Mapping[str, T.Mapping[T.Union[int, TagAction], abc.Iterable[str]]]
        ] = None,
    ...
    def get_url_files(self, url: str) -> dict[str, T.Any]:
    ...
    def add_url(
        ...
        service_names_to_additional_tags: T.Optional[T.Mapping[str, abc.Iterable[str]]] = None,
        service_keys_to_additional_tags: T.Optional[T.Mapping[str, abc.Iterable[str]]] = None,
    ...
    def set_notes(self, notes: dict[str, str], hash_: T.Optional[str] = None, file_id: T.Optional[int] = None) -> None:
    ...
    def get_cookies(self, domain: str) -> list[list[T.Union[str, int]]]:
    ...
    def search_files(
        self,
        tags: abc.Iterable[T.Union[str, abc.Iterable[str]]],
        file_service_name: T.Optional[str] = None,
        file_service_key: T.Optional[str] = None,
        tag_service_name: T.Optional[str] = None,
        tag_service_key: T.Optional[str] = None,
    ...
    def get_file_metadata(
        ...
        hide_service_name_tags: T.Optional[bool] = None,
    ...
    def get_page_list(self) -> list[dict[str, T.Any]]:
