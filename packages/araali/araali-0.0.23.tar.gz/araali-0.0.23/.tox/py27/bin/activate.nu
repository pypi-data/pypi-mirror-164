...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/abhishek/opensrc/araalinetworks/api/python/api/.tox/py27'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/abhishek/opensrc/araalinetworks/api/python/api/.tox/py27/bin/deactivate.nu'
