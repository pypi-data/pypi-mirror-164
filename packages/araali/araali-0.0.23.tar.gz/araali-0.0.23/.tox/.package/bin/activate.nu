...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/abhishek/opensrc/araalinetworks/api/python/api/.tox/.package'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/abhishek/opensrc/araalinetworks/api/python/api/.tox/.package/bin/deactivate.nu'
