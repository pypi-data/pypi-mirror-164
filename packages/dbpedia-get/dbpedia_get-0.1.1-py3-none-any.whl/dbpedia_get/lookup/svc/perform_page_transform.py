...
from dbpedia.lookup.dmo import SpacyDocSegmenter
from dbpedia.lookup.dmo import DBPediaContentNormalizer
...
class PerformPageTransform(BaseObject):
    ...
    def __init__(self,
        ...
        self._normalize_page = DBPediaContentNormalizer(
            segmenter=SpacyDocSegmenter().process).process
