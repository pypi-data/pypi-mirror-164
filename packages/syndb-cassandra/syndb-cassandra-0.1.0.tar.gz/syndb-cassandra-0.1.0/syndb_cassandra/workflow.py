...
@validate_arguments
def add_owner(owner_id: UUID, settings: Optional[SyndbCassandraSettings] = None) -> None:
    assert _get_connection(settings).execute(f"INSERT INTO {SYNDB_OWNER_TABLE} (cid) VALUES ({owner_id}) IF NOT EXISTS")
