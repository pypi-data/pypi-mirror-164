...
class BaseSyndbCassandraSettings(BaseSettings):
    ...
    def cassandra_connection(self):
        ...
        connection.register_connection(self.cassandra_connection_name, session=current_connection)
...
def get_settings(
    ...
    return SyndbCassandraProductionSettings if os.environ.get("IN_PRODUCTION", False) else SyndbCassandraTestSettings
