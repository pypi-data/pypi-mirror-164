...
class ApiClient(object):
    ...
    Args:
        ...
        sch_api_token (:obj:`str`, optional): SCH API credential token. Default: ``None``
    ...
    def __init__(self,
        ...
        if not authentication_token and not (sch_auth_token and sch_credential_id):
            raise Exception('Invalid authentication options provided. Either (sch_api_token and sch_api_credential_id)'
