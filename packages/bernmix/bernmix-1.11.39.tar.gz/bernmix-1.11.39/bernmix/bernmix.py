...
def pmf_int_joint(probs, wights_vec):
    """
    Joint distribution of several sums of BRVs
    :param probs: probabilities of BRVs in sums
    :param wights_vec: vectors of weights
    :return:
    """
    bm_new.pmf_joint(probs, wights_vec)
#
