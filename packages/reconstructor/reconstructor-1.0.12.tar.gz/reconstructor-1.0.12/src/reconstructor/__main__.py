...
if test == 'yes':
    if os.path.exists(script_path+'/testfiles') == False:
        ...
        url = "https://github.com/emmamglass/reconstructor/blob/master/testfiles/488.146.fa"
        wget.download(url, out = script_path+'/testfiles')

        url = "https://github.com/emmamglass/reconstructor/blob/master/testfiles/488.146a.KEGGprot.out"
        wget.download(url, out = script_path+'/testfiles')

        url = "https://github.com/emmamglass/reconstructor/blob/master/testfiles/fmt.metaG.01044A.bin.149.KEGGprot.sbml"
        wget.download(url, out = script_path+'/testfiles')
    ...
    cmd_line = "python -m reconstructor --input " + script_path+"/testfiles/488.146a.KEGGprot.out --type 2 --gram negative"
    os.system(cmd_line)
