...
if os.path.exists(script_path+'/testfiles') == False:
    ...
    url = "https://github.com/emmamglass/reconstructor/testfiles/488.146.fa"
    wget.download(url, out = script_path+'/testfiles')

    url = "https://github.com/emmamglass/reconstructor/testfiles/JCP8151B.KEGGprot.out"
    wget.download(url, out = script_path+'/testfiles')

    url = "https://github.com/emmamglass/reconstructor/testfiles/fmt.metaG.01044A.bin.149.KEGGprot.sbml"
    wget.download(url, out = script_path+'/testfiles')
