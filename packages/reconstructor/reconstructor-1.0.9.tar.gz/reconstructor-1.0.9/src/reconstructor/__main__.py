...
if os.path.exists(script_path+'/refs') == False:
    ...
    shutil.move(script_path+'/biomass.sbml', script_path+'/refs/biomass.sbml')
    shutil.move(script_path+'/compounds.json', script_path+'/refs/compounds.json')
    shutil.move(script_path+'/gene_modelseed.pickle', script_path+'/gene_modelseed.pickle')
    shutil.move(script_path+'/gene_names.pickle', script_path+'/gene_names.pickle')
    shutil.move(script_path+'/reactions.json', script_path+'/refs/reactions.json')
    shutil.move(script_path+'/screened_kegg_prokaryotes_pep_db.dmnd', script_path+'/refs/screened_kegg_prokaryotes_pep_db.dmnd')
    shutil.move(script_path+'/universal.pickle', script_path+'/refs/universal.pickle')
