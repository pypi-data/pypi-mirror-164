...
if os.path.exists(script_path+'/refs') == False:
    ...
    shutil.move(script_path+'/biomass.sbml', script_path+'/refs')
    shutil.move(script_path+'/compounds.json', script_path+'/refs')
    shutil.move(script_path+'/gene_modelseed.pickle', script_path+'/refs')
    shutil.move(script_path+'/gene_names.pickle', script_path+'/refs')
    shutil.move(script_path+'/reactions.json', script_path+'/refs')
    shutil.move(script_path+'/screened_kegg_prokaryotes_pep_db.dmnd', script_path+'/refs')
    shutil.move(script_path+'/universal.pickle', script_path+'/refs')
