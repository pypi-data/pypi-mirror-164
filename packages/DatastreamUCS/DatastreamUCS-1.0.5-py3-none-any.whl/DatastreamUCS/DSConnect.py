...
#--------------- Constructor ----------------------------------------------------------------------------------------  
    def __init__(self, config = None, username = None, password = None, proxies = None, sslCer = None):
        ...
        self._buildVer = '1.0.5'
        self._timeout = 300
        self._appID = 'DatastreamUCIPy-' + self._buildVer
        self._reqSession.headers['User-Agent'] = self._reqSession.headers['User-Agent'] + ' DatastreamUCIPy/' + self._buildVer
