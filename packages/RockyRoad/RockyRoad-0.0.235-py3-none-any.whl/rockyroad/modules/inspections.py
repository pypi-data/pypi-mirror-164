...
class Inspections(Consumer):
    ...
    class __Reports(Consumer):
        ...
        def addFile(self, uid: Query(type=str), directory: Query(type=str), file: Part):
            """This call will create an inspection report with the specified parameters."""
        ...
        def downloadFile(
            self,
            uid: Query(type=str),
            filename: Query(type=str), directory: Query(type=str),
        ):
        ...
        def listFiles(
            self,
            uid: Query(type=str), directory: Query(type=str),
        ):
