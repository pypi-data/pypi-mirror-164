...
class SynchronizationFinalizationRequest(object):
    ...
    def __init__(self, send_notification=None, batch_size=1000, simulation=None, save_result=None, synchronization_id=None, finalization_strategy=None, finalization_parameters=None, local_vars_configuration=None):  # noqa: E501
    ...
    def save_result(self):
        ...
        Whether the import Result should be persisted or forgotten. <b>The default value</b> is <code>false</code>.<p>If <code>true</code>, the result of the import simulation will be available at the end of the job but no change will be applied to the DGC.  # noqa: E501
    ...
    def finalization_strategy(self, finalization_strategy):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                finalization_strategy is not None and not re.search(r'REMOVE_RESOURCES|CHANGE_STATUS', finalization_strategy)):  # noqa: E501
            raise ValueError(r"Invalid value for `finalization_strategy`, must be a follow pattern or equal to `/REMOVE_RESOURCES|CHANGE_STATUS/`")  # noqa: E501
    ...
    def finalization_parameters(self):
        ...
        If you have set `finalizationStrategy` to `CHANGE_STATUS`, the status ID for the resources that no longer exist in the external system.<p><b>NOTE:</b> This parameter must be declared with an 'application/json' content type.  # noqa: E501
