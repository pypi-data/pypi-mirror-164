...
class CommunityImportCommand(object):
    ...
    def __init__(self, identifier=None, indexes=None, name=None, description=None, language=None, parent=None, resource_type=None, local_vars_configuration=None):  # noqa: E501
