...
"""
    ...
    The Import API is an efficient way to load large volumes of data into the Collibra Data Governance Center. The API can automatically differentiate between creating and updating data.  # noqa: E501
...
from collibra_importer.exceptions import (
    ApiTypeError,
    ApiValueError
)
...
class ImportApi(object):
    ...
    def import_csv_in_job(self, separator, quote, escape, template, **kwargs):  # noqa: E501
        ...
        :param bool save_result: Whether the import Result should be persisted or forgotten. <b>The default value</b> is <code>false</code>.<p>If <code>true</code>, the result of the import simulation will be available at the end of the job but no change will be applied to the DGC.
    ...
    def import_csv_in_job_with_http_info(self, separator, quote, escape, template, **kwargs):  # noqa: E501
        ...
        all_params = ['separator', 'quote', 'escape', 'template', 'send_notification', 'batch_size', 'simulation', 'save_result', 'file_id', 'file', 'file_name', 'delete_file', 'strict_quotes', 'ignore_leading_whitespace', 'header_row']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def import_excel_in_job_with_http_info(self, template, **kwargs):  # noqa: E501
        ...
        all_params = ['template', 'send_notification', 'batch_size', 'simulation', 'save_result', 'file_id', 'file', 'file_name', 'delete_file', 'sheet_name', 'sheet_index', 'header_row']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def import_json_in_job_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['send_notification', 'batch_size', 'simulation', 'save_result', 'file_id', 'file', 'file_name', 'delete_file']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def synchronize_batch_csv_in_job_with_http_info(self, synchronization_id, separator, quote, escape, template, **kwargs):  # noqa: E501
        ...
        all_params = ['synchronization_id', 'separator', 'quote', 'escape', 'template', 'send_notification', 'batch_size', 'simulation', 'save_result', 'file_id', 'file', 'file_name', 'delete_file', 'strict_quotes', 'ignore_leading_whitespace', 'header_row']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def synchronize_batch_excel_in_job_with_http_info(self, synchronization_id, template, **kwargs):  # noqa: E501
        ...
        all_params = ['synchronization_id', 'template', 'send_notification', 'batch_size', 'simulation', 'save_result', 'file_id', 'file', 'file_name', 'delete_file', 'sheet_name', 'sheet_index', 'header_row']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def synchronize_batch_json_in_job_with_http_info(self, synchronization_id, **kwargs):  # noqa: E501
        ...
        all_params = ['synchronization_id', 'send_notification', 'batch_size', 'simulation', 'save_result', 'file_id', 'file', 'file_name', 'delete_file']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def synchronize_finalize_in_job_with_http_info(self, synchronization_id, **kwargs):  # noqa: E501
        ...
        all_params = ['synchronization_id', 'send_notification', 'batch_size', 'simulation', 'save_result', 'finalization_strategy']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and 'finalization_strategy' in local_var_params and not re.search(r'REMOVE_RESOURCES|CHANGE_STATUS', local_var_params['finalization_strategy']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `finalization_strategy` when calling `synchronize_finalize_in_job`, must conform to the pattern `/REMOVE_RESOURCES|CHANGE_STATUS/`")  # noqa: E501
        collection_formats = {}
