...
class InlineObject9(object):
    ...
    def __init__(self, send_notification=False, batch_size=1000, simulation=False, save_result=False, file_id=None, file=None, file_name='synchronization_file', delete_file=False, local_vars_configuration=None):  # noqa: E501
