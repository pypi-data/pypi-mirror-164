...
class InlineObject4(object):
    ...
    def __init__(self, send_notification=False, batch_size=1000, simulation=False, save_result=False, file_id=None, file=None, file_name='synchronization_file', delete_file=False, sheet_name=None, sheet_index=None, header_row=None, template=None, local_vars_configuration=None):  # noqa: E501
