...
def upload_list_convert_list(upload_list_path):
    ...
    if not os.path.exists(upload_list_path):
        raise RayvisionError(1000006, "{} is not exist".format(upload_list_path))
    else:
        file_list = []
        ...
        tmp_upload_path = os.path.join(os.path.dirname(upload_list_path),"tmp_upload.json")
...
# s = upload_list_convert_list(r"F:\Project\SDK\abc.txt")
# print(s)