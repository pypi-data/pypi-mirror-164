...
from rayvision_sync.rayvision_raysync.utils import upload_list_convert_list
...
class RayvisionUpload(object):
    ...
    def __init__(self, api,
        ...
        self.raysync_engine = RayvisionTransferRaysync(self.trans.user_id, self.api.user_info.get("user_name"),
    ...
    def upload_asset(self, upload_json_path, max_speed=None, is_db=True,
        ...
        Args:
            ...
            engine_type (str): Transport engine type, supports "aspera" and "raysyncweb".
        ...
        if engine_type == "aspera":
            ...
            if transmit_type == "upload_list":
                upload_list, upload_json_path = upload_list_convert_list(upload_json_path)
                append_to_upload(upload_list, upload_json_path)
            paramDict = {
                "server_ip": server_ip if server_ip else self.trans.transport_info[engine_type]['server_ip'],
                "server_port": server_port if server_port else self.trans.transport_info[engine_type]['server_port'],
