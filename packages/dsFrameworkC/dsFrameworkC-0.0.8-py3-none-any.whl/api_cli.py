...
def create_folders(project_name):
    ...
    create_main_folders('examples', 'pl_wrapper')
...
def create_project(project_name):
    ...
    create_trainer_file(project_name, directories['pl_wrapper'], 'trainer', False, from_folder='pl_wrapper')
    create_trainer_file(project_name, directories['examples'], 'example1_mnist', False,
                        from_folder=os.path.join('pl_wrapper', 'examples'))
    create_trainer_file(project_name, directories['examples'], 'example2_wine_quality', False,
                        from_folder=os.path.join('pl_wrapper', 'examples'))
    ...
    create_trainer_file(project_name, directories['trainer'], 'trainer_main', False)
