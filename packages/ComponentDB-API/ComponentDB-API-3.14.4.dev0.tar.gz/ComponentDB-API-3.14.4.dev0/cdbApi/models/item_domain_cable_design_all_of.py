...
class ItemDomainCableDesignAllOf(object):
    ...
    def __init__(self, inventory_item=None, technical_system_list=None, alternate_name=None, assigned_item=None, is_housed=None, catalog_item=None, local_vars_configuration=None):  # noqa: E501
