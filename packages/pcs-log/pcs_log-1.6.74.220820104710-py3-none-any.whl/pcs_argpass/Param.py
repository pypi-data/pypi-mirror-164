...
from typing import Dict, Union  # ,  List, Set, Tuple, Optional
...
__updated__ = '112.220820104701'
Version = f"1.10.{__updated__}"
...
#---------------------------------------------
        ...
        self.__HelpList:list = []           # List of all parameters with type 'H'
        self.__ImportList:list = []         # List of all parameters with type 'x'
        self.__ExportList:list = []         # List of all parameters with type 'X'
        self.__Glob_ImportList:list = []    # List of all parameters with type '<'
        self.__Glob_ExportList:list = []    # List of all parameters with type '>'
