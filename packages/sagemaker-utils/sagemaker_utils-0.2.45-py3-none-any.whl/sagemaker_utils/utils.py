...
def download(s3_path: str, local_path:str, show_progress=True, session = default_session) -> None:
    '''
    ...
    try:
        ...
        if show_progress:
            object_size = s3.head_object(Bucket=params['Bucket'], Key=params['Key'])["ContentLength"]            
...
def read_file(s3_path: str, session = default_session)->Union[dict, pd.core.frame.DataFrame, Any]:
    '''
