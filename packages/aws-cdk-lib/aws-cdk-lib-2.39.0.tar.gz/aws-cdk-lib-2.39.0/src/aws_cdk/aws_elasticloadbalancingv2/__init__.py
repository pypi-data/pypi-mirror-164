...
class AddNetworkActionProps:
    def __init__(self, *, action: "NetworkListenerAction") -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AddNetworkActionProps.__init__)
...
class AddNetworkTargetsProps:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(AddNetworkTargetsProps.__init__)
...
class AddRuleProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AddRuleProps.__init__)
...
class ApplicationListenerAttributes:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ApplicationListenerAttributes.__init__)
...
class ApplicationListenerCertificate(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ApplicationListenerCertificate.__init__)
...
class ApplicationListenerCertificateProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ApplicationListenerCertificateProps.__init__)
...
class ApplicationListenerRule(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ApplicationListenerRule.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def add_condition(self, condition: "ListenerCondition") -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ApplicationListenerRule.add_condition)
    ...
    def configure_action(self, action: "ListenerAction") -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ApplicationListenerRule.configure_action)
            check_type(argname="argument action", value=action, expected_type=type_hints["action"])
...
class ApplicationLoadBalancerAttributes:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ApplicationLoadBalancerAttributes.__init__)
...
class ApplicationLoadBalancerRedirectConfig:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ApplicationLoadBalancerRedirectConfig.__init__)
...
class AuthenticateOidcOptions:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AuthenticateOidcOptions.__init__)
...
class BaseApplicationListenerProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(BaseApplicationListenerProps.__init__)
            check_type(argname="argument certificates", value=certificates, expected_type=type_hints["certificates"])
...
class BaseApplicationListenerRuleProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(BaseApplicationListenerRuleProps.__init__)
            check_type(argname="argument priority", value=priority, expected_type=type_hints["priority"])
            check_type(argname="argument action", value=action, expected_type=type_hints["action"])
            check_type(argname="argument conditions", value=conditions, expected_type=type_hints["conditions"])
...
class BaseListener(
    ...
    def __init__(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(BaseListener.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
...
class BaseListenerLookupOptions:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(BaseListenerLookupOptions.__init__)
...
class BaseLoadBalancer(
    ...
    def __init__(
        ...
        scope: constructs.Construct,
        id: builtins.str,
        base_props: typing.Union["BaseLoadBalancerProps", typing.Dict[str, typing.Any]],
        additional_props: typing.Any,
    ) -> None:
        '''
        :param scope: -
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(BaseLoadBalancer.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def log_access_logs(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(BaseLoadBalancer.log_access_logs)
    ...
    def remove_attribute(self, key: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(BaseLoadBalancer.remove_attribute)
    ...
    def set_attribute(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(BaseLoadBalancer.set_attribute)
            check_type(argname="argument key", value=key, expected_type=type_hints["key"])
...
class BaseLoadBalancerLookupOptions:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(BaseLoadBalancerLookupOptions.__init__)
            check_type(argname="argument load_balancer_arn", value=load_balancer_arn, expected_type=type_hints["load_balancer_arn"])
            check_type(argname="argument load_balancer_tags", value=load_balancer_tags, expected_type=type_hints["load_balancer_tags"])
        self._values: typing.Dict[str, typing.Any] = {}
        if load_balancer_arn is not None:
...
class BaseLoadBalancerProps:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(BaseLoadBalancerProps.__init__)
            check_type(argname="argument vpc", value=vpc, expected_type=type_hints["vpc"])
...
class BaseNetworkListenerProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(BaseNetworkListenerProps.__init__)
            check_type(argname="argument port", value=port, expected_type=type_hints["port"])
    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(health_check, dict):
            health_check = HealthCheck(**health_check)
        if __debug__:
            type_hints = typing.get_type_hints(BaseTargetGroupProps.__init__)
            check_type(argname="argument deregistration_delay", value=deregistration_delay, expected_type=type_hints["deregistration_delay"])
            check_type(argname="argument health_check", value=health_check, expected_type=type_hints["health_check"])
            check_type(argname="argument target_group_name", value=target_group_name, expected_type=type_hints["target_group_name"])
...
class CfnListener(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        default_actions: typing.Union[_IResolvable_da3f097b, typing.Sequence[typing.Union[typing.Union["CfnListener.ActionProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]]],
        load_balancer_arn: builtins.str,
        alpn_policy: typing.Optional[typing.Sequence[builtins.str]] = None,
        certificates: typing.Optional[typing.Union[_IResolvable_da3f097b, typing.Sequence[typing.Union[typing.Union["CfnListener.CertificateProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]]]] = None,
        port: typing.Optional[jsii.Number] = None,
    ...
    def default_actions(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnListener, "default_actions").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def load_balancer_arn(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnListener, "load_balancer_arn").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def alpn_policy(self, value: typing.Optional[typing.List[builtins.str]]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnListener, "alpn_policy").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def certificates(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnListener, "certificates").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def port(self, value: typing.Optional[jsii.Number]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnListener, "port").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def ssl_policy(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnListener, "ssl_policy").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    class ActionProperty:
        def __init__(
            ...
            *,
            type: builtins.str,
            authenticate_cognito_config: typing.Optional[typing.Union[typing.Union["CfnListener.AuthenticateCognitoConfigProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]] = None,
            authenticate_oidc_config: typing.Optional[typing.Union[typing.Union["CfnListener.AuthenticateOidcConfigProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]] = None,
            fixed_response_config: typing.Optional[typing.Union[typing.Union["CfnListener.FixedResponseConfigProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]] = None,
            forward_config: typing.Optional[typing.Union[typing.Union["CfnListener.ForwardConfigProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]] = None,
            order: typing.Optional[jsii.Number] = None,
            redirect_config: typing.Optional[typing.Union[typing.Union["CfnListener.RedirectConfigProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]] = None,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnListener.ActionProperty.__init__)
    ...
    class AuthenticateCognitoConfigProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnListener.AuthenticateCognitoConfigProperty.__init__)
    ...
    class AuthenticateOidcConfigProperty:
        def __init__(
            ...
            *,
            ...
            :param session_cookie_name: The name of the cookie used to maintain session information. The default is AWSELBAuthSessionCookie.
            :param session_timeout: The maximum duration of the authentication session, in seconds. The default is 604800 seconds (7 days).
            :param use_existing_client_secret: ``CfnListener.AuthenticateOidcConfigProperty.UseExistingClientSecret``.
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnListener.AuthenticateOidcConfigProperty.__init__)
                check_type(argname="argument authorization_endpoint", value=authorization_endpoint, expected_type=type_hints["authorization_endpoint"])
                check_type(argname="argument client_id", value=client_id, expected_type=type_hints["client_id"])
                check_type(argname="argument issuer", value=issuer, expected_type=type_hints["issuer"])
                check_type(argname="argument token_endpoint", value=token_endpoint, expected_type=type_hints["token_endpoint"])
    ...
    class CertificateProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnListener.CertificateProperty.__init__)
    ...
    class FixedResponseConfigProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnListener.FixedResponseConfigProperty.__init__)
    ...
    class ForwardConfigProperty:
        def __init__(
            self,
            *,
            target_groups: typing.Optional[typing.Union[_IResolvable_da3f097b, typing.Sequence[typing.Union[typing.Union["CfnListener.TargetGroupTupleProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]]]] = None,
            target_group_stickiness_config: typing.Optional[typing.Union[typing.Union["CfnListener.TargetGroupStickinessConfigProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]] = None,
        ) -> None:
            '''Information for creating an action that distributes requests among one or more target groups.
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnListener.ForwardConfigProperty.__init__)
                check_type(argname="argument target_groups", value=target_groups, expected_type=type_hints["target_groups"])
    ...
    class RedirectConfigProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnListener.RedirectConfigProperty.__init__)
                check_type(argname="argument status_code", value=status_code, expected_type=type_hints["status_code"])
    ...
    class TargetGroupStickinessConfigProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnListener.TargetGroupStickinessConfigProperty.__init__)
    ...
    class TargetGroupTupleProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnListener.TargetGroupTupleProperty.__init__)
                check_type(argname="argument target_group_arn", value=target_group_arn, expected_type=type_hints["target_group_arn"])
...
class CfnListenerCertificate(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        certificates: typing.Union[_IResolvable_da3f097b, typing.Sequence[typing.Union[typing.Union["CfnListenerCertificate.CertificateProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]]],
        listener_arn: builtins.str,
    ) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnListenerCertificate.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def inspect(self, inspector: _TreeInspector_488e0dd5) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnListenerCertificate.inspect)
            check_type(argname="argument inspector", value=inspector, expected_type=type_hints["inspector"])
        return typing.cast(None, jsii.invoke(self, "inspect", [inspector]))
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnListenerCertificate._render_properties)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    def certificates(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnListenerCertificate, "certificates").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "certificates", value)
    ...
    def listener_arn(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnListenerCertificate, "listener_arn").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    class CertificateProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnListenerCertificate.CertificateProperty.__init__)
                check_type(argname="argument certificate_arn", value=certificate_arn, expected_type=type_hints["certificate_arn"])
            self._values: typing.Dict[str, typing.Any] = {}
            if certificate_arn is not None:
                self._values["certificate_arn"] = certificate_arn
...
class CfnListenerCertificateProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnListenerCertificateProps.__init__)
            check_type(argname="argument certificates", value=certificates, expected_type=type_hints["certificates"])
            check_type(argname="argument listener_arn", value=listener_arn, expected_type=type_hints["listener_arn"])
        self._values: typing.Dict[str, typing.Any] = {
            "certificates": certificates,
...
class CfnListenerRule(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        actions: typing.Union[_IResolvable_da3f097b, typing.Sequence[typing.Union[typing.Union["CfnListenerRule.ActionProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]]],
        conditions: typing.Union[_IResolvable_da3f097b, typing.Sequence[typing.Union[typing.Union["CfnListenerRule.RuleConditionProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]]],
        listener_arn: builtins.str,
        priority: jsii.Number,
    ) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnListenerRule.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def inspect(self, inspector: _TreeInspector_488e0dd5) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnListenerRule.inspect)
            check_type(argname="argument inspector", value=inspector, expected_type=type_hints["inspector"])
        return typing.cast(None, jsii.invoke(self, "inspect", [inspector]))
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnListenerRule._render_properties)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    def actions(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnListenerRule, "actions").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def conditions(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnListenerRule, "conditions").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def listener_arn(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnListenerRule, "listener_arn").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "listenerArn", value)
    ...
    def priority(self, value: jsii.Number) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnListenerRule, "priority").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    class ActionProperty:
        def __init__(
            ...
            *,
            type: builtins.str,
            authenticate_cognito_config: typing.Optional[typing.Union[typing.Union["CfnListenerRule.AuthenticateCognitoConfigProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]] = None,
            authenticate_oidc_config: typing.Optional[typing.Union[typing.Union["CfnListenerRule.AuthenticateOidcConfigProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]] = None,
            fixed_response_config: typing.Optional[typing.Union[typing.Union["CfnListenerRule.FixedResponseConfigProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]] = None,
            forward_config: typing.Optional[typing.Union[typing.Union["CfnListenerRule.ForwardConfigProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]] = None,
            order: typing.Optional[jsii.Number] = None,
            redirect_config: typing.Optional[typing.Union[typing.Union["CfnListenerRule.RedirectConfigProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]] = None,
            target_group_arn: typing.Optional[builtins.str] = None,
        ) -> None:
            '''Specifies an action for a listener rule.
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnListenerRule.ActionProperty.__init__)
                check_type(argname="argument type", value=type, expected_type=type_hints["type"])
                check_type(argname="argument authenticate_cognito_config", value=authenticate_cognito_config, expected_type=type_hints["authenticate_cognito_config"])
                check_type(argname="argument authenticate_oidc_config", value=authenticate_oidc_config, expected_type=type_hints["authenticate_oidc_config"])
                check_type(argname="argument fixed_response_config", value=fixed_response_config, expected_type=type_hints["fixed_response_config"])
    ...
    class AuthenticateCognitoConfigProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnListenerRule.AuthenticateCognitoConfigProperty.__init__)
                check_type(argname="argument user_pool_arn", value=user_pool_arn, expected_type=type_hints["user_pool_arn"])
                check_type(argname="argument user_pool_client_id", value=user_pool_client_id, expected_type=type_hints["user_pool_client_id"])
                check_type(argname="argument user_pool_domain", value=user_pool_domain, expected_type=type_hints["user_pool_domain"])
                check_type(argname="argument authentication_request_extra_params", value=authentication_request_extra_params, expected_type=type_hints["authentication_request_extra_params"])
    ...
    class AuthenticateOidcConfigProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnListenerRule.AuthenticateOidcConfigProperty.__init__)
                check_type(argname="argument authorization_endpoint", value=authorization_endpoint, expected_type=type_hints["authorization_endpoint"])
                check_type(argname="argument client_id", value=client_id, expected_type=type_hints["client_id"])
                check_type(argname="argument issuer", value=issuer, expected_type=type_hints["issuer"])
                check_type(argname="argument token_endpoint", value=token_endpoint, expected_type=type_hints["token_endpoint"])
    ...
    class FixedResponseConfigProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnListenerRule.FixedResponseConfigProperty.__init__)
                check_type(argname="argument status_code", value=status_code, expected_type=type_hints["status_code"])
                check_type(argname="argument content_type", value=content_type, expected_type=type_hints["content_type"])
                check_type(argname="argument message_body", value=message_body, expected_type=type_hints["message_body"])
            self._values: typing.Dict[str, typing.Any] = {
    ...
    class ForwardConfigProperty:
        def __init__(
            self,
            *,
            target_groups: typing.Optional[typing.Union[_IResolvable_da3f097b, typing.Sequence[typing.Union[typing.Union["CfnListenerRule.TargetGroupTupleProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]]]] = None,
            target_group_stickiness_config: typing.Optional[typing.Union[typing.Union["CfnListenerRule.TargetGroupStickinessConfigProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]] = None,
        ) -> None:
            '''Information for creating an action that distributes requests among one or more target groups.
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnListenerRule.ForwardConfigProperty.__init__)
                check_type(argname="argument target_groups", value=target_groups, expected_type=type_hints["target_groups"])
                check_type(argname="argument target_group_stickiness_config", value=target_group_stickiness_config, expected_type=type_hints["target_group_stickiness_config"])
            self._values: typing.Dict[str, typing.Any] = {}
            if target_groups is not None:
    ...
    class HostHeaderConfigProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnListenerRule.HostHeaderConfigProperty.__init__)
    ...
    class HttpHeaderConfigProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnListenerRule.HttpHeaderConfigProperty.__init__)
    ...
    class HttpRequestMethodConfigProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnListenerRule.HttpRequestMethodConfigProperty.__init__)
                check_type(argname="argument values", value=values, expected_type=type_hints["values"])
            self._values: typing.Dict[str, typing.Any] = {}
            if values is not None:
                self._values["values"] = values
    ...
    class PathPatternConfigProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnListenerRule.PathPatternConfigProperty.__init__)
                check_type(argname="argument values", value=values, expected_type=type_hints["values"])
            self._values: typing.Dict[str, typing.Any] = {}
            if values is not None:
                self._values["values"] = values
    ...
    class QueryStringConfigProperty:
        def __init__(
            self,
            *,
            values: typing.Optional[typing.Union[_IResolvable_da3f097b, typing.Sequence[typing.Union[typing.Union["CfnListenerRule.QueryStringKeyValueProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]]]] = None,
        ) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnListenerRule.QueryStringConfigProperty.__init__)
                check_type(argname="argument values", value=values, expected_type=type_hints["values"])
            self._values: typing.Dict[str, typing.Any] = {}
            if values is not None:
                self._values["values"] = values
    ...
    class QueryStringKeyValueProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnListenerRule.QueryStringKeyValueProperty.__init__)
                check_type(argname="argument key", value=key, expected_type=type_hints["key"])
                check_type(argname="argument value", value=value, expected_type=type_hints["value"])
            self._values: typing.Dict[str, typing.Any] = {}
            if key is not None:
    ...
    class RedirectConfigProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnListenerRule.RedirectConfigProperty.__init__)
                check_type(argname="argument status_code", value=status_code, expected_type=type_hints["status_code"])
                check_type(argname="argument host", value=host, expected_type=type_hints["host"])
                check_type(argname="argument path", value=path, expected_type=type_hints["path"])
                check_type(argname="argument port", value=port, expected_type=type_hints["port"])
    ...
    class RuleConditionProperty:
        def __init__(
            ...
            *,
            ...
            host_header_config: typing.Optional[typing.Union[typing.Union["CfnListenerRule.HostHeaderConfigProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]] = None,
            http_header_config: typing.Optional[typing.Union[typing.Union["CfnListenerRule.HttpHeaderConfigProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]] = None,
            http_request_method_config: typing.Optional[typing.Union[typing.Union["CfnListenerRule.HttpRequestMethodConfigProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]] = None,
            path_pattern_config: typing.Optional[typing.Union[typing.Union["CfnListenerRule.PathPatternConfigProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]] = None,
            query_string_config: typing.Optional[typing.Union[typing.Union["CfnListenerRule.QueryStringConfigProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]] = None,
            source_ip_config: typing.Optional[typing.Union[typing.Union["CfnListenerRule.SourceIpConfigProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]] = None,
            values: typing.Optional[typing.Sequence[builtins.str]] = None,
        ) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnListenerRule.RuleConditionProperty.__init__)
    ...
    class SourceIpConfigProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnListenerRule.SourceIpConfigProperty.__init__)
                check_type(argname="argument values", value=values, expected_type=type_hints["values"])
            self._values: typing.Dict[str, typing.Any] = {}
            if values is not None:
                self._values["values"] = values
    ...
    class TargetGroupStickinessConfigProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnListenerRule.TargetGroupStickinessConfigProperty.__init__)
                check_type(argname="argument duration_seconds", value=duration_seconds, expected_type=type_hints["duration_seconds"])
                check_type(argname="argument enabled", value=enabled, expected_type=type_hints["enabled"])
            self._values: typing.Dict[str, typing.Any] = {}
            if duration_seconds is not None:
    ...
    class TargetGroupTupleProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnListenerRule.TargetGroupTupleProperty.__init__)
                check_type(argname="argument target_group_arn", value=target_group_arn, expected_type=type_hints["target_group_arn"])
                check_type(argname="argument weight", value=weight, expected_type=type_hints["weight"])
            self._values: typing.Dict[str, typing.Any] = {}
            if target_group_arn is not None:
...
class CfnListenerRuleProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnListenerRuleProps.__init__)
...
class CfnLoadBalancer(
    ...
    def __init__(
        ...
        *,
        ...
        load_balancer_attributes: typing.Optional[typing.Union[_IResolvable_da3f097b, typing.Sequence[typing.Union[typing.Union["CfnLoadBalancer.LoadBalancerAttributeProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]]]] = None,
        name: typing.Optional[builtins.str] = None,
        scheme: typing.Optional[builtins.str] = None,
        security_groups: typing.Optional[typing.Sequence[builtins.str]] = None,
        subnet_mappings: typing.Optional[typing.Union[_IResolvable_da3f097b, typing.Sequence[typing.Union[typing.Union["CfnLoadBalancer.SubnetMappingProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]]]] = None,
    ...
    def load_balancer_attributes(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnLoadBalancer, "load_balancer_attributes").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def name(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnLoadBalancer, "name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def subnet_mappings(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnLoadBalancer, "subnet_mappings").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def type(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnLoadBalancer, "type").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    class LoadBalancerAttributeProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnLoadBalancer.LoadBalancerAttributeProperty.__init__)
                check_type(argname="argument key", value=key, expected_type=type_hints["key"])
                check_type(argname="argument value", value=value, expected_type=type_hints["value"])
            self._values: typing.Dict[str, typing.Any] = {}
            if key is not None:
    ...
    class SubnetMappingProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnLoadBalancer.SubnetMappingProperty.__init__)
...
class CfnTargetGroup(
    ...
    def __init__(
        ...
        *,
        ...
        ip_address_type: typing.Optional[builtins.str] = None,
        matcher: typing.Optional[typing.Union[typing.Union["CfnTargetGroup.MatcherProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]] = None,
        name: typing.Optional[builtins.str] = None,
        port: typing.Optional[jsii.Number] = None,
        protocol: typing.Optional[builtins.str] = None,
        protocol_version: typing.Optional[builtins.str] = None,
        tags: typing.Optional[typing.Sequence[_CfnTag_f6864754]] = None,
        target_group_attributes: typing.Optional[typing.Union[_IResolvable_da3f097b, typing.Sequence[typing.Union[typing.Union["CfnTargetGroup.TargetGroupAttributeProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]]]] = None,
        targets: typing.Optional[typing.Union[_IResolvable_da3f097b, typing.Sequence[typing.Union[typing.Union["CfnTargetGroup.TargetDescriptionProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]]]] = None,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnTargetGroup.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def inspect(self, inspector: _TreeInspector_488e0dd5) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnTargetGroup.inspect)
            check_type(argname="argument inspector", value=inspector, expected_type=type_hints["inspector"])
        return typing.cast(None, jsii.invoke(self, "inspect", [inspector]))
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnTargetGroup._render_properties)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    def health_check_enabled(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnTargetGroup, "health_check_enabled").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def health_check_interval_seconds(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnTargetGroup, "health_check_interval_seconds").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def health_check_path(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnTargetGroup, "health_check_path").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def health_check_port(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnTargetGroup, "health_check_port").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def health_check_protocol(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnTargetGroup, "health_check_protocol").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def health_check_timeout_seconds(self, value: typing.Optional[jsii.Number]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnTargetGroup, "health_check_timeout_seconds").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def healthy_threshold_count(self, value: typing.Optional[jsii.Number]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnTargetGroup, "healthy_threshold_count").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def ip_address_type(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnTargetGroup, "ip_address_type").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "ipAddressType", value)
    ...
    def matcher(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnTargetGroup, "matcher").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def name(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnTargetGroup, "name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "name", value)
    ...
    def port(self, value: typing.Optional[jsii.Number]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnTargetGroup, "port").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "port", value)
    ...
    def protocol(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnTargetGroup, "protocol").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "protocol", value)
    ...
    def protocol_version(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnTargetGroup, "protocol_version").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def target_group_attributes(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnTargetGroup, "target_group_attributes").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def targets(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnTargetGroup, "targets").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def target_type(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnTargetGroup, "target_type").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def unhealthy_threshold_count(self, value: typing.Optional[jsii.Number]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnTargetGroup, "unhealthy_threshold_count").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def vpc_id(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnTargetGroup, "vpc_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    class MatcherProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnTargetGroup.MatcherProperty.__init__)
    ...
    class TargetDescriptionProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnTargetGroup.TargetDescriptionProperty.__init__)
                check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    class TargetGroupAttributeProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnTargetGroup.TargetGroupAttributeProperty.__init__)
                check_type(argname="argument key", value=key, expected_type=type_hints["key"])
                check_type(argname="argument value", value=value, expected_type=type_hints["value"])
            self._values: typing.Dict[str, typing.Any] = {}
            if key is not None:
...
class CfnTargetGroupProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnTargetGroupProps.__init__)
...
class FixedResponseOptions:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(FixedResponseOptions.__init__)
            check_type(argname="argument content_type", value=content_type, expected_type=type_hints["content_type"])
            check_type(argname="argument message_body", value=message_body, expected_type=type_hints["message_body"])
        self._values: typing.Dict[str, typing.Any] = {}
        if content_type is not None:
...
class ForwardOptions:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ForwardOptions.__init__)
...
class _IApplicationListenerProxy(
    ...
    def add_action(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IApplicationListener.add_action)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def add_certificates(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IApplicationListener.add_certificates)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument certificates", value=certificates, expected_type=type_hints["certificates"])
    ...
    def add_target_groups(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IApplicationListener.add_target_groups)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def add_targets(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IApplicationListener.add_targets)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def register_connectable(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IApplicationListener.register_connectable)
...
class _IApplicationLoadBalancerTargetProxy:
    ...
    def attach_to_application_target_group(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IApplicationLoadBalancerTarget.attach_to_application_target_group)
...
class _INetworkLoadBalancerProxy(
    ...
    def add_listener(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(INetworkLoadBalancer.add_listener)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
...
class _INetworkLoadBalancerTargetProxy:
    ...
    def attach_to_network_target_group(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(INetworkLoadBalancerTarget.attach_to_network_target_group)
            check_type(argname="argument target_group", value=target_group, expected_type=type_hints["target_group"])
...
class ListenerAction(
    ...
    *(weighted)forward*, *fixedResponse* or *redirect* action.
    ...
    def __init__(
        self,
        action_json: typing.Union[CfnListener.ActionProperty, typing.Dict[str, typing.Any]],
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ListenerAction.__init__)
    ...
    def fixed_response(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ListenerAction.fixed_response)
            check_type(argname="argument status_code", value=status_code, expected_type=type_hints["status_code"])
    ...
    def forward(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ListenerAction.forward)
            check_type(argname="argument target_groups", value=target_groups, expected_type=type_hints["target_groups"])
    ...
    def weighted_forward(
        cls,
        target_groups: typing.Sequence[typing.Union["WeightedTargetGroup", typing.Dict[str, typing.Any]]],
        *,
        stickiness_duration: typing.Optional[_Duration_4839e8c3] = None,
    ) -> "ListenerAction":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ListenerAction.weighted_forward)
            check_type(argname="argument target_groups", value=target_groups, expected_type=type_hints["target_groups"])
        options = ForwardOptions(stickiness_duration=stickiness_duration)
    ...
    def bind(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ListenerAction.bind)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument listener", value=listener, expected_type=type_hints["listener"])
    ...
    def _renumber(
        self,
        actions: typing.Sequence[typing.Union[CfnListener.ActionProperty, typing.Dict[str, typing.Any]]],
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ListenerAction._renumber)
            check_type(argname="argument actions", value=actions, expected_type=type_hints["actions"])
...
class ListenerCertificate(
    ...
    def __init__(self, certificate_arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ListenerCertificate.__init__)
            check_type(argname="argument certificate_arn", value=certificate_arn, expected_type=type_hints["certificate_arn"])
    ...
    def from_arn(cls, certificate_arn: builtins.str) -> "ListenerCertificate":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ListenerCertificate.from_arn)
            check_type(argname="argument certificate_arn", value=certificate_arn, expected_type=type_hints["certificate_arn"])
    ...
    def from_certificate_manager(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ListenerCertificate.from_certificate_manager)
...
class ListenerCondition(
    ...
    def host_headers(cls, values: typing.Sequence[builtins.str]) -> "ListenerCondition":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ListenerCondition.host_headers)
            check_type(argname="argument values", value=values, expected_type=type_hints["values"])
    ...
    def http_header(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ListenerCondition.http_header)
            check_type(argname="argument name", value=name, expected_type=type_hints["name"])
            check_type(argname="argument values", value=values, expected_type=type_hints["values"])
    ...
    def http_request_methods(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ListenerCondition.http_request_methods)
            check_type(argname="argument values", value=values, expected_type=type_hints["values"])
    ...
    def path_patterns(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ListenerCondition.path_patterns)
            check_type(argname="argument values", value=values, expected_type=type_hints["values"])
    ...
    def query_strings(
        cls,
        values: typing.Sequence[typing.Union["QueryStringCondition", typing.Dict[str, typing.Any]]],
    ) -> "ListenerCondition":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ListenerCondition.query_strings)
            check_type(argname="argument values", value=values, expected_type=type_hints["values"])
    ...
    def source_ips(cls, values: typing.Sequence[builtins.str]) -> "ListenerCondition":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ListenerCondition.source_ips)
            check_type(argname="argument values", value=values, expected_type=type_hints["values"])
...
class LoadBalancerTargetProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(LoadBalancerTargetProps.__init__)
            check_type(argname="argument target_type", value=target_type, expected_type=type_hints["target_type"])
...
class NetworkForwardOptions:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(NetworkForwardOptions.__init__)
            check_type(argname="argument stickiness_duration", value=stickiness_duration, expected_type=type_hints["stickiness_duration"])
        self._values: typing.Dict[str, typing.Any] = {}
        if stickiness_duration is not None:
            self._values["stickiness_duration"] = stickiness_duration
...
class NetworkListener(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(NetworkListener.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def from_lookup(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(NetworkListener.from_lookup)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def from_network_listener_arn(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(NetworkListener.from_network_listener_arn)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def add_action(self, _id: builtins.str, *, action: "NetworkListenerAction") -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(NetworkListener.add_action)
    ...
    def add_certificates(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(NetworkListener.add_certificates)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument certificates", value=certificates, expected_type=type_hints["certificates"])
        return typing.cast(None, jsii.invoke(self, "addCertificates", [id, certificates]))
    ...
    def add_target_groups(
        ...
        *target_groups: "INetworkTargetGroup",
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(NetworkListener.add_target_groups)
            check_type(argname="argument _id", value=_id, expected_type=type_hints["_id"])
    ...
    def add_targets(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(NetworkListener.add_targets)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
...
class NetworkListenerAction(
    ...
    *(weighted)forward*, *fixedResponse* or *redirect* action.
    ...
    def __init__(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(NetworkListenerAction.__init__)
            check_type(argname="argument action_json", value=action_json, expected_type=type_hints["action_json"])
            check_type(argname="argument next", value=next, expected_type=type_hints["next"])
        jsii.create(self.__class__, self, [action_json, next])
    ...
    def forward(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(NetworkListenerAction.forward)
            check_type(argname="argument target_groups", value=target_groups, expected_type=type_hints["target_groups"])
    ...
    def weighted_forward(
        cls,
        target_groups: typing.Sequence[typing.Union["NetworkWeightedTargetGroup", typing.Dict[str, typing.Any]]],
        *,
        stickiness_duration: typing.Optional[_Duration_4839e8c3] = None,
    ) -> "NetworkListenerAction":
        '''Forward to one or more Target Groups which are weighted differently.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(NetworkListenerAction.weighted_forward)
            check_type(argname="argument target_groups", value=target_groups, expected_type=type_hints["target_groups"])
        options = NetworkForwardOptions(stickiness_duration=stickiness_duration)
    ...
    def bind(self, scope: constructs.Construct, listener: INetworkListener) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(NetworkListenerAction.bind)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument listener", value=listener, expected_type=type_hints["listener"])
    ...
    def _renumber(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(NetworkListenerAction._renumber)
            check_type(argname="argument actions", value=actions, expected_type=type_hints["actions"])
        return typing.cast(typing.List[CfnListener.ActionProperty], jsii.invoke(self, "renumber", [actions]))
...
class NetworkListenerLookupOptions(BaseListenerLookupOptions):
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(NetworkListenerLookupOptions.__init__)
            check_type(argname="argument listener_port", value=listener_port, expected_type=type_hints["listener_port"])
            check_type(argname="argument load_balancer_arn", value=load_balancer_arn, expected_type=type_hints["load_balancer_arn"])
            check_type(argname="argument load_balancer_tags", value=load_balancer_tags, expected_type=type_hints["load_balancer_tags"])
...
class NetworkLoadBalancer(
    ...
    def from_lookup(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(NetworkLoadBalancer.from_lookup)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def from_network_load_balancer_attributes(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(NetworkLoadBalancer.from_network_load_balancer_attributes)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def add_listener(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(NetworkLoadBalancer.add_listener)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        props = BaseNetworkListenerProps(
            port=port,
            alpn_policy=alpn_policy,
    ...
    def metric(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(NetworkLoadBalancer.metric)
...
class NetworkLoadBalancerAttributes:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(NetworkLoadBalancerAttributes.__init__)
            check_type(argname="argument load_balancer_arn", value=load_balancer_arn, expected_type=type_hints["load_balancer_arn"])
            check_type(argname="argument load_balancer_canonical_hosted_zone_id", value=load_balancer_canonical_hosted_zone_id, expected_type=type_hints["load_balancer_canonical_hosted_zone_id"])
            check_type(argname="argument load_balancer_dns_name", value=load_balancer_dns_name, expected_type=type_hints["load_balancer_dns_name"])
            check_type(argname="argument vpc", value=vpc, expected_type=type_hints["vpc"])
...
class NetworkLoadBalancerLookupOptions(BaseLoadBalancerLookupOptions):
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(NetworkLoadBalancerLookupOptions.__init__)
            check_type(argname="argument load_balancer_arn", value=load_balancer_arn, expected_type=type_hints["load_balancer_arn"])
            check_type(argname="argument load_balancer_tags", value=load_balancer_tags, expected_type=type_hints["load_balancer_tags"])
        self._values: typing.Dict[str, typing.Any] = {}
        if load_balancer_arn is not None:
    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(health_check, dict):
            health_check = HealthCheck(**health_check)
        if __debug__:
            type_hints = typing.get_type_hints(NetworkTargetGroupProps.__init__)
            check_type(argname="argument deregistration_delay", value=deregistration_delay, expected_type=type_hints["deregistration_delay"])
            check_type(argname="argument health_check", value=health_check, expected_type=type_hints["health_check"])
            check_type(argname="argument target_group_name", value=target_group_name, expected_type=type_hints["target_group_name"])
            check_type(argname="argument target_type", value=target_type, expected_type=type_hints["target_type"])
...
class NetworkWeightedTargetGroup:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(NetworkWeightedTargetGroup.__init__)
            check_type(argname="argument target_group", value=target_group, expected_type=type_hints["target_group"])
            check_type(argname="argument weight", value=weight, expected_type=type_hints["weight"])
        self._values: typing.Dict[str, typing.Any] = {
...
class QueryStringCondition:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(QueryStringCondition.__init__)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
            check_type(argname="argument key", value=key, expected_type=type_hints["key"])
        self._values: typing.Dict[str, typing.Any] = {
            "value": value,
...
class RedirectOptions:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(RedirectOptions.__init__)
            check_type(argname="argument host", value=host, expected_type=type_hints["host"])
            check_type(argname="argument path", value=path, expected_type=type_hints["path"])
...
class TargetGroupAttributes:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(TargetGroupAttributes.__init__)
            check_type(argname="argument target_group_arn", value=target_group_arn, expected_type=type_hints["target_group_arn"])
...
class TargetGroupBase(
    ...
    def __init__(
        ...
        scope: constructs.Construct,
        id: builtins.str,
        base_props: typing.Union[BaseTargetGroupProps, typing.Dict[str, typing.Any]],
        additional_props: typing.Any,
    ) -> None:
        '''
        :param scope: -
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(TargetGroupBase.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument base_props", value=base_props, expected_type=type_hints["base_props"])
            check_type(argname="argument additional_props", value=additional_props, expected_type=type_hints["additional_props"])
    ...
    def set_attribute(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(TargetGroupBase.set_attribute)
            check_type(argname="argument key", value=key, expected_type=type_hints["key"])
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        return typing.cast(None, jsii.invoke(self, "setAttribute", [key, value]))
    ...
    def health_check(self, value: HealthCheck) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(TargetGroupBase, "health_check").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def _target_type(self, value: typing.Optional["TargetType"]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(TargetGroupBase, "_target_type").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "targetType", value)
...
class WeightedTargetGroup:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(WeightedTargetGroup.__init__)
            check_type(argname="argument target_group", value=target_group, expected_type=type_hints["target_group"])
            check_type(argname="argument weight", value=weight, expected_type=type_hints["weight"])
        self._values: typing.Dict[str, typing.Any] = {
            "target_group": target_group,
...
class AddApplicationActionProps(AddRuleProps):
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AddApplicationActionProps.__init__)
            check_type(argname="argument conditions", value=conditions, expected_type=type_hints["conditions"])
            check_type(argname="argument priority", value=priority, expected_type=type_hints["priority"])
            check_type(argname="argument action", value=action, expected_type=type_hints["action"])
        self._values: typing.Dict[str, typing.Any] = {
...
class AddApplicationTargetGroupsProps(AddRuleProps):
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AddApplicationTargetGroupsProps.__init__)
            check_type(argname="argument conditions", value=conditions, expected_type=type_hints["conditions"])
            check_type(argname="argument priority", value=priority, expected_type=type_hints["priority"])
            check_type(argname="argument target_groups", value=target_groups, expected_type=type_hints["target_groups"])
        self._values: typing.Dict[str, typing.Any] = {
    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(health_check, dict):
            health_check = HealthCheck(**health_check)
        if __debug__:
            type_hints = typing.get_type_hints(AddApplicationTargetsProps.__init__)
            check_type(argname="argument conditions", value=conditions, expected_type=type_hints["conditions"])
            check_type(argname="argument priority", value=priority, expected_type=type_hints["priority"])
            check_type(argname="argument deregistration_delay", value=deregistration_delay, expected_type=type_hints["deregistration_delay"])
            check_type(argname="argument health_check", value=health_check, expected_type=type_hints["health_check"])
...
class ApplicationListener(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ApplicationListener.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def from_application_listener_attributes(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ApplicationListener.from_application_listener_attributes)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def from_lookup(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ApplicationListener.from_lookup)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def add_action(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ApplicationListener.add_action)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        props = AddApplicationActionProps(
            action=action, conditions=conditions, priority=priority
        )
    ...
    def add_certificates(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ApplicationListener.add_certificates)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument certificates", value=certificates, expected_type=type_hints["certificates"])
        return typing.cast(None, jsii.invoke(self, "addCertificates", [id, certificates]))
    ...
    def add_target_groups(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ApplicationListener.add_target_groups)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        props = AddApplicationTargetGroupsProps(
            target_groups=target_groups, conditions=conditions, priority=priority
        )
    ...
    def add_targets(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ApplicationListener.add_targets)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        props = AddApplicationTargetsProps(
            deregistration_delay=deregistration_delay,
            health_check=health_check,
    ...
    def register_connectable(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ApplicationListener.register_connectable)
            check_type(argname="argument connectable", value=connectable, expected_type=type_hints["connectable"])
            check_type(argname="argument port_range", value=port_range, expected_type=type_hints["port_range"])
        return typing.cast(None, jsii.invoke(self, "registerConnectable", [connectable, port_range]))
...
class ApplicationListenerLookupOptions(BaseListenerLookupOptions):
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ApplicationListenerLookupOptions.__init__)
            check_type(argname="argument listener_port", value=listener_port, expected_type=type_hints["listener_port"])
            check_type(argname="argument load_balancer_arn", value=load_balancer_arn, expected_type=type_hints["load_balancer_arn"])
            check_type(argname="argument load_balancer_tags", value=load_balancer_tags, expected_type=type_hints["load_balancer_tags"])
            check_type(argname="argument listener_arn", value=listener_arn, expected_type=type_hints["listener_arn"])
...
class ApplicationListenerRuleProps(BaseApplicationListenerRuleProps):
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ApplicationListenerRuleProps.__init__)
            check_type(argname="argument priority", value=priority, expected_type=type_hints["priority"])
            check_type(argname="argument action", value=action, expected_type=type_hints["action"])
            check_type(argname="argument conditions", value=conditions, expected_type=type_hints["conditions"])
            check_type(argname="argument target_groups", value=target_groups, expected_type=type_hints["target_groups"])
...
class ApplicationLoadBalancerLookupOptions(BaseLoadBalancerLookupOptions):
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ApplicationLoadBalancerLookupOptions.__init__)
            check_type(argname="argument load_balancer_arn", value=load_balancer_arn, expected_type=type_hints["load_balancer_arn"])
            check_type(argname="argument load_balancer_tags", value=load_balancer_tags, expected_type=type_hints["load_balancer_tags"])
        self._values: typing.Dict[str, typing.Any] = {}
        if load_balancer_arn is not None:
    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(health_check, dict):
            health_check = HealthCheck(**health_check)
        if __debug__:
            type_hints = typing.get_type_hints(ApplicationTargetGroupProps.__init__)
            check_type(argname="argument deregistration_delay", value=deregistration_delay, expected_type=type_hints["deregistration_delay"])
            check_type(argname="argument health_check", value=health_check, expected_type=type_hints["health_check"])
            check_type(argname="argument target_group_name", value=target_group_name, expected_type=type_hints["target_group_name"])
            check_type(argname="argument target_type", value=target_type, expected_type=type_hints["target_type"])
...
class _IApplicationLoadBalancerProxy(
    ...
    def add_listener(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IApplicationLoadBalancer.add_listener)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
...
class _IApplicationTargetGroupProxy(
    ...
    def add_target(self, *targets: IApplicationLoadBalancerTarget) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IApplicationTargetGroup.add_target)
    ...
    def register_connectable(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IApplicationTargetGroup.register_connectable)
            check_type(argname="argument connectable", value=connectable, expected_type=type_hints["connectable"])
            check_type(argname="argument port_range", value=port_range, expected_type=type_hints["port_range"])
        return typing.cast(None, jsii.invoke(self, "registerConnectable", [connectable, port_range]))
    ...
    def register_listener(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IApplicationTargetGroup.register_listener)
            check_type(argname="argument listener", value=listener, expected_type=type_hints["listener"])
            check_type(argname="argument associating_construct", value=associating_construct, expected_type=type_hints["associating_construct"])
...
class _INetworkTargetGroupProxy(
    ...
    def add_target(self, *targets: INetworkLoadBalancerTarget) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(INetworkTargetGroup.add_target)
            check_type(argname="argument targets", value=targets, expected_type=typing.Tuple[type_hints["targets"], ...]) # pyright: ignore [reportGeneralTypeIssues]
        return typing.cast(None, jsii.invoke(self, "addTarget", [*targets]))
    ...
    def register_listener(self, listener: INetworkListener) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(INetworkTargetGroup.register_listener)
            check_type(argname="argument listener", value=listener, expected_type=type_hints["listener"])
...
class NetworkTargetGroup(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(NetworkTargetGroup.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def from_target_group_attributes(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(NetworkTargetGroup.from_target_group_attributes)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def add_target(self, *targets: INetworkLoadBalancerTarget) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(NetworkTargetGroup.add_target)
            check_type(argname="argument targets", value=targets, expected_type=typing.Tuple[type_hints["targets"], ...]) # pyright: ignore [reportGeneralTypeIssues]
        return typing.cast(None, jsii.invoke(self, "addTarget", [*targets]))
    ...
    def register_listener(self, listener: INetworkListener) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(NetworkTargetGroup.register_listener)
            check_type(argname="argument listener", value=listener, expected_type=type_hints["listener"])
        return typing.cast(None, jsii.invoke(self, "registerListener", [listener]))
...
class ApplicationLoadBalancer(
    ...
    def from_application_load_balancer_attributes(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ApplicationLoadBalancer.from_application_load_balancer_attributes)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def from_lookup(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ApplicationLoadBalancer.from_lookup)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def add_listener(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ApplicationLoadBalancer.add_listener)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        props = BaseApplicationListenerProps(
            certificates=certificates,
            default_action=default_action,
    ...
    def add_security_group(self, security_group: _ISecurityGroup_acf8a799) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ApplicationLoadBalancer.add_security_group)
            check_type(argname="argument security_group", value=security_group, expected_type=type_hints["security_group"])
    ...
    def metric(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ApplicationLoadBalancer.metric)
            check_type(argname="argument metric_name", value=metric_name, expected_type=type_hints["metric_name"])
        props = _MetricOptions_1788b62f(
            account=account,
            color=color,
    ...
    def metric_http_code_elb(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ApplicationLoadBalancer.metric_http_code_elb)
    ...
    def metric_http_code_target(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ApplicationLoadBalancer.metric_http_code_target)
            check_type(argname="argument code", value=code, expected_type=type_hints["code"])
        props = _MetricOptions_1788b62f(
            account=account,
            color=color,
...
class ApplicationTargetGroup(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ApplicationTargetGroup.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def from_target_group_attributes(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ApplicationTargetGroup.from_target_group_attributes)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        attrs = TargetGroupAttributes(
            target_group_arn=target_group_arn, load_balancer_arns=load_balancer_arns
    ...
    def add_target(self, *targets: IApplicationLoadBalancerTarget) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ApplicationTargetGroup.add_target)
            check_type(argname="argument targets", value=targets, expected_type=typing.Tuple[type_hints["targets"], ...]) # pyright: ignore [reportGeneralTypeIssues]
        return typing.cast(None, jsii.invoke(self, "addTarget", [*targets]))
    ...
    def enable_cookie_stickiness(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ApplicationTargetGroup.enable_cookie_stickiness)
    ...
    def metric(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ApplicationTargetGroup.metric)
            check_type(argname="argument metric_name", value=metric_name, expected_type=type_hints["metric_name"])
        props = _MetricOptions_1788b62f(
            account=account,
            color=color,
    ...
    def metric_http_code_target(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ApplicationTargetGroup.metric_http_code_target)
            check_type(argname="argument code", value=code, expected_type=type_hints["code"])
        props = _MetricOptions_1788b62f(
            account=account,
            color=color,
    ...
    def register_connectable(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ApplicationTargetGroup.register_connectable)
            check_type(argname="argument connectable", value=connectable, expected_type=type_hints["connectable"])
            check_type(argname="argument port_range", value=port_range, expected_type=type_hints["port_range"])
        return typing.cast(None, jsii.invoke(self, "registerConnectable", [connectable, port_range]))
    ...
    def register_listener(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ApplicationTargetGroup.register_listener)
            check_type(argname="argument listener", value=listener, expected_type=type_hints["listener"])
            check_type(argname="argument associating_construct", value=associating_construct, expected_type=type_hints["associating_construct"])
        return typing.cast(None, jsii.invoke(self, "registerListener", [listener, associating_construct]))
