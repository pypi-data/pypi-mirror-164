...
class CfnProfilingGroup(
    ...
    def __init__(
        ...
        *,
        ...
        anomaly_detection_notification_configuration: typing.Optional[typing.Union[_IResolvable_da3f097b, typing.Sequence[typing.Union[typing.Union["CfnProfilingGroup.ChannelProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]]]] = None,
