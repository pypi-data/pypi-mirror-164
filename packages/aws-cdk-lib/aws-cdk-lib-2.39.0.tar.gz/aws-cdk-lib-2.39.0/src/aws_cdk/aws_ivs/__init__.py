...
class CfnRecordingConfiguration(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        destination_configuration: typing.Union[typing.Union["CfnRecordingConfiguration.DestinationConfigurationProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b],
        name: typing.Optional[builtins.str] = None,
        tags: typing.Optional[typing.Sequence[_CfnTag_f6864754]] = None,
        thumbnail_configuration: typing.Optional[typing.Union[typing.Union["CfnRecordingConfiguration.ThumbnailConfigurationProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]] = None,
    ) -> None:
    ...
    class DestinationConfigurationProperty:
        def __init__(
            self,
            *,
            s3: typing.Union[typing.Union["CfnRecordingConfiguration.S3DestinationConfigurationProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b],
        ) -> None:
