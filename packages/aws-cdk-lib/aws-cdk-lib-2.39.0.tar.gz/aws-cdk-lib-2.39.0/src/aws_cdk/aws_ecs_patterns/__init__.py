...
class FargateServiceBaseProps:
    def __init__(
        ...
        *,
        ...
        runtime_platform: typing.Optional[_RuntimePlatform_5ed98a9c] = None,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(FargateServiceBaseProps.__init__)
    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(task_subnets, dict):
            task_subnets = SubnetSelection(**task_subnets)
        if __debug__:
