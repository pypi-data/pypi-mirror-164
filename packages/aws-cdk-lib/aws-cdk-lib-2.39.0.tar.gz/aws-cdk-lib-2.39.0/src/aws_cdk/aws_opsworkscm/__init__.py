...
class CfnServer(
    ...
    def __init__(
        ...
        *,
        ...
        engine_attributes: typing.Optional[typing.Union[_IResolvable_da3f097b, typing.Sequence[typing.Union[typing.Union["CfnServer.EngineAttributeProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]]]] = None,
