...
class CfnSafetyRule(
    ...
    def __init__(
        ...
        *,
        ...
        name: builtins.str,
        rule_config: typing.Union[typing.Union["CfnSafetyRule.RuleConfigProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b],
        assertion_rule: typing.Optional[typing.Union[typing.Union["CfnSafetyRule.AssertionRuleProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]] = None,
        gating_rule: typing.Optional[typing.Union[typing.Union["CfnSafetyRule.GatingRuleProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]] = None,
        tags: typing.Optional[typing.Sequence[_CfnTag_f6864754]] = None,
    ) -> None:
