...
class CfnVirtualCluster(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        container_provider: typing.Union[typing.Union["CfnVirtualCluster.ContainerProviderProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b],
        name: builtins.str,
    ...
    class ContainerInfoProperty:
        def __init__(
            self,
            *,
            eks_info: typing.Union[typing.Union["CfnVirtualCluster.EksInfoProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b],
        ) -> None:
    ...
    class ContainerProviderProperty:
        def __init__(
            ...
            *,
            id: builtins.str,
            info: typing.Union[typing.Union["CfnVirtualCluster.ContainerInfoProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b],
            type: builtins.str,
        ) -> None:
