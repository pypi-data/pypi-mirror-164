...
setup(
    ...
    description=(
        "Type annotations for aiobotocore.RedshiftServerless 2.4.0 service generated with"
    ...
    package_data={"": ["LICENSE"], "types_aiobotocore_redshift_serverless": ["py.typed", "*.pyi"]},
    python_requires=">=3.7",
    project_urls={
