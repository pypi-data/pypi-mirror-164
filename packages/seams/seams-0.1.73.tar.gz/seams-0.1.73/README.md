...
## Creating a vertex
To create a vertex call the create_vertex method with 4 required arguments: Tenant Id, Vertex Label, Vertex Name, and a dictionary of key/value pairs that will represent the data fields of the vertex.
