...
def test_output_name_ordering(transform_builder):
    ...
    allowed_world_names = {
        "VISP": (
            # Note that because one spatial pixel axis is first both the world
            # axes come before the wavelength world axis.
            ("helioprojective latitude", "helioprojective longitude", "wavelength", "time"),
            ("helioprojective latitude", "helioprojective longitude", "wavelength", "time", "stokes"),
        ),
        "VTF": (
