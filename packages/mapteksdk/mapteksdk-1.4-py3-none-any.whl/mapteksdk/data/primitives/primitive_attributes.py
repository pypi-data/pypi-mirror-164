...
class PrimitiveAttributes:
  ...
  def __getitem__(self, name):
    ...
    # :TODO: 2021-09-13 SDK-517 This should probably be how
  ...
  def _load_attribute(self, name):
    ...
    if function_name is None:
      raise ValueError(
        f'The type of the attribute ({array_type}) is an unsupported type.')
    ...
    if self.primitive_type == PrimitiveType.POINT:
      ...
      raise ValueError(
        f'The primitive type {self.primitive_type!r} '
  ...
  def _save_attribute(self, name, data):
    ...
    if function_name is None:
      raise ValueError(
        f'The type of the attribute ({array_ctype}) is an unsupported type.')
