...
class PointSet(PointProperties, PointDeletionProperties, Topology):
  ...
  def _get_pandas(
    ...
    if include_colours:
      ...
      # before visible.
      column_names.extend((PointSet.RED, PointSet.GREEN, PointSet.BLUE, PointSet.ALPHA))
  ...
  def _put_pandas(self, point_collection, included_names, include_colours,
    ...
    """
    try:
      self.points = point_collection[[PointSet.X, PointSet.Y, PointSet.Z]].values
      ...
      message = (
        ...
        "'{PointSet.Z}' columns is not supported. "
