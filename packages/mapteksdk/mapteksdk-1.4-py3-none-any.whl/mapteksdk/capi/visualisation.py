...
class Visualisation(WrapperBase):
  ...
  def __init__(self):
    super().__init__("mdf_visualisation", "mapteksdk.capi.visualisation")
  ...
  def capi_functions(self):
    return [
      ...
      {"VisualisationCApiVersion" : (ctypes.c_uint32, None),
       ...
       "VisualisationReadRaster2DDimensions" : (ctypes.c_uint8, [ctypes.POINTER(T_ReadHandle), ctypes.POINTER(ctypes.c_uint32), ]),
       ...
       "VisualisationRasterGetTitle" : (ctypes.c_uint8, [ctypes.POINTER(T_ReadHandle), ctypes.c_char_p, ctypes.POINTER(ctypes.c_uint32), ]),
      }
    ]
