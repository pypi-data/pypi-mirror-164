...
def separate_filters(filters: list[FieldFilter], to_separate: str):
...
def model_to_dict(model):
    return {field: getattr(model, field) for field in model.__mapper__.column_attrs.keys()}
...
def load_from_model_query(model, filters: list[FieldFilter], limit: Union[int, None], offset: Union[int, None],
                          query_modifier: Callable = None, init_query=None):
