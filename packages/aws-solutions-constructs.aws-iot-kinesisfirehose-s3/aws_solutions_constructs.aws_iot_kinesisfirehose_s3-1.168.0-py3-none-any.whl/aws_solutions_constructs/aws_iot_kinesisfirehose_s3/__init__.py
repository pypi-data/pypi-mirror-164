...
class IotToKinesisFirehoseToS3(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IotToKinesisFirehoseToS3.__init__)
    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(iot_topic_rule_props, dict):
            iot_topic_rule_props = CfnTopicRuleProps(**iot_topic_rule_props)
        ...
        if __debug__:
            type_hints = typing.get_type_hints(IotToKinesisFirehoseToS3Props.__init__)
