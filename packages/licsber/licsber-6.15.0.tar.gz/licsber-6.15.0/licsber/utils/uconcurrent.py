...
def wait_for_execute(
    ...
    :param safe: True进程/False线程
    :return:
    """
    executor = ThreadPoolExecutor if safe else ProcessPoolExecutor
    with executor(initializer=initializer, max_workers=max_workers) as p:
