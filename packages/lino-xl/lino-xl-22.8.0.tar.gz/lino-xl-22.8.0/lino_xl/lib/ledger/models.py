...
from .mixins import ProjectRelated, VoucherNumber, PeriodRange, PeriodRangeObservable, PartnerRelated, Payable
...
class Journal(BabelNamed, Sequenced, Referrable, PrintableType):
    ...
    make_ledger_movements = models.BooleanField(_("Ledger"), default=True)
    ...
    invoicing_area = dd.ForeignKey('invoicing.Area', blank=True, null=True,
        related_name="journals_using_this")
...
class Declaration(PartnerRelated, Payable, RegistrableVoucher, Certifiable, PeriodRange):
    class Meta:
        abstract = True
        app_label = "ledger"
