...
def test_sanitize_vertex():
    ...
    sanitized_vertex = _patch_widget.sanitize_vertex(
        copy(vertex), 0, 10, 0, 10
    )
...
def test_sanitize_rectangle():
    ...
    sanitized_rectangle = _patch_widget.sanitize_rectangle(
...
def test_create_rectangle():
    ...
    rectangle = _patch_widget.create_rectangle(
