...
APP_NAME = 'scheduler Demo Application'  # Displayed in some generic UI scenarios
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'libraries':{
                'scheduler_taglib': 'psu_scheduler.templatetags.scheduler_taglib',
            }
        },
    },
]
...
if is_aws:
    ...
    SECRET_KEY = os.environ.get('SECRET_KEY', '+okl7=0e6g#*p((61xdt45n-aah3l+ngv(n)zqiojf2)vqyo0^')
