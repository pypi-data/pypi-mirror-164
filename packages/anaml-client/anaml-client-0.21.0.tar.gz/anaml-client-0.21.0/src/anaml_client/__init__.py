...
from .models.view_materialisation import *
from .models.view_materialisation_runs import *
from . import version
...
class Anaml:
    ...
    def get_view_materialisation_by_id(self, view_materialisation_id: Union[ViewMaterialisationJobId, int]) -> ViewMaterialisationJob:
