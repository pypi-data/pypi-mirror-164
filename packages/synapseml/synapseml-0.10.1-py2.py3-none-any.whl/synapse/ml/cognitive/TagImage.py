...
class TagImage(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="TagImage_c7c6bf99bd6f_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        language=None,
        languageCol=None,
        outputCol="TagImage_c7c6bf99bd6f_output",
        ...
        self._setDefault(errorCol="TagImage_c7c6bf99bd6f_error")
        self._setDefault(outputCol="TagImage_c7c6bf99bd6f_output")
