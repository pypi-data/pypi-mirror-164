...
class FindSimilarFace(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="FindSimilarFace_1bb3ab7bc3b1_error",
        faceId=None,
        faceIdCol=None,
        faceIds=None,
        faceIdsCol=None,
        ...
        mode=None,
        modeCol=None,
        outputCol="FindSimilarFace_1bb3ab7bc3b1_output",
        ...
        self._setDefault(errorCol="FindSimilarFace_1bb3ab7bc3b1_error")
        self._setDefault(outputCol="FindSimilarFace_1bb3ab7bc3b1_output")
