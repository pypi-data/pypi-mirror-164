...
class DictionaryExamples(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="DictionaryExamples_bad84bf387af_error",
        fromLanguage=None,
        fromLanguageCol=None,
        handler=None,
        outputCol="DictionaryExamples_bad84bf387af_output",
        ...
        self._setDefault(errorCol="DictionaryExamples_bad84bf387af_error")
        self._setDefault(outputCol="DictionaryExamples_bad84bf387af_output")
