...
class VerifyFaces(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="VerifyFaces_f7902fe35e2d_error",
        faceId=None,
        faceIdCol=None,
        faceId1=None,
        faceId1Col=None,
        ...
        outputCol="VerifyFaces_f7902fe35e2d_output",
        personGroupId=None,
        ...
        self._setDefault(errorCol="VerifyFaces_f7902fe35e2d_error")
        self._setDefault(outputCol="VerifyFaces_f7902fe35e2d_output")
