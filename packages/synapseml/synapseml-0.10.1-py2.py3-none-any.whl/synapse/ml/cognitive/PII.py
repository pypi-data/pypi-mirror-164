...
class PII(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        domain=None,
        domainCol=None,
        errorCol="PII_4d01338d9da2_error",
        handler=None,
        language=None,
        languageCol=None,
        modelVersion=None,
        modelVersionCol=None,
        outputCol="PII_4d01338d9da2_output",
        piiCategories=None,
        ...
        self._setDefault(errorCol="PII_4d01338d9da2_error")
        self._setDefault(outputCol="PII_4d01338d9da2_output")
