...
class NERV2(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="NERV2_2fa61c56011c_error",
        handler=None,
        language=None,
        languageCol=None,
        outputCol="NERV2_2fa61c56011c_output",
        ...
        self._setDefault(errorCol="NERV2_2fa61c56011c_error")
        self._setDefault(outputCol="NERV2_2fa61c56011c_output")
