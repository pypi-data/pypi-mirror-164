...
class GenerateThumbnails(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="GenerateThumbnails_421d33225766_error",
        handler=None,
        height=None,
        heightCol=None,
        imageBytes=None,
        ...
        imageUrl=None,
        imageUrlCol=None,
        outputCol="GenerateThumbnails_421d33225766_output",
        smartCropping=None,
        ...
        self._setDefault(errorCol="GenerateThumbnails_421d33225766_error")
        self._setDefault(outputCol="GenerateThumbnails_421d33225766_output")
