...
class AddDocuments(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="AddDocuments_58531222e598_error",
        handler=None,
        indexName=None,
        outputCol="AddDocuments_58531222e598_output",
        serviceName=None,
        ...
        self._setDefault(errorCol="AddDocuments_58531222e598_error")
        self._setDefault(outputCol="AddDocuments_58531222e598_output")
