...
class Transliterate(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="Transliterate_e0266fd53a9e_error",
        fromScript=None,
        fromScriptCol=None,
        handler=None,
        language=None,
        languageCol=None,
        outputCol="Transliterate_e0266fd53a9e_output",
        ...
        self._setDefault(errorCol="Transliterate_e0266fd53a9e_error")
        self._setDefault(outputCol="Transliterate_e0266fd53a9e_output")
