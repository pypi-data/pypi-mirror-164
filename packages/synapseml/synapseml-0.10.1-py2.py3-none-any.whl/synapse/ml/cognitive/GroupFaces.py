...
class GroupFaces(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="GroupFaces_69ba12453891_error",
        faceIds=None,
        faceIdsCol=None,
        handler=None,
        outputCol="GroupFaces_69ba12453891_output",
        ...
        self._setDefault(errorCol="GroupFaces_69ba12453891_error")
        self._setDefault(outputCol="GroupFaces_69ba12453891_output")
