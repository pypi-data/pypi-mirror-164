...
class OCR(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="OCR_505d7fc88fc6_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        language=None,
        languageCol=None,
        outputCol="OCR_505d7fc88fc6_output",
        ...
        self._setDefault(errorCol="OCR_505d7fc88fc6_error")
        self._setDefault(outputCol="OCR_505d7fc88fc6_output")
