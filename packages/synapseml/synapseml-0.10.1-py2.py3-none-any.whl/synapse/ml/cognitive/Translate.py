...
class Translate(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="Translate_3c4860b06abe_error",
        fromLanguage=None,
        ...
        outputCol="Translate_3c4860b06abe_output",
        ...
        self._setDefault(errorCol="Translate_3c4860b06abe_error")
        self._setDefault(outputCol="Translate_3c4860b06abe_output")
