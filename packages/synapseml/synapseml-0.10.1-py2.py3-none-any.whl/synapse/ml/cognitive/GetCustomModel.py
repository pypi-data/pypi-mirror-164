...
class GetCustomModel(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="GetCustomModel_89ce46b236a5_error",
        handler=None,
        includeKeys=None,
        includeKeysCol=None,
        modelId=None,
        modelIdCol=None,
        outputCol="GetCustomModel_89ce46b236a5_output",
        ...
        self._setDefault(errorCol="GetCustomModel_89ce46b236a5_error")
        self._setDefault(outputCol="GetCustomModel_89ce46b236a5_output")
