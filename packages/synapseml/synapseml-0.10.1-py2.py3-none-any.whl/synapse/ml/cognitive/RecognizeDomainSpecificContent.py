...
class RecognizeDomainSpecificContent(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="RecognizeDomainSpecificContent_46cfc0e52bc5_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        model=None,
        modelCol=None,
        outputCol="RecognizeDomainSpecificContent_46cfc0e52bc5_output",
        ...
        self._setDefault(errorCol="RecognizeDomainSpecificContent_46cfc0e52bc5_error")
        self._setDefault(outputCol="RecognizeDomainSpecificContent_46cfc0e52bc5_output")
