...
class NER(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="NER_84dacd152a1b_error",
        handler=None,
        language=None,
        languageCol=None,
        modelVersion=None,
        modelVersionCol=None,
        outputCol="NER_84dacd152a1b_output",
        showStats=None,
        showStatsCol=None,
        ...
        self._setDefault(errorCol="NER_84dacd152a1b_error")
        self._setDefault(outputCol="NER_84dacd152a1b_output")
