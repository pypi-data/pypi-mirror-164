...
class OpenAICompletion(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        echo=None,
        echoCol=None,
        errorCol="OpenAPICompletion_80cb2a195029_error",
        ...
        n=None,
        nCol=None,
        outputCol="OpenAPICompletion_80cb2a195029_output",
        ...
        self._setDefault(errorCol="OpenAPICompletion_80cb2a195029_error")
        self._setDefault(outputCol="OpenAPICompletion_80cb2a195029_output")
