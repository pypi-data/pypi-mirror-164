...
class SpeechToText(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="SpeechToText_ebf209da28b8_error",
        format=None,
        formatCol=None,
        handler=None,
        language=None,
        languageCol=None,
        outputCol="SpeechToText_ebf209da28b8_output",
        profanity=None,
        profanityCol=None,
        ...
        self._setDefault(errorCol="SpeechToText_ebf209da28b8_error")
        self._setDefault(outputCol="SpeechToText_ebf209da28b8_output")
