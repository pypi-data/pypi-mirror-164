...
class ListCustomModels(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="ListCustomModels_c87772e877a4_error",
        handler=None,
        op=None,
        opCol=None,
        outputCol="ListCustomModels_c87772e877a4_output",
        ...
        self._setDefault(errorCol="ListCustomModels_c87772e877a4_error")
        self._setDefault(outputCol="ListCustomModels_c87772e877a4_output")
