...
class Detect(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="Detect_e349c53d1305_error",
        handler=None,
        outputCol="Detect_e349c53d1305_output",
        ...
        self._setDefault(errorCol="Detect_e349c53d1305_error")
        self._setDefault(outputCol="Detect_e349c53d1305_output")
