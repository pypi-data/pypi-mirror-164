...
class LanguageDetectorV2(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="LanguageDetectorV2_1a4fff89e6a2_error",
        handler=None,
        language=None,
        languageCol=None,
        outputCol="LanguageDetectorV2_1a4fff89e6a2_output",
        ...
        self._setDefault(errorCol="LanguageDetectorV2_1a4fff89e6a2_error")
        self._setDefault(outputCol="LanguageDetectorV2_1a4fff89e6a2_output")
