...
class KeyPhraseExtractorV2(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="KeyPhraseExtractorV2_d7e4b1c7cafd_error",
        handler=None,
        language=None,
        languageCol=None,
        outputCol="KeyPhraseExtractorV2_d7e4b1c7cafd_output",
        ...
        self._setDefault(errorCol="KeyPhraseExtractorV2_d7e4b1c7cafd_error")
        self._setDefault(outputCol="KeyPhraseExtractorV2_d7e4b1c7cafd_output")
