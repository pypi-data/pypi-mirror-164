...
class DetectFace(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="DetectFace_c949a57924bb_error",
        handler=None,
        imageUrl=None,
        imageUrlCol=None,
        outputCol="DetectFace_c949a57924bb_output",
        ...
        self._setDefault(errorCol="DetectFace_c949a57924bb_error")
        self._setDefault(outputCol="DetectFace_c949a57924bb_output")
