...
class BreakSentence(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="BreakSentence_d411298254ce_error",
        handler=None,
        language=None,
        languageCol=None,
        outputCol="BreakSentence_d411298254ce_output",
        script=None,
        scriptCol=None,
        ...
        self._setDefault(errorCol="BreakSentence_d411298254ce_error")
        self._setDefault(outputCol="BreakSentence_d411298254ce_output")
