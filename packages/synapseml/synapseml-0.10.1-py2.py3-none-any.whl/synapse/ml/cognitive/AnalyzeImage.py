...
class AnalyzeImage(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        details=None,
        detailsCol=None,
        errorCol="AnalyzeImage_5bab0277ceff_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        language=None,
        languageCol=None,
        outputCol="AnalyzeImage_5bab0277ceff_output",
        ...
        self._setDefault(errorCol="AnalyzeImage_5bab0277ceff_error")
        self._setDefault(outputCol="AnalyzeImage_5bab0277ceff_output")
