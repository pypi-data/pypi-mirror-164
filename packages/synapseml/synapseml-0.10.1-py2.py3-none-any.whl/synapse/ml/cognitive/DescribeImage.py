...
class DescribeImage(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="DescribeImage_ba9f2daf42cf_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        outputCol="DescribeImage_ba9f2daf42cf_output",
        ...
        self._setDefault(errorCol="DescribeImage_ba9f2daf42cf_error")
        self._setDefault(outputCol="DescribeImage_ba9f2daf42cf_output")
