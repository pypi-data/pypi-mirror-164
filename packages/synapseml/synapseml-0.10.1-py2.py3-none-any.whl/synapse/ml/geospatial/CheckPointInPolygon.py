...
class CheckPointInPolygon(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="CheckPointInPolygon_afc00a0de810_error",
        handler=None,
        latitude=None,
        latitudeCol=None,
        longitude=None,
        longitudeCol=None,
        outputCol="CheckPointInPolygon_afc00a0de810_output",
        ...
        self._setDefault(errorCol="CheckPointInPolygon_afc00a0de810_error")
        self._setDefault(outputCol="CheckPointInPolygon_afc00a0de810_output")
