...
requirements = ['setuptools==56.0.0', 'neo4j==4.4.0', 'numpy==1.19.5', 'pandas==1.1.5', 'pytest==6.2.4',
                'pytest_unordered==0.4.1', 'requests==2.25.1', 'networkx==2.5.1']
required = []
dependency_links = []
...
setuptools.setup(
    ...
    version="3.1.7",                         # The initial release version
