...
import { ScriptEditorWidgetFactory } from './ScriptEditorWidgetFactory';
import { ScriptEditor } from './ScriptEditor';
import { pyIcon } from './icons';
...
const PYTHON = 'python';
const PYTHON_EDITOR_NAMESPACE = 'python-editor-extension';
...
const extension: JupyterFrontEndPlugin<void> = {
    ...
    activate: (
      ...
      launcher: ILauncher | null
        ...
        console.log('python-editor extension is activated!');
