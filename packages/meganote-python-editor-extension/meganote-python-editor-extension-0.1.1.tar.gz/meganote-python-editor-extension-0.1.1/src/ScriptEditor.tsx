 ...
 */
const SCRIPT_EDITOR_CLASS = 'ScriptEditor';
const OUTPUT_AREA_CLASS = 'ScriptEditor-OutputArea';
const OUTPUT_AREA_ERROR_CLASS = 'ScriptEditor-OutputArea-error';
const OUTPUT_AREA_CHILD_CLASS = 'ScriptEditor-OutputArea-child';
const OUTPUT_AREA_OUTPUT_CLASS = 'ScriptEditor-OutputArea-output';
const OUTPUT_AREA_PROMPT_CLASS = 'ScriptEditor-OutputArea-prompt';
const RUN_BUTTON_CLASS = 'ScriptEditor-Run';
const TOOLBAR_CLASS = 'ScriptEditor-Toolbar';
...
> {
  ...
  private createScrollButtons = (
    ...
    scrollUpButton.className = 'ScriptEditor-scrollTop';
    scrollDownButton.className = 'ScriptEditor-scrollBottom';
