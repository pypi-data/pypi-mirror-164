...
from .common import CONFIG_DIR, PROBLEM_DIFFICULTY, STATUS_COLORS, abort_with_error
...
def print_record(record: Record) -> None:
    click.echo(
        ...
        + click.style(
            f"[{PROBLEM_DIFFICULTY[record['problem']['difficulty']][0]}]",
            fg=PROBLEM_DIFFICULTY[record["problem"]["difficulty"]][1],
        )
    )
