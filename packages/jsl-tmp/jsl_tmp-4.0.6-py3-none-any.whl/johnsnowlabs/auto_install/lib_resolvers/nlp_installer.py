    ...
    compatible_spark_to_py_map = {
        SparkVersion.spark3xx: {
            ...
            PyInstallTypes.wheel: UrlDependency(
                url='https://files.pythonhosted.org/packages/17/1a/658c156d9b93bacf291ac0117cb5a9b748fdcb7451b575cb0b84a53cfe73/spark_nlp-{lib_version}-py2.py3-none-any.whl',
            ...
            PyInstallTypes.tar: UrlDependency(
                url='https://files.pythonhosted.org/packages/b2/b7/f07cdf02cf91a8ad5925f2d9b4af926ba51c9cb4b8230ecd0ec0663baba9/spark-nlp-{lib_version}.tar.gz',
