...
setup(
    ...
    author_email='yidongwang37@gmail.com, haoc3@andrew.cmu.edu',

    # Note that this is a string of words separated by whitespace, not a list.
    keywords='pytorch semi-supervised-learning',
    packages=['semilearn'],
    package_dir={'semilearn':'src'},
    include_package_data=True,
    install_requires=['torch >= 1.8', 'torchvision', 'torchaudio', 'transformers', 'timm', 'progress'],
    python_requires='>=3.7',
)