...
def update():
    ...
    if settings['course'] in curr['courses']:
        ...
        click.echo(warning("Error: You are enrolled in {settings['course']}, but this course is not available. Please run mwc setup again."))
