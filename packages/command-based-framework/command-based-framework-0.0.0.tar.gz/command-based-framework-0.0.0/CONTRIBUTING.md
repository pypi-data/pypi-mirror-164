...
`command-based-framework` documentation uses [Sphinx] as its main documentation compiler.
...
[repository]: https://github.com/<USERNAME>/command-based-framework
[issue tracker]: https://github.com/<USERNAME>/command-based-framework/issues
