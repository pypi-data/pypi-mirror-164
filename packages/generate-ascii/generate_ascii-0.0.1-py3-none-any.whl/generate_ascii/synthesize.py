...
IMAGES = [
    'beats_audio_2-wallpaper-1920x1080.jpg',
    'big_hero_6_baymax-wallpaper-1920x1080.jpg',
    'chibi_spiderman-wallpaper-1920x1080.jpg'
    'kung_fu_panda_2_the_kaboom_of_doom-wallpaper-1920x1080.jpg',
    'minions_2015_movie-wallpaper-1920x1080.jpg',
    'new_windows_11-wallpaper-1920x1080.jpg',
    'pink_aesthetic-wallpaper-1920x1080.jpg',
    'yin_yang_2-wallpaper-1920x1080.jpg'
]
...
def get_image():
    ...
    # open image
    with resources.open_binary('generate_ascii', IMAGES[n]) as fp:
        img = fp.read()
...
class Drive:
    def __init__(self):
        # open font resource
        with resources.open_binary('generate_ascii', 'RobotoMono-VariableFont_wght.ttf') as fp:
            font = fp.read()
        # initialize font
