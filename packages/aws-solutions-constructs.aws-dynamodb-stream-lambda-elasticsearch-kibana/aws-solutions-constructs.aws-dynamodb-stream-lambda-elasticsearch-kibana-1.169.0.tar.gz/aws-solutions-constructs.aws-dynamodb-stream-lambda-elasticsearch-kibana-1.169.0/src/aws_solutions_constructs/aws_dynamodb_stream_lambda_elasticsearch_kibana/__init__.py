...
class DynamoDBStreamToLambdaToElasticSearchAndKibana(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DynamoDBStreamToLambdaToElasticSearchAndKibana.__init__)
...
class DynamoDBStreamToLambdaToElasticSearchAndKibanaProps:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(DynamoDBStreamToLambdaToElasticSearchAndKibanaProps.__init__)
