...
class CloudFrontToApiGatewayToLambda(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CloudFrontToApiGatewayToLambda.__init__)
    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(cloud_front_logging_bucket_props, dict):
            cloud_front_logging_bucket_props = BucketProps(**cloud_front_logging_bucket_props)
        if isinstance(lambda_function_props, dict):
            lambda_function_props = FunctionProps(**lambda_function_props)
        if isinstance(log_group_props, dict):
            log_group_props = LogGroupProps(**log_group_props)
        if __debug__:
            type_hints = typing.get_type_hints(CloudFrontToApiGatewayToLambdaProps.__init__)
