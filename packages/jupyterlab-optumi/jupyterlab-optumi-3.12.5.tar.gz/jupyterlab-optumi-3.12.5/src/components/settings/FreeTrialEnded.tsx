...
export class FreeTrialEnded extends React.Component<IProps, IState> {
    _isMounted = false;
            ...
            <>
                ...
                <DIV sx={{display: 'flex', width: '100%'}}>
                    <Label label={'Free trial'}
                        getValue={() => Global.user.trialEnd ? 'Ended on ' + Global.user.trialEnd?.toLocaleDateString() : 'Ended'}
                        align='left' valueAlign='right' lineHeight='20px'
                        infoRight={
                            <InfoPopup title='Your free trial has ended' sx={{marginY: 'auto', marginLeft: 0.5, marginRight: -0.5, marginBottom: '2px'}} popup={
                                <>
                                    <DIV sx={{padding: '12px'}}>
                                    ...
                                    <DIV sx={{padding: '12px'}}>
                                        Your data will be retained for 14 days after the trial end date.
                                    </DIV>
                                </>
                            } />
                        }
