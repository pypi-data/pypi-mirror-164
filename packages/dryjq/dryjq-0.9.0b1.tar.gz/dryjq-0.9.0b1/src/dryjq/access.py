...
class PathComponent:
    ...
    def get_value(self, data_structure: Any) -> Any:
        ...
        #
        if isinstance(data_structure, list) and not self.allows_lists:
        ...
        #
        try:
            value = data_structure[self.index]
        ...
        #
        logging.debug("Value at %r is %r", self.index, value)
        return value
...
class ReplacingPath(Path):
    ...
    def replace_value(self, data_structure: Any) -> Any:
    ...
    # Alias method for replace_value
    apply_to = replace_value
