...
setup(
  ...
  description = 'Tkinter GUI code is compressed. Compress large projects to small files using this.',   # Give a short description about your library
  ...
  keywords = ['Tkinter', 'GUI', 'Modified'],   # Keywords that define your package best
