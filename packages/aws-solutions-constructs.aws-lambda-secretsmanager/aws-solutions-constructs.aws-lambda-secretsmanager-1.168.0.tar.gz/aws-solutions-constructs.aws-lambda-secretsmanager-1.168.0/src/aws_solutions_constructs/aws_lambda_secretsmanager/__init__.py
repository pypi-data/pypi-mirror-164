...
class LambdaToSecretsmanager(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(LambdaToSecretsmanager.__init__)
    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(secret_props, dict):
            secret_props = SecretProps(**secret_props)
        if isinstance(vpc_props, dict):
            vpc_props = VpcProps(**vpc_props)
        if __debug__:
            type_hints = typing.get_type_hints(LambdaToSecretsmanagerProps.__init__)
