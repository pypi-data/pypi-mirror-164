...
def load_train_data():
    ...
    housing_labels = pd.read_csv(
        os.path.join(os.path.join(PATH, "../data/processed/"), args.independ)
    )
    logger.debug(
...
def train(housing_prepared, housing_labels):
    ...
    with open(os.path.join(PATH, "../deploy/conda/linear_reg.pkl"), "wb") as f:
    ...
    with open(os.path.join(PATH, "../deploy/conda/tree_reg.pkl"), "wb") as f:
