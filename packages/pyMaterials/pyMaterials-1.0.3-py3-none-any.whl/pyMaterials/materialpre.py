            ...
            model={
                "Model": {
                    ...
                    "SubHeadEntity3": {
                        ...
                        "FPrintCount": 1,
                        "FMinPackCount": "1" if str(data.loc[i]["最小包装数"])=="" else
                        str(data.loc[i]["最小包装数"])
                    },
                    "SubHeadEntity4": {
                    ...
                    "SubHeadEntity5": {
                        ...
                        "FFinishReceiptOverRate": str(data.loc[i]["入库超收比例(%"]),
                        "FFinishReceiptShortRate": str(data.loc[i]["入库欠收比例(%"]),
...
def saveData(path,zPath,option):
...
if __name__ == '__main__':
    ...
    option={
        "acct_id": '62f49d037697ee',
        "user_name":'张志',
        "app_id":'232255_1eeC0aDJ1rGaSexHx1wrz/9tzNQZ1okE',
        "app_sec":'1bb7607d115547b3b153c43959f054ee',
