    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(api_gateway_props, dict):
            api_gateway_props = RestApiProps(**api_gateway_props)
        ...
        if isinstance(put_record_request_model, dict):
            put_record_request_model = ModelOptions(**put_record_request_model)
        if isinstance(put_records_request_model, dict):
            put_records_request_model = ModelOptions(**put_records_request_model)
        if __debug__:
