...
class SubscriptionsApi(object):
    ...
    def get_app_subscriptions(
        ...
        **kwargs
        ...
        Fetches all the subscriptions active for this app.  This is a close indicator for how many generators are being run to update the insights.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_app_subscriptions(app_name, user_name, async_req=True)
        >>> result = thread.get()
