...
class CentralGovernance(
    ...
    def register_data_domain(
        ...
        :access: public
        '''
        return typing.cast(None, jsii.invoke(self, "registerDataDomain", [id, domain_id, domain_name, domain_secret_arn]))
    ...
    def __init__(
        ...
        *,
        ...
        props = DataDomainProps(
            central_account_id=central_account_id, crawler_workflow=crawler_workflow
        )
...
class SingletonCfnLaunchTemplate(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        launch_template_data: typing.Union[aws_cdk.aws_ec2.CfnLaunchTemplate.LaunchTemplateDataProperty, aws_cdk.IResolvable],
