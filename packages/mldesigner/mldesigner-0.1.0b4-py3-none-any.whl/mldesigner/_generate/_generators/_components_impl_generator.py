...
from azure.ai.ml._internal.entities import ScopeComponent, InternalComponent
...
from mldesigner._generate._generators._constants import V2_COMPONENT_TO_NODE, V1_COMPONENT_TO_NODE
    ...
    def _get_used_components(cls, components):
        ...
        for v1_component, v1_node in V1_COMPONENT_TO_NODE.items():
            if v1_component in used_components_counter:
                v1_node_cls.append(v1_node.__name__)
