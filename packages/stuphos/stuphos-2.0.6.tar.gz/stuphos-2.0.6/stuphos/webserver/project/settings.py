...
DATABASES = {
    'default': initDjangoDatabaseConfig(database)
}

# In case default gets overwritten, we always have access to the conf here.
DATABASES['stuphos'] = DATABASES['default']

# XXX hardcoded namespace:
DATABASES['stuphosweb'] = initDjangoDatabaseConfig('sqlite')
...
#        'cms.middleware.toolbar.ToolbarMiddleware',
        ...
        'stuphos.webserver.LoggingMiddleware', # XXX
)
