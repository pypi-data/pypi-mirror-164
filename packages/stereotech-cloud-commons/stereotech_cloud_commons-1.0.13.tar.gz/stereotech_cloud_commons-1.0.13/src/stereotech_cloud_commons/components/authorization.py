...
class Authorization:
    def __init__(self, config: ConfigHelper) -> None:
        ...
        self.permitted_paths.add("/access/register")
        self.permitted_paths.add("/access/confirm")
        self.permitted_paths.add("/access/resend")
        self.permitted_paths.add("/access/reset")
        self.permitted_paths.add("/access/reset/confirm")
