...
class Ticket(Ticket, Assignable, Summarized, Hierarchical, ElasticSearchable):
...
#AllTickets.display_mode_main = "responsive_grid"

class TicketsByParent(Tickets):
    required_roles = dd.login_required(Reporter)
    # label = _("Known problems")
    master_key = 'parent'
    column_names = "priority overview:50 quick_assign_to #ticket_type #workflow_buttons *"
