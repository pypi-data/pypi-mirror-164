(function($) {
    ...
    function createInputTextCard(inputCardTitle, inputCardLineStart, inputCardLineEnd) {
        ...
        if (previousCard) {
            ...
            console.log("Line End: " + inputCardLineEnd);
    ...
    function hideInput() {
        ...
        console.log(qs("#component-2-preview"));
        $("#submit-btn").remove();
    }
    ...
    function createOutputComponentDOM(in_componentType, outputValue, parentElementSelector, startTop=false) {
        ...
        if(componentType == "card") {
            ...
            if (outputValue['max-height'] != undefined) {
                $(component.getId()).css("max-height", outputValue['max-height']);
            }
