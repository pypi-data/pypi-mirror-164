...
class KinesisFirehoseToAnalyticsAndS3(
    ...
    def __init__(
        ...
        *,
        ...
        kinesis_analytics_props: typing.Optional[typing.Union[aws_cdk.aws_kinesisanalytics.CfnApplicationProps, typing.Dict[str, typing.Any]]] = None,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(KinesisFirehoseToAnalyticsAndS3.__init__)
    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(bucket_props, dict):
            bucket_props = BucketProps(**bucket_props)
        if isinstance(kinesis_analytics_props, dict):
            kinesis_analytics_props = CfnApplicationProps(**kinesis_analytics_props)
        if isinstance(logging_bucket_props, dict):
            logging_bucket_props = BucketProps(**logging_bucket_props)
        if isinstance(log_group_props, dict):
            log_group_props = LogGroupProps(**log_group_props)
        if __debug__:
            type_hints = typing.get_type_hints(KinesisFirehoseToAnalyticsAndS3Props.__init__)
