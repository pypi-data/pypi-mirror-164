...
class _Sky130(tch.Technology):
    ...
    def _init(self):
        ...
        prims += (
            *implants.values(), nwm, hvi, diffres, polyres, areaid_diode, areaid_sc,
        )
        ...
        difftap = prm.WaferWire(name="difftap",
            ...
            implant=(implants["nsdm"], implants["psdm"]),
        ...
        # TODO: RDL option
        prims += (difftap, poly, *metals.values())
        ...
        prims += (
            ...
            *(
                prm.Resistor(name=name,
                    ...
                    sheetres=sheetres, # Own rule
                )
                for name, wire, marker, sheetres in (
                    ("active_res", difftap, diffres, 200.0),
                    ("poly_res", poly, polyres, 48.2), # typical sheet resistance
                )
            ),
            # TODO: licon on top of unsilicided poly(/difftap?) is allowed
            # diodes
            prm.Diode(
                name="ndiode", model="sky130_fd_pr__diode_pw2nd_05v5",
                wire=difftap, implant=implants["nsdm"],
                indicator=areaid_diode, min_indicator_enclosure=prp.Enclosure(self.grid),
            ),
            prm.Diode(
                name="pdiode", model="sky130_fd_pr__diode_pd2nw_05v5",
                wire=difftap, implant=implants["psdm"], well=nwm,
                indicator=areaid_diode, min_indicator_enclosure=prp.Enclosure(self.grid),
            ),
            # extra space rules
            prm.Spacing( # poly.4
        ...
        trans = {
            name: prm.MOSFET(name=name, model=model,
                ...
                (
                    ...
                    mosgate, implants["nsdm"], None,
                ),
                (
                    "nfet_01v8_sc", "sky130_fd_pr__nfet_01v8__model",
                    mosgate_sc, implants["nsdm"], None,
                ),
                (
                    "pfet_01v8", "sky130_fd_pr__pfet_01v8__model",
                    mosgate, implants["psdm"], nwm,
                ),
                (
                    "nfet_01v8_lvt", "sky130_fd_pr__nfet_01v8_lvt__model",
                    mosgate, (implants["nsdm"], implants["lvtn"]), None,
                ),
                (
                    "pfet_01v8_lvt", "sky130_fd_pr__pfet_01v8_lvt__model",
                    mosgate, (implants["psdm"], implants["lvtn"]), nwm,
                ),
                (
                    "pfet_01v8_hvt", "sky130_fd_pr__pfet_01v8_hvt__model",
                    mosgate, (implants["psdm"], implants["hvtp"]), nwm,
                ),
                (
                    "nfet_g5v0d10v5", "sky130_fd_pr__nfet_g5v0d10v5__model",
                    hvmosgate, implants["nsdm"], None,
                ),
                (
                    "pfet_g5v0d10v5", "sky130_fd_pr__pfet_g5v0d10v5__model",
                    hvmosgate, implants["psdm"], nwm,
                ),
            )
        }
