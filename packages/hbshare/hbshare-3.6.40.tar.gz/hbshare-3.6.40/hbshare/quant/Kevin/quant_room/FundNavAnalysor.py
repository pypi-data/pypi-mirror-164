...
if __name__ == '__main__':
    ...
    nv_series = get_fund_nav_from_sql('20180531', '20220812', {"九坤日享中证1000指数增强1号": "SCP381"})
    trading_day_list = get_trading_day_list('20180531', '20220812', frequency='week')
    nv_series = nv_series.reindex(trading_day_list)

    FundNavAnalysor('20180531', '20220812', '000852', nv_series).run()