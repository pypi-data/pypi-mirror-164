...
def get_v1_router(storage: StorageInterface):
    ...
    @v1router.get(
        ...
        responses={102: {}},
        description="Check if your request is registered by the backend. You can now query try to query a Response at the reponse endpoints. \
            But this does not indicate that your response content is ready/available.",
    )
