...
class Area_plot: 
  # read data
  def __init__(self, path=os.getcwd(),file='museum_visitors_line.csv'):
      ...
      # self.data = self.read_file("numseunm_visitors.csv", path)
      # self.path=path
  ...
  def area(self,  x_col_name=None, y_col_name=None, plot_type=None,paper_type=None,**kwargs):
    ...
    # self.data = self.read(file, self.path)
