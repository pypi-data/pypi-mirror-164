...
# ToDo This is only used by sample scripts. connection_manager does it entirely on its own. Merge them so that there is just the one combined approach.
# ToDo This also doesn't support password auth. wtf?
