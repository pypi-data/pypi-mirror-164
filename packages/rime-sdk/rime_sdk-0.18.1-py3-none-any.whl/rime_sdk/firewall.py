...
class Firewall:
    ...
    def update_metric_thresholds(
        ...
        if not isinstance(medium, numbers.Number):
            raise ValueError(
        ...
        if low == medium or medium == high:  # pylint: disable=consider-using-in
            print("WARNING: setting equal thresholds is not recommended.")
    ...
    @deprecated(
        "run_firewall_incremental_data is deprecated, use run_continuous_tests instead."
    )
