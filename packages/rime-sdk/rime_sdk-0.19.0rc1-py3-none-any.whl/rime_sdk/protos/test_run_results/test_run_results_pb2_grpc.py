...
class ResultsReaderStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ListSummaryTests = channel.unary_unary(
                ...
                request_serializer=protos_dot_test__run__results_dot_test__run__results__pb2.ListSummaryTestsRequest.SerializeToString,
                response_deserializer=protos_dot_test__run__results_dot_test__run__results__pb2.ListSummaryTestsResponse.FromString,
                )
...
def add_ResultsReaderServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ListSummaryTests': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=protos_dot_test__run__results_dot_test__run__results__pb2.ListSummaryTestsRequest.FromString,
                    response_serializer=protos_dot_test__run__results_dot_test__run__results__pb2.ListSummaryTestsResponse.SerializeToString,
            ),
    }
...
class ResultsReader(object):
    ...
    def ListSummaryTests(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/testrunresult.ResultsReader/ListSummaryTests',
            protos_dot_test__run__results_dot_test__run__results__pb2.ListSummaryTestsRequest.SerializeToString,
            protos_dot_test__run__results_dot_test__run__results__pb2.ListSummaryTestsResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
