...
from tala.model.plan_item import JumpToPlanItem, IfThenElse, ForgetAllPlanItem, ForgetPlanItem,\
    ...
    EndTurnPlanItem, ResetDomainQueryPlanItem, IteratePlanItem
...
class DomainCompiler(XmlCompiler):
    ...
    def _compile_inform_element(self, element):
        ...
        if insist == "true":
            return [ForgetPlanItem(predicate), AssumePlanItem(predicate_proposition), AssumeIssuePlanItem(question)]
        else:
