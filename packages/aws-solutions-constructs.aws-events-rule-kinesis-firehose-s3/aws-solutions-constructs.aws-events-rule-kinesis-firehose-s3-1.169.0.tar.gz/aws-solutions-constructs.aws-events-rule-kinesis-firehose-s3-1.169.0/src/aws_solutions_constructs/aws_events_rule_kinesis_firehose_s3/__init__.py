...
class EventsRuleToKinesisFirehoseToS3(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EventsRuleToKinesisFirehoseToS3.__init__)
    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(event_bus_props, dict):
            event_bus_props = EventBusProps(**event_bus_props)
        ...
        if __debug__:
            type_hints = typing.get_type_hints(EventsRuleToKinesisFirehoseToS3Props.__init__)
