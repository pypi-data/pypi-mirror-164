...
class EdgeGrantedToCorporationChild(object):
    ...
    """
    swagger_types = {
        'corporation_locations': 'list[EdgeLocationBaseChild]',
        'corporation_id': 'str',
    ...
    attribute_map = {
        'corporation_locations': 'CorporationLocations',
        'corporation_id': 'CorporationId',
        'corporation_name': 'CorporationName',
        'corporation_abbreviation': 'CorporationAbbreviation'
    }

    def __init__(self, corporation_locations=None, corporation_id=None, corporation_name=None, corporation_abbreviation=None):  # noqa: E501
        """EdgeGrantedToCorporationChild - a model defined in Swagger"""  # noqa: E501
        self._corporation_locations = None
        self._corporation_id = None
        self._corporation_name = None
        self._corporation_abbreviation = None
        self.discriminator = None
        self.corporation_locations = corporation_locations
    ...
    @property
    def corporation_locations(self):
        """Gets the corporation_locations of this EdgeGrantedToCorporationChild.  # noqa: E501


        :return: The corporation_locations of this EdgeGrantedToCorporationChild.  # noqa: E501
        :rtype: list[EdgeLocationBaseChild]
        """
        return self._corporation_locations

    @corporation_locations.setter
    def corporation_locations(self, corporation_locations):
        """Sets the corporation_locations of this EdgeGrantedToCorporationChild.


        :param corporation_locations: The corporation_locations of this EdgeGrantedToCorporationChild.  # noqa: E501
        :type: list[EdgeLocationBaseChild]
        """
        if corporation_locations is None:
            raise ValueError("Invalid value for `corporation_locations`, must not be `None`")  # noqa: E501

        self._corporation_locations = corporation_locations
