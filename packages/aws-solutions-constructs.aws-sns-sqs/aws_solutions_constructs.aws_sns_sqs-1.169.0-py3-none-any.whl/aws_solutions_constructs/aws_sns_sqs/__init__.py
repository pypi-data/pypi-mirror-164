...
class SnsToSqs(
    ...
    def __init__(
        ...
        *,
        ...
        sqs_subscription_props: typing.Optional[typing.Union[aws_cdk.aws_sns_subscriptions.SqsSubscriptionProps, typing.Dict[str, typing.Any]]] = None,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SnsToSqs.__init__)
    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(encryption_key_props, dict):
            encryption_key_props = KeyProps(**encryption_key_props)
        if isinstance(queue_props, dict):
            queue_props = QueueProps(**queue_props)
        if isinstance(sqs_subscription_props, dict):
            sqs_subscription_props = SqsSubscriptionProps(**sqs_subscription_props)
        if isinstance(topic_props, dict):
            topic_props = TopicProps(**topic_props)
        if __debug__:
            type_hints = typing.get_type_hints(SnsToSqsProps.__init__)
