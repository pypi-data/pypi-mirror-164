...
class DevManage(object):
    ...
    def dwm_enable_blurbehind_window(self, flags=0x00000001, enable: bool = True, rgn_blur=1, transition_on_maximized: bool = True):
...
if __name__ == '__main__':
    ...
    Manage.dwm_set_window_attribute(11, ctypes.byref(ctypes.c_int(0)), ctypes.sizeof(ctypes.c_int(0)))
    Window.mainloop()
