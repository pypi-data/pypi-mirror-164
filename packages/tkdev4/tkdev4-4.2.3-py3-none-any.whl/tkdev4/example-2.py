...
BasicFalse = ttk.Radiobutton(SettingBasic, text="False", variable=RoundVar, value="False", command=basic_false)
BasicFalse.pack(side="left", padx=10, pady=10)
BasicTrue = ttk.Radiobutton(SettingBasic, text="True", variable=RoundVar, value="True", command=basic_true)
