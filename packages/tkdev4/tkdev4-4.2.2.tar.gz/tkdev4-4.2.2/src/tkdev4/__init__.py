...
class DevManage(object):
    def __init__(self, master: tk.Tk):
        ...
        self.DWMWA_SYSTEMBACKDROP_TYPE = 23
        self.DWMWA_LAST = 24
    ...
    def dwm_set_ncrendering_policy(self, value=2):
        Value = ctypes.c_int(value)
        self.dwm_set_window_attribute(Manage.DWMWA_NCRENDERING_POLICY,
    ...
    def dwm_enable_blurbehind_window(self, flags=0x00000001, enable: bool = True, rgn_blur=1,
        ...
        return self.DwmApi.DwmEnableBlurBehindWindow(self._master, ctypes.byref(BlurBehid))

    def dwm_is_composition_enabled(self):
        return self.DwmApi.DwmIsCompositionEnabled()

    def dwm_extend_frame_into_client_area(self, margins=[-1, -1, -1, -1]):
        Margins = MARGINS(margins[0], margins[1], margins[2], margins[3])
        return self.DwmApi.DwmExtendFrameIntoClientArea(self._master, ctypes.byref(Margins))
