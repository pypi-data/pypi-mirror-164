...
class XAVoiceMemosApplication(XABase.XAApplication):
    ...
    def __init__(self, properties):
        ...
        # print(self.front_window.groups()[0].groups()[0].groups()[0].groups()[0].groups()[0].groups()[0].ui_elements().role())
        # print(self.front_window.groups()[0].groups()[0].groups()[0].groups()[0].groups()[0].groups()[0].splitters()[1])

    @property
    def sidebar_showing(self) -> bool:
        second_splitter = self.front_window.xa_elem.groups()[0].groups()[0].groups()[0].groups()[0].groups()[0].groups()[0].splitters()[1]
        return second_splitter.get() is not None
