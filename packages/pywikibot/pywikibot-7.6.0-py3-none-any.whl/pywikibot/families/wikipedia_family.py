...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'tt', 'eu', 'ms', 'eo', 'he', 'hy', 'da', 'bg', 'azb', 'sk', 'kk',
        'et', 'min', 'be', 'simple', 'hr', 'el', 'lt', 'gl', 'az', 'sl', 'ur',
        'uz', 'nn', 'ka', 'hi', 'th', 'ta', 'la', 'cy', 'mk', 'ast', 'bn',
        'zh-yue', 'lv', 'tg', 'af', 'my', 'mg', 'bs', 'oc', 'sq', 'mr', 'nds',
        'ky', 'ml', 'be-tarask', 'te', 'sw', 'br', 'new', 'jv', 'vec', 'ht',
        'pms', 'pnb', 'su', 'lb', 'ba', 'lld', 'ga', 'szl', 'lmo', 'is', 'ku',
        'cv', 'fy', 'vo', 'tl', 'ckb', 'wuu', 'an', 'sco', 'diq', 'pa', 'yo',
        'io', 'ne', 'gu', 'als', 'kn', 'bar', 'scn', 'bpy', 'avk', 'ia', 'qu',
        'mn', 'nv', 'crh', 'xmf', 'si', 'ha', 'bat-smg', 'os', 'frr', 'gd',
        'or', 'cdo', 'ps', 'bug', 'yi', 'ilo', 'sd', 'ban', 'am', 'nap', 'sah',
        'hsb', 'fo', 'map-bms', 'li', 'mai', 'mzn', 'gor', 'eml', 'ace', 'bcl',
        'sa', 'shn', 'wa', 'zh-classical', 'ie', 'lij', 'as', 'zu', 'mhr',
        'mrj', 'hif', 'hyw', 'mni', 'km', 'hak', 'roa-tara', 'ig', 'pam',
        'nso', 'sn', 'so', 'rue', 'bh', 'se', 'myv', 'vls', 'nds-nl', 'mi',
        'sat', 'sc', 'nah', 'vep', 'gan', 'kab', 'glk', 'tk', 'fiu-vro', 'co',
        'bo', 'ab', 'ary', 'gv', 'frp', 'kw', 'kv', 'csb', 'pcd', 'ug', 'skr',
        'udm', 'zea', 'ay', 'gn', 'tum', 'nrm', 'mt', 'bjn', 'smn', 'lez',
        'lfn', 'stq', 'lo', 'olo', 'mwl', 'fur', 'rm', 'ang', 'lad', 'gom',
        'koi', 'ext', 'tyv', 'dsb', 'rw', 'dty', 'ln', 'av', 'cbk-zam', 'dv',
        'ksh', 'gag', 'bxr', 'pfl', 'pap', 'pag', 'pi', 'haw', 'awa', 'tay',
        'tw', 'inh', 'krc', 'xal', 'szy', 'za', 'dag', 'kaa', 'pdc', 'mdf',
        'atj', 'to', 'arc', 'tcy', 'kbp', 'jam', 'na', 'wo', 'kbd', 'nia',
        'nov', 'ki', 'tet', 'lg', 'bi', 'mnw', 'tpi', 'nqo', 'jbo', 'roa-rup',
        'fj', 'lbe', 'kg', 'xh', 'ty', 'ks', 'cu', 'shi', 'srn', 'trv', 'om',
        'sm', 'guw', 'gcr', 'alt', 'chr', 'ltg', 'ny', 'pih', 'got', 'mad',
        'st', 'ami', 'blk', 'tn', 'bm', 've', 'rmy', 'ts', 'chy', 'rn', 'iu',
        'ak', 'ss', 'ch', 'ff', 'pnt', 'kcg', 'ady', 'ik', 'ee', 'sg', 'din',
        'pwn', 'kl', 'ti', 'dz', 'cr', 'pcm',
    ]
