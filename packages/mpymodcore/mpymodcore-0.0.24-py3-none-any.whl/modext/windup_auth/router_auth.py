...
class AuthRouter(Router):
    ...
    def put(self, to, groups):
        return self._decor(to, "PUT", groups)

    def delete(self, to, groups):
        return self._decor(to, "DELETE", groups)
    ...
    def xput(self, to, groups):
        return self._decor(to, "PUT", groups, True)

    def xdelete(self, to, groups):
        return self._decor(to, "DELETE", groups, True)
