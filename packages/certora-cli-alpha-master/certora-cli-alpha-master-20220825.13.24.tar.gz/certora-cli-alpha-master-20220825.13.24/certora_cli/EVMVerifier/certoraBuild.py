...
from Shared.certoraUtils import safe_create_dir, remove_file
...
class CertoraBuildGenerator:
    ...
    def standard_json(self,
        ...
        solc_args = get_extra_solc_args(file_name, self.input_config.solc_args, self.input_config.optimize_map)
    ...
    def collect_for_file(self,
        ...
        if not is_vyper:
            ...
            solc_ver_to_run = get_relevant_solc(build_arg_contract_file, self.input_config.solc,
    ...
    def resolve_slot(self, primary_contract: str, slot_name: str) -> str:
        ...
        solc_ver_to_run = get_relevant_solc(file_of_primary_contract, self.input_config.solc,
                                            self.input_config.solc_mappings)
        solc_add_extra_args = get_extra_solc_args(file_of_primary_contract, self.input_config.solc_args,
