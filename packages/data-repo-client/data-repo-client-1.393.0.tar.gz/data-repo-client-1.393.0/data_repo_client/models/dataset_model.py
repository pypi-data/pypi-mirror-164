...
class DatasetModel(object):
    ...
    def ingest_service_account(self):
        ...
        Google service account to grant storage.object.get access on source Google storage buckets to in order to ingest files   # noqa: E501
