...
CACHE_LOCATION = os.path.join(tempfile.gettempdir(), "image_service", "images")
CACHE_ENABLED = False
...
class Image:
    ...
    def _update_cache(self, image_content: bytes):
        if CACHE_ENABLED:
            ...
            with open(os.path.join(self._cache_location, self._cached_image_name), mode="w") as file:
