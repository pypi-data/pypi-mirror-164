...
def load_alert(
    ...
    **kwargs
    ...
    Args:
        ...
        kwargs:
            Keyword arguments for ``_drop_cutouts`` and ``alert_dict_to_dataframe``.
    """
    LOGGER.warn("Depreciated. Use open_alert() instead.")
    return open_alert(alert, return_as=return_as, **kwargs)
    # first, load to bytes
    # if return_as == "bytes":
...
def decode_alert(
    ...
    **kwargs
    ...
    """."""
    LOGGER.warn("Depreciated. Use open_alert() instead.")
    return open_alert(alert, return_as=return_as, drop_cutouts=drop_cutouts, **kwargs)
