...
class text_display_button():
    ...
    def hide_character(self):
        self.Button.config(text ='N')

    def display_character(self):
        self.Button.config(text =self.input_text)

    def load_file(self):
        with open(path_txt, 'r', errors='ignore') as reader:
    ...
    def create_widgets_inside_frame(self):
        ...
        self.Button.config(bg = 'black',fg = '#7dcd66')
...
class main_frame():
    def __init__(self,root):
        ...
        fileMenu.add_command(label="hide", command=self.hide_characters)
        fileMenu.add_command(label="show", command=self.show_characters)
    ...
    def load_txt(self):
        ...
        #     input_text = reader.read()
        if len(input_text)==0:
            with open(path_txt, 'r',encoding='GKB', errors='ignore') as reader:
                input_text = reader.read()
        # print(input_text)
        input_text=re.findall(r'[\u4e00-\u9fa5]', input_text)
        # input_text = input_text.split('\n')
    ...
    def creat_buttons(self):
        ...
        if cols>7:
            ...
            button_size = 60
        lenghth = ceil(button_size*cols*1.46)
