...
setuptools.setup(
    ...
    install_requires=['ua-headers', 'requests', 'torpy'],  # list all packages that your package uses
    ...
    download_url="https://github.com/mishakorzik/IpHack/archive/refs/tags/1.0.9.tar.gz",
)
