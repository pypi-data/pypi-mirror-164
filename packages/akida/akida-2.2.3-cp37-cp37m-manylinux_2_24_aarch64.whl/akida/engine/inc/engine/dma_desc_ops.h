...
static constexpr uint32_t MIN_NB_DESCRIPTORS = 2;
static constexpr uint32_t MAX_NB_DESCRIPTORS = 16;
static constexpr uint32_t MAX_NB_DESCRIPTORS_MULTIPASS = 256;
...
static constexpr bool DESC_CONFIG_DIRECTION_WRITE = true;
static constexpr bool DESC_CONFIG_DIRECTION_READ = false;
